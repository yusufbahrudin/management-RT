...
!(function (t) {
  ...
  t.extend({
    simpleWeather: function (i) {
      i = t.extend(
        { location: '', woeid: '', unit: 'f', success: function (t) {}, error: function (t) {} },
        i
      )
      var o = new Date(),
        n =
      ...
      if ('' !== i.location) {
        ...
        if ('' === i.woeid)
          return i.error('Could not retrieve weather due to an invalid location.'), !1
            ...
            ;(r.title = n.item.title),
              ...
              n.item.condition.temp < 80 && n.atmosphere.humidity < 40
                ? (r.heatindex =
                    ...
                    6.83783 * Math.pow(10, -3) * Math.pow(n.item.condition.temp, 2) -
                    5.481717 * Math.pow(10, -2) * Math.pow(n.atmosphere.humidity, 2) +
                    1.22874 *
                      Math.pow(10, -3) *
