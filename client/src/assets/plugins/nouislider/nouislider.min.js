...
!(function (t) {
  ...
  ;(l.prototype.getMargin = function (t) {
    ...
    if (e && (t / e) % 1 != 0)
      throw new Error(
        'noUiSlider (' + et + "): 'limit', 'margin' and 'padding' must be divisible by step."
      )
  ...
  function y(t, e) {
    ...
    if (0 !== e && ((t.margin = t.spectrum.getMargin(e)), !t.margin))
      throw new Error(
        'noUiSlider (' + et + "): 'margin' option is only supported on linear sliders."
      )
  }
  function E(t, e) {
  ...
  function C(t, e) {
    if (!i(e) && !Array.isArray(e))
      throw new Error(
        'noUiSlider (' + et + "): 'padding' option must be numeric or array of exactly 2 numbers."
      )
    ...
    if (0 !== e) {
      if (
        ...
        throw new Error(
          'noUiSlider (' + et + "): 'padding' option is only supported on linear sliders."
        )
      if (t.padding[0] < 0 || t.padding[1] < 0)
        throw new Error('noUiSlider (' + et + "): 'padding' option must be a positive number(s).")
      if (100 <= t.padding[0] + t.padding[1])
        throw new Error(
          'noUiSlider (' + et + "): 'padding' option must not exceed 100% of the range."
        )
    }
  }
  function N(t, e) {
  ...
  function U(t, e) {
    ...
    if (s && (t.margin || t.limit))
      throw new Error(
        'noUiSlider (' + et + "): 'unconstrained' behaviour cannot be used with margin or limit"
      )
      ...
      if (!0 === e) {
        ...
        t.tooltips.forEach(function (t) {
          if ('boolean' != typeof t && ('object' != typeof t || 'function' != typeof t.to))
            throw new Error(
              'noUiSlider (' + et + "): 'tooltips' must be passed a formatter or 'false'."
            )
        })
      }
  }
          ...
          v.forEach(function (t, e) {
            ...
            if ((h && (r = E.xNumSteps[e]), r || (r = d - f), !1 !== f && void 0 !== d))
              for (r = Math.max(r, 1e-7), n = f; n <= d; n = (n + r).toFixed(7) / 1) {
                for (
                  u = (a = (o = E.toStepping(n)) - x) / m, p = a / (c = Math.round(u)), i = 1;
                  i <= c;
                  i += 1
                )
