...
;(function () {
  ...
  d.AxisBase = d.Class({
    ...
    createBalloon: function () {
      ...
      this.balloon &&
        (this.balloon.destroy && this.balloon.destroy(), d.extend(this.balloon, a.balloon, !0))
    },
      ...
      for (p = n; p <= l; p++) {
        ...
        for (q = 0; q < k.length; q++)
          if (((n = k[q]), n.hidden)) n.newStack && ((g[p] = NaN), (e[p] = NaN))
            ...
            ((m = n.type), n.chart == this.chart && n.valueAxis == this && a == m && n.stackable)
          )
    ...
    handleSynchronization: function () {
      if (this.synchronizeWith) {
        ...
        e &&
          ...
          (b = Math.abs(
            Math.log(
              Math.abs(Math.pow(10, Math.floor(Math.log(Math.abs(this.step)) * Math.LOG10E)))
            ) * Math.LOG10E
          )),
      ...
      if ('H' == Pa) {
        if (
          (0 <= b &&
            ...
            0 < D &&
              ((Ba = d.line(z, [b, b + ma, b + ma], [X, X + na, na], I, D, C, H)), x.push(Ba))),
          (v = 0),
          (G = b),
          h && 90 == n && J && (G -= r),
          !1 === e
          ...
          1 == ia &&
            ...
            (Y = e - da),
            0 < Y &&
              ((Da = d.rect(z, Y, a.height, Q, M)), Da.translate(e - Y + ma, na), x.push(Da))),
          'bottom' == Z
            ? ((v += X + r / 2 + ea),
              J
                ? (0 < n
        ...
        0 <= b &&
          ...
          0 < D &&
            ((Ba = d.line(z, [0, ma, xa + ma], [b, b + na, b + na], I, D, C, H)), x.push(Ba)))
        ga = 'end'
  ...
  d.AmChart = d.Class({
    ...
    drawLabel: function (a) {
      ...
      if (b.container && !1 !== a.enabled) {
        ...
        'right' == g && (g = 'end')
        'center' == g &&
          ((g = 'middle'), k ? (c = b.realHeight - c + c / 2) : (n = b.realWidth / 2 - n))
        void 0 === l && (l = 1)
        void 0 === k && (k = 0)
        c += f / 2
  ...
  d.AmGraph = d.Class({
              ...
              if (isNaN(W))
                ...
                if (
                  ...
                  this.drawSmoothedGraph(x, u, T, U),
                    ...
                    (this.dashLengthSwitched = v.dashLength)
                v.gap &&
                  (this.drawSmoothedGraph(x, u, T, U), (x = []), (u = []), (T = []), (U = []))
              }
              break
            case 'step':
              if (!isNaN(W)) {
              ...
              if ('regular' == M || '100%' == M) {
                ...
                if (Zb) {
                  ...
                  if (Oa) {
                    ...
                    t
                      ? ((jb = Ea),
                        (ib = 0 > W ? E - ac / 2 - 2 - kb - sb : E + ac / 2 + 3 + kb + sb))
    ...
    createBullet: function (a, b, c) {
      if (
        ...
        l = h
        this.bulletAxis &&
          ((h = a.values.error), isNaN(h) || (k = h), (h = this.bulletAxis.stepWidth * k))
      ...
      if (!isNaN(a) && this.vvLine) {
        if (isNaN(this.prevLineX)) {
          ...
          if (this.limitToGraph) {
            ...
            d &&
              (this.chart.rotate || (c = 'bottom' == d.position ? this.height : -this.height),
              (e = a))
          }
      ...
      if (!isNaN(a) && this.hhLine) {
        if (isNaN(this.prevLineY)) {
          ...
          if (this.limitToGraph) {
            var d = this.chart.categoryAxis
            d &&
              (this.chart.rotate && (c = 'right' == d.position ? this.width : -this.width), (e = a))
          }
  ...
  d.VMLRenderer = d.Class({
    ...
    setAttr: function (a, b, c) {
      if (void 0 !== c) {
        ...
        if ('shape' == f) {
          'cs' == b &&
            ((g.style.width = '100px'), (g.style.height = '100px'), g.setAttribute('coordsize', c))
    ...
    arrangeEntries: function () {
      ...
      for (A = 0; A < x.length; A++) {
        ...
        H + u.width > q &&
          0 < A &&
          0 !== y &&
          (t++, (H = y = 0), (B = H + u.width + f + n), (D = D + C + m), (C = 0))
