  ...
  e.AmSerialChart = e.Class({
        ...
        if (l)
          if (l.mouseIsOver()) {
            var k = l.mouseX,
              l = l.mouseY
            e != f &&
              ((k = this.rotate ? l / this.plotAreaHeight : k / this.plotAreaWidth),
              (e *= k),
              (f *= 1 - k))
    ...
    handleCursorZoomReal: function (a, b, c, d, e) {
      ...
      this.rotate
        ...
        : (isNaN(c) ||
            isNaN(d) ||
            (this.relativeZoomValueAxes(this.valueAxes, c, d) && this.updateAfterValueZoom()),
...
;(function () {
  ...
  e.CategoryAxis = e.Class({
      ...
      if (e.ifArray(a)) {
        ...
        if (this.parseDates && !this.equalSpacing)
          (this.lastTime = a[a.length - 1].time),
            (this.maxTime = e
              .resetDateToMin(new Date(this.lastTime + 1.05 * u), this.minPeriod, 1, q)
              .getTime()),
          ...
          F = f
          if (
            this.data[f].time != e.resetDateToMin(new Date(this.data[f].time), g, v, q).getTime()
          ) {
            var u = 0,
              D = n
            for (b = f; b < C; b++)
    ...
    showBalloonAt: function (a, b) {
      void 0 === b &&
        (b = this.parseDates ? this.dateToCoordinate(new Date(a)) : this.categoryToCoordinate(a))
    ...
    adjustBalloonCoordinate: function (a, b) {
      ...
      d &&
        !b &&
        (d.setIndex(c), this.parseDates && d.setTimestamp(this.coordinateToDate(a).getTime()))
      return a
    }
  })
})()
