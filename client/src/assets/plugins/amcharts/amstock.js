  ...
  e.AmStockChart = e.Class({
    ...
    afterWrite: function (a) {
      ...
      this.dataSetSelector &&
        (this.dataSetSelector = e.processObject(this.dataSetSelector, e.DataSetSelector, b))
      this.periodSelector &&
        (this.periodSelector = e.processObject(this.periodSelector, e.PeriodSelector, b))
      a.innerHTML = ''
      this.div = a
      this.measure()
      this.createLayout()
    ...
    updateDataSets: function () {
      ...
      for (c = 0; c < b.length; c++) {
        ...
        void 0 === d.color &&
          (d.color = this.colors.length - 1 > c ? this.colors[c] : e.randomColor())
      }
    ...
    fixGlue: function () {
      if (this.glueToTheEnd && this.startDate && this.endDate && this.lastDate) {
        this.startDate = new Date(
          this.startDate.getTime() + (this.lastDate.getTime() - this.endDate.getTime()) + 1
        )
              ...
              (g.percentHeight = (g.percentHeight / d) * 100),
                g.panelBox &&
                  (g.panelBox.style.height =
                    Math.round((g.percentHeight * this.panelsHeight) / 100) + 'px')
          this.prevPH = c
        }
      }
    },
      ...
      if (k && g) {
        ...
        for (k = 0; k < q.length; k++) {
          ...
          if (l != h) {
            ...
            if ((d = g.chartCursor))
              (d.categoryBalloonDateFormat = c.chartCursorSettings.categoryBalloonDateFormat(
                n.period
              )),
    ...
    dispDUpd: function () {
      this.skipEvents ||
        ...
        this.chartRendered ||
          ((this.chartRendered = !0), this.fire({ type: 'rendered', chart: this })),
      ...
      if (0 < this.dataSets.length) {
        ...
        for (b = 0; b < a.length; b++) {
          ...
          for (l = 0; l < g.length; l++) {
            ...
            f.useDataSetColors &&
              ((f.lineColor = d.color), (f.fillColors = void 0), (f.bulletColor = void 0))
            var m = !1,
              q = d.fieldMappings
            ...
            if (f.comparable) {
              ...
              if (f.valueAxis) {
                ...
                for (D = 0; D < B; D++) {
                  ...
                  r ||
                    ((r = new e.AmGraph(this.theme)), (r.id = 'comparedGraph_' + f.id + '_' + C.id))
                  f.compareGraphType && (r.type = f.compareGraphType)
                  f.compareGraph &&
                    (e.copyProperties(f.compareGraph, r),
                    f.compareGraph.balloon &&
                      ((r.balloon = {}), e.copyProperties(f.compareGraph.balloon, r.balloon)))
  ...
  e.PeriodSelector = e.Class({
    ...
    selectPeriodButton: function (a, b, c) {
      ...
      f &&
        ...
        'YTD' == g &&
          ((a.startTime = h.getTime()),
          m.getFullYear() < new Date().getFullYear() && (d.style.display = 'none')),
        (a.endTime = n.getTime()),
        b ||
          ((this.skipMark = !0),
