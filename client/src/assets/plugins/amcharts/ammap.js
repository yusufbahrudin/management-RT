  ...
  d.AmChart = d.Class({
    ...
    drawLabel: function (a) {
      ...
      if (b.container && !1 !== a.enabled) {
        ...
        'right' == g && (g = 'end')
        'center' == g &&
          ((g = 'middle'), h ? (c = b.realHeight - c + c / 2) : (n = b.realWidth / 2 - n))
        void 0 === l && (l = 1)
        void 0 === h && (h = 0)
        c += f / 2
    ...
    arrangeEntries: function () {
      ...
      for (w = 0; w < u.length; w++) {
        ...
        F + v.width > p &&
          0 < w &&
          0 !== A &&
          (t++, (F = A = 0), (C = F + v.width + f + n), (x = x + z + m), (z = 0))
        ...
        for (c = 0; c < a.length; c++) {
          ...
          if (e) f.value ? g.text(f.value) : g.text('')
            ...
            f.legendColorFunction &&
              (n = f.legendColorFunction(l, k, f.periodDataItem, f.periodPercentDataItem))
            g.text(k)
            if (
              !f.pattern &&
              (this.useMarkerColorForValues && g.setAttr('fill', n), this.useMarkerColorForLabels)
            ) {
              if ((g = f.legendMarker)) g.setAttr('fill', n), g.setAttr('stroke', n)
              ;(g = f.legendLabel) &&
                (f.hidden ? g.setAttr('fill', this.markerDisabledColor) : g.setAttr('fill', n))
            }
          }
        }
    },
...
;(function () {
  ...
  d.AmMap = d.Class({
        ...
        if ((a = b.mapContainer)) {
          ...
          if (!isNaN(h)) {
            ...
            if (!isNaN(q)) {
              ...
              0.1 < Math.abs(h - k) &&
                (b.zoomTo(h, q, l, !0), (b.mapWasPinched = !0), clearTimeout(b.pinchTO))
            }
          }
          h = a.scale
          b.isDragging &&
    ...
    zoomToObject: function (a) {
      if (a) {
        ...
        var e = a.zoomLevel,
          ...
          l = this.realHeight
        isNaN(e) ||
          (isNaN(b) || isNaN(c) ? this.zoomTo(e, f, k, g) : this.zoomToLongLat(e, c, b, g))
    ...
    zoomTo: function (a, b, c, e) {
      ...
      g = this.zoomLevel()
      isNaN(b) &&
        ((b = this.realWidth / this.mapWidth), (b = (this.zoomX() - 0.5 * b) * (a / g) + 0.5 * b))
      isNaN(c) &&
        ((c = this.realHeight / this.mapHeight), (c = (this.zoomY() - 0.5 * c) * (a / g) + 0.5 * c))
      this.stopAnimation()
      isNaN(a) ||
        ((g = this.mapContainer),
        (this.initialX = g.x),
      ...
      a.mousedown(function (a) {
        ...
        .focus(function (a) {
          ...
          'MapArea' == b.objectType &&
            ((d = c.getAreaCenterLongitude(b)), (f = c.getAreaCenterLatitude(b)))
    ...
    redrawArea: function (a) {
      for (var b = !1, c = '', e = 0; e < a.length; e++) {
        ...
        k < this.minMapXX &&
          ((this.minMapXX = k), (this.leftLongLat = { longitude: g, latitude: f }))
        k > this.maxMapXX &&
          ((this.maxMapXX = k), (this.rightLongLat = { longitude: g, latitude: f }))
        h < this.minMapYY &&
          ((this.minMapYY = h), (this.topLongLat = { longitude: g, latitude: f }))
        h > this.maxMapYY &&
          ((this.maxMapYY = h), (this.bottomLongLat = { longitude: g, latitude: f }))
        b ? (c += ' L ') : ((c += ' M '), (b = !0))
        c += k + ' ' + h
      }
      return c + ' Z '
  ...
  d.ZoomControl = d.Class({
    ...
    update: function () {
      ...
      k &&
        ...
        this.previousDY != f &&
          e &&
          (e.translate((this.buttonSize - this.draggerSize) / 2, f), (this.previousDY = f)))
    }
  })
})()
;(function () {
  ...
  d.SmallMap = d.Class({
    ...
    update: function () {
      ...
      if (a) {
        ...
        0 < c &&
          0 < d &&
          (k.setAttr('width', Math.ceil(c + 1)), k.setAttr('height', Math.ceil(d + 1)))
        this.rWidth = c
        this.rHeight = d
      }
    },
    ...
    getCoordinates: function (a, b) {
      ...
      if (!isNaN(a)) {
        ...
        if (1 < this.longitudes.length) {
          ...
          1 < this.x.length &&
            ((c = this.x[b]), (g = this.x[b + 1]), (d = this.y[b]), (f = this.y[b + 1]))
        k = c + (g - c) * a
        h = d + (f - d) * a
