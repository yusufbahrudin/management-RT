      ...
      var s,
        d = {
          ...
          drawing: {
            ...
            handler: {
              ...
              redo: function () {
                ...
                if (c) {
                  if (((c.selectable = !0), d.drawing.undos.push(c), 'added' == c.action))
              ...
              add: function (c) {
                var u = d.deepMerge(
                    { top: d.setup.fabric.height / 2, left: d.setup.fabric.width / 2 },
                    c || {}
                  ),
              ...
              change: function (c, u, f) {
                ...
                if (
                  ...
                  h.width &&
                    ...
                    1 == d.drawing.width &&
                      (d.drawing.fontSize = h.fontSize = d.defaults.fabric.drawing.fontSize)),
                  ...
                  u ||
                    ((m = JSON.stringify(
                      d.deepMerge(d.getState(S), {
                        cfg: { color: h.color, width: h.width, opacity: h.opacity }
                      })
                    )),
                    (S.recentState = m),
                    (d.drawing.redos = []),
              ...
              if ('clipPath' == w.tagName) {
                ...
                for (m = 0; m < w.childNodes.length; m++)
                  if ('rect' == w.childNodes[m].tagName)
                    ...
                    A.transformMatrix &&
                      ((T.offsetX = A.transformMatrix[4]), (T.offsetY = A.transformMatrix[5]))
                  }
                ...
                return (
                  ...
                  1 < m.length
                    ? N.set({
                        left: N.getLeft() + S,
                        top:
                          N.getTop() + N.fontSize * (m.length - 1) * (0.18 + N._fontSizeFraction),
                        textAlign: u.originX,
                    ...
                    : N.set({
                        left: N.getLeft() + S,
                        top:
                          N.getTop() - N.getHeight() / 2 + N.fontSize * (0.18 + N._fontSizeFraction)
                      }),
                  N
                )
              })
          ...
          capture: function (c, u) {
            ...
            if (!d.handleNamespace('fabric', { scope: this, cb: d.capture, args: arguments }))
              return !1
                  ...
                  ? -1 != ['left', 'right'].indexOf(d.setup.chart.legendSettings.position) &&
                    ...
                    A.has.legend
                      ? (w.pY +=
                          ...
                          d.setup.chart.panelsSettings.panelSpacing)
                      : A.has.scrollbar &&
                        (A.offset.y -= d.setup.chart.panelsSettings.panelSpacing))
                              ...
                              clipTo: (function (Z, Q) {
                                return function ($) {
                                  ...
                                  'map' == d.setup.chart.type &&
                                    ...
                                    this.className ==
                                      d.setup.chart.classNamePrefix + '-graph-bullet' &&
          ...
          toSVG: function (c, u) {
            ...
            if (!d.handleNamespace('fabric', { scope: this, cb: d.toSVG, args: arguments }))
              return !1
          ...
          toXLSX: function (c, u) {
            ...
            return (
              ...
              (S.Sheets[m.name] = (function (T) {
                for (
                  var M = {}, F = { s: { c: 1e7, r: 1e7 }, e: { c: 0, r: 0 } }, D = 0;
                  D != T.length;
                  ++D
                )
          ...
          handleNamespace: function (c, u) {
              ...
              ;(m = !!(c in h)),
                ...
                m
                  ? (clearTimeout(N),
                    ...
                    d.handleLog(
                      ['AmCharts [export]: Namespace "', c, '" showed up in: ', h + ''].join('')
                    ))
                  : S - w < d.libs.loadTimeout
                  ? (N = setTimeout(f, 250))
                  : d.handleLog(
                      ['AmCharts [export]: Gave up waiting for "', c, '" in: ', h + ''].join('')
                    )
            }
            var N,
            ...
            return (
              (m = !!(c in h)),
              m ||
                (d.handleLog(['AmCharts [export]: Could not find "', c, '" in: ', h + ''].join('')),
                f()),
              m
            )
          },
                    ...
                    for (w = 0; w < F.dataSet.dataProvider.length; w++) {
                      ...
                      if (-1 != I)
                        for (N = 0; N < F.dataSet.fieldMappings.length; N++) {
                          ...
                          ;(f.data[I][h] = F.dataSet.dataProvider[w][A.fromField]),
                ...
                for (m = 0; m < d.setup.chart.dataProvider.length; m++) {
                  ...
                  if (O[P])
                    for (w = 0; w < O[P].length; w++)
                      (O[P][w][d.setup.chart.categoryField] = O[d.setup.chart.categoryField]),
                        f.data.push(O[P][w])
                }
          ...
          processData: function (c) {
            ...
            return (
              void 0 !== u.processData && (u.data = d.handleCallback(u.processData, u.data, u)),
              u.data
            )
          },
              ...
              for (S = 0; S < w.length; S++) {
                ...
                ;(void 0 === M.menu || M.menu.length) &&
                        ...
                        (function (H, X) {
                          return function (W) {
                            ...
                            return ('draw' != X.action &&
                              ...
                              ? void H.apply(d, [W, X])
                              : ((X.delay = isNaN(X.delay) ? d.config.delay : X.delay),
                                void d.delay(X, H))
                          }
                        })(
                          M.click ||
                  ...
                  M.icon &&
                    (E.setAttribute(
                      'src',
                      (M.ignore || -1 != M.icon.slice(0, 10).indexOf('//') ? '' : t.pathToImages) +
                        M.icon
                    ),
                    D.appendChild(E)),
              ...
              ((d.docListener = function (u) {
                ...
                function N(D) {
                  d.setup.focusedMenuItem &&
                    ...
                    (d.setup.focusedMenuItem.parentNode.classList.remove('active'),
                    f(
                      d.setup.focusedMenuItem.parentNode.previousSibling.getElementsByTagName('a'),
                      D
                    ))
                }
                function S() {
                  ...
                  d.setup.focusedMenuItem &&
                    (D(d.setup.focusedMenuItem), (d.setup.focusedMenuItem = void 0))
                }
                ...
                ;(8 == u.keyCode || 46 == u.keyCode) && T
                  ...
                  : 90 == u.keyCode &&
                    (u.metaKey || u.ctrlKey) &&
                    (u.preventDefault(),
                    u.shiftKey ? d.drawing.handler.redo() : d.drawing.handler.undo())
              }),
