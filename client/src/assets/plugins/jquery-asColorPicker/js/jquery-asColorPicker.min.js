        ...
        return (
          ...
          (this.mousemove = function (t) {
            ...
            return (
              (e =
                'vertical' === this.direction
                  ? this.data.top + (t.pageY || this.data.startY) - this.data.startY
                  : this.data.left + (t.pageX || this.data.startX) - this.data.startX),
              this.move(e),
              !1
            )
          }),
      ...
      init: function (t, e) {
        ...
        this.options.localStorage
          ? ((s = t.namespace + '_palettes_' + t.id),
            (a = this.getLocal(s)) || ((a = this.options.colors), this.setLocal(s, a)))
    ...
    x = {
      ...
      updatePreview: function (t) {
        this.$previous.css('backgroundColor', t.toRGBA()),
          this.$previous.data('color', { r: t.value.r, g: t.value.g, b: t.value.b, a: t.value.a })
      }
    },
    C = function (t, e) {
      ;(this.api = t),
      ...
      $.extend(i, {
        ...
        bind: function () {
          ...
          i.$gradient.on('update', function () {
            ...
            i.$wrap.on('click', '.' + e + '-gradient-cancel', function () {
              return (
                (!1 === i.options.switchable || l.default.matchString(t.originValue)) &&
                  i.overrideCore(),
                t.cancel(),
                !1
              )
          ...
          ;(t.set = function (e) {
            if (((t.isEmpty = '' === e), 'string' == typeof e))
              !1 === i.options.switchable || l.default.matchString(e)
                ? i.isEnabled
                  ? (i.val(e), (t.color = i.value), i.$gradient.trigger('update', i.value.value))
                  : i.enable(e)
                : (i.disable(), t.val(e))
            else {
        ...
        preview: {
          ...
          render: function () {
            i.$preview.css({ 'background-image': i.value.toStringWithAngle('to right', !0) }),
              i.$preview.css({ 'background-image': i.value.toStringWithAngle('to right') })
          }
        },
        markers: {
          width: 160,
          ...
          move: function (t, e, a) {
            ;(i.api.isEmpty = !1),
              ...
              i.$gradient.trigger('update', { id: $(t).data('id'), position: e })
          }
        },
        wheel: {
          init: function () {
        ...
        u(
          ...
          [
            ...
            },
            {
              key: 'init',
              value: function () {
                ;(this.color = (0, h.default)(this.element.value, this.options.color)),
                  this._create(),
                  this.options.skin &&
            ...
            },
            {
              ...
              value: function () {
                var t = !this.$element.is(':visible'),
                  ...
                  h = void 0
                ;(o =
                  s + e.top > (0, r.default)(window).height() + (0, r.default)(window).scrollTop()
                    ? e.top - s
                    : e.top + i),
                  (h =
                    n + e.left >
                    (0, r.default)(window).width() + (0, r.default)(window).scrollLeft()
                      ? e.left - n + a
                      : e.left),
            ...
            },
            {
              key: 'getString',
              value: function (t, e) {
                return this.options.lang in _ && void 0 !== _[this.options.lang][t]
