  ...
  ;(n.prototype = {
    ...
    setParent: function (e) {
      e.children(this.options.listNodeName).length &&
        (e.prepend(t(this.options.expandBtnHTML)), e.prepend(t(this.options.collapseBtnHTML))),
    ...
    dragStart: function (e) {
      ...
      this.placeEl.css('height', l.height()),
        ...
        this.dragEl.css({ left: e.pageX - a.offsetX, top: e.pageY - a.offsetY })
      var n,
        d,
        h = this.dragEl.find(this.options.itemNodeName)
      for (n = 0; n < h.length; n++)
        (d = t(h[n]).parents(this.options.listNodeName).length) > this.dragDepth &&
          (this.dragDepth = d)
    },
    dragStop: function (t) {
    ...
    dragMove: function (i) {
          ...
          h.distX > 0 &&
            ...
            this.placeEl.parents(d.listNodeName).length + this.dragDepth <= d.maxDepth &&
              (a.length
                ...
                : ((a = t('<' + d.listNodeName + '/>').addClass(d.listClass)).append(this.placeEl),
                  n.append(a),
                  this.setParent(n)))),
          h.distX < 0 &&
      ...
      if (!h.dirAx || g || p) {
        ...
        ;(l = this.placeEl.parent()),
          p
            ? ((a = t(s.createElement(d.listNodeName)).addClass(d.listClass)).append(this.placeEl),
