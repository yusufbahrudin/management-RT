...
!(function (t, n) {
  ...
  function ft(t, n, e, r, i, o, a) {
    ...
    for (u = 0; u < l; ++u)
      (f = n[u]) &&
        ((d[u] = c = at + a.call(f, f.__data__, u, n)), c in s ? (i[u] = f) : (s[c] = f))
    for (u = 0; u < h; ++u)
  ...
  Rt.prototype = Lt.prototype = {
    ...
    data: function (t, n) {
      ...
      for (
        var a = o.length, u = new Array(a), f = new Array(a), c = new Array(a), s = 0;
        s < a;
        ++s
      ) {
        var l = i[s],
  ...
  function _n(t) {
    return (
      t instanceof nn || (t = vn(t)), t ? new mn((t = t.rgb()).r, t.g, t.b, t.opacity) : new mn()
    )
  }
  function bn(t, n, e, r) {
  ...
  Kt(
    ...
    tn(nn, {
      ...
      darker: function (t) {
        return (
          (t = null == t ? 0.7 : Math.pow(0.7, t)), new te(this.h, this.s, this.l * t, this.opacity)
        )
      },
      rgb: function () {
  ...
  function Er(t, n) {
    var e
    return ('number' == typeof n ? ve : n instanceof vn ? ce : (e = vn(n)) ? ((n = e), ce) : be)(
      t,
      n
    )
  }
  ...
  Pr.prototype = zr.prototype = {
    ...
    selectAll: function (t) {
      ...
      for (var r = this._groups, i = r.length, o = [], a = [], u = 0; u < i; ++u)
        for (var f, c = r[u], s = c.length, l = 0; l < s; ++l)
          if ((f = c[l])) {
            for (
              var h, d = t.call(f, f.__data__, l, c), p = Tr(f, e), v = 0, g = d.length;
              v < g;
              ++v
            )
    ...
    transition: function () {
      for (
        var t = this._name, n = this._id, e = Rr(), r = this._groups, i = r.length, o = 0;
        o < i;
        ++o
      )
    ...
    function l() {
      ...
      if (i.apply(this, arguments)) {
        var r,
          ...
          x =
            'selection' === (t.event.metaKey ? (m = 'overlay') : m) ? gi : t.event.altKey ? bi : _i,
          w = n === xi ? null : Ni[m],
          M = n === mi ? null : Si[m],
          A = Pi(b),
          T = A.extent,
      ...
      function B() {
        if ((pi(), t.event.touches)) {
          ...
          Gt(t.event.view, g), q.on('keydown.brush keyup.brush mousemove.brush mouseup.brush', null)
  ...
  ;(aa.copy = function () {
    ...
    (aa.find = function (t, n, e) {
      ...
      for (
        ...
        if (
          !(!(v = f.node) || (i = f.x0) > h || (o = f.y0) > d || (a = f.x1) < s || (u = f.y1) < l)
        )
          if (v.length) {
            var g = (i + a) / 2,
              y = (o + u) / 2
    ...
    (aa.visitAfter = function (t) {
      var n,
        ...
        r = []
      for (
        this._root && e.push(new ta(this._root, this._x0, this._y0, this._x1, this._y1));
        (n = e.pop());
        ...
        return (function (n, e, r) {
          ...
          switch ((r = ba(null == r ? ',f' : r)).type) {
            case 's':
              ...
              return (
                null != r.precision || isNaN((i = ka(u, f))) || (r.precision = i),
                t.formatPrefix(r, f)
              )
            case '':
            case 'e':
  ...
  function V_(t, n) {
    ...
    var s = u - r,
      ...
      h = s / c
    return l
      ? (-h + Math.sqrt(h * h - 2 * l * ((s * s) / (-2 * c) - f + c / 2 + i - o / 2))) / l + r
      : (r + u) / 2
  }
  function $_(t, n) {
    var e = t.N
  ...
  ;(ub.prototype = ob.prototype),
    ...
    (t.ribbon = function () {
      ...
      function a() {
        ...
        if (
          ...
          o.arc(0, 0, s, l, h),
          (l === g && h === y) ||
            (o.quadraticCurveTo(0, 0, v * Li(g), v * Di(g)), o.arc(0, 0, v, g, y)),
    ...
    (t.drag = function () {
      ...
      function p() {
        if (!i && o.apply(this, arguments)) {
          ...
          u &&
            (Dt(t.event.view).on('mousemove.drag', v, !0).on('mouseup.drag', g, !0),
            Xt(t.event.view),
            Ht(),
            (r = !1),
            (n = t.event.clientX),
    ...
    (t.geoPath = function (t, n) {
      ...
      function o(t) {
        return (
          t && ('function' == typeof i && r.pointRadius(+i.apply(this, arguments)), su(t, e(r))),
          r.result()
        )
      }
      return (
