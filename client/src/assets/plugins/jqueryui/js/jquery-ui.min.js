  ...
  e.extend(n.prototype, {
    ...
    e.widget('ui.draggable', e.ui.mouse, {
      ...
      _mouseCapture: function (t) {
        ...
        return this.helper || s.disabled || e(t.target).closest('.ui-resizable-handle').length > 0
          ? !1
          ...
          (h = s.snapElements[c].left),
            ...
            !e.contains(s.snapElements[c].item.ownerDocument, s.snapElements[c].item)
              ...
              : ('inner' !== f.snapMode &&
                  ...
                  a &&
                    (i.position.top =
                      s._convertPositionTo('relative', { top: d, left: 0 }).top - s.margins.top),
                  o &&
                    (i.position.left =
                      s._convertPositionTo('relative', {
                        top: 0,
                  ...
                  r &&
                    (i.position.left =
                      s._convertPositionTo('relative', { top: 0, left: l }).left - s.margins.left)),
                (p = n || a || o || r),
                'outer' !== f.snapMode &&
                  ((n = m >= Math.abs(u - y)),
                  (a = m >= Math.abs(d - b)),
                  ...
                  n &&
                    (i.position.top =
                      s._convertPositionTo('relative', { top: u, left: 0 }).top - s.margins.top),
                  a &&
                    (i.position.top =
                      s._convertPositionTo('relative', {
                  ...
                  o &&
                    (i.position.left =
                      s._convertPositionTo('relative', { top: 0, left: h }).left - s.margins.left),
                  r &&
                    (i.position.left =
                      s._convertPositionTo('relative', {
                        top: 0,
