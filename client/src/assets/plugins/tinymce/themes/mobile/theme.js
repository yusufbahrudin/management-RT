  ...
  var mobile = (function () {
    ...
    var typedValue = function (validator, expectedType) {
      return value$2(function (a) {
        ...
        return validator(a)
          ? Result.value(a)
          : Result.error('Expected type: ' + expectedType + ' but got: ' + actualType)
      })
    }
                  ...
                  console.log(eventName, {
                    ...
                    sequence: map$1(sequence, function (s) {
                      if (!contains(['cut', 'stopped', 'response'], s.outcome)) {
                        ...
                        return (
                          '{' + s.purpose + '} ' + s.outcome + ' at (' + element(s.target) + ')'
                        )
                      }
                    })
                  })
    ...
    var ToggleSchema = [
      ...
      defaultedOf(
        ...
        { mode: 'none' },
        choose$1('mode', {
          pressed: [defaulted$1('syncWithExpanded', false), output$1('update', updatePressed)],
    ...
    var orientation = function (onReceive) {
      return Receiving.config({
        channels: wrap$2(TinyChannels.orientationChanged(), { onReceive: onReceive })
      })
    }
          ...
          function (data) {
            internals[data.pname()] = multiple(true, function (detail, _partSpec, _partValidated) {
              ...
              return map$1(units, function (u) {
                return data
                  .factory()
                  .sketch(deepMerge(data.defaults()(detail, u), u, data.overrides()(detail, u)))
              })
            })
          }
        )
    ...
    var composite = function (owner, schema, partTypes, factory, spec) {
      ...
      return deepMerge(factory(detail, components$$1, specWithUid, subs.externals()), {
    ...
    var spectrumPart = required({
      ...
      overrides: function (detail) {
        ...
        var touchEvents = derive([run(touchstart(), moveToX), run(touchmove(), moveToX)])
        var mouseEvents = derive([
    ...
    var sketch$7 = function (rawSpec) {
      ...
      var reposition = function (dialog, message) {
        descendant$2(dialog.element(), '.' + Styles.resolve('serialised-dialog-chain')).each(
          function (parent) {
    ...
    var generateFrom = function (spec, all) {
      ...
      var validated = asStruct('component.behaviours', objOf(schema), spec.behaviours).fold(
        function (errInfo) {
          throw new Error(
    ...
    var builder = function (detail) {
      return {
        dom: deepMerge(detail.dom(), {
          attributes: { role: detail.toggling().isSome() ? 'menuitemcheckbox' : 'menuitem' }
        }),
        behaviours: deepMerge(
          derive$2([
    ...
    var schema$b = [strict$1('dom'), strict$1('components'), output$1('builder', builder$1)]
    ...
    var schema$d = constant([
      ...
      defaultedOf(
        ...
        choose$1('mode', {
          ...
          menu: [defaulted$1('moveOnTab', true), output$1('config', configureMenu)]
        })
      ),
      itemMarkers(),
    ...
    var beforeSpecial = function (element, offset) {
      ...
      else if (!contains(['br', 'img'], name$$1)) return Situ.on(element, offset)
    ...
    var doGetExact = function (selection) {
      ...
      return after$3(anchorNode, selection.anchorOffset, focusNode, selection.focusOffset)
        ? Option.some(
            range$1(
    ...
    var schema$e = constant([defaulted$1('shell', true), field$1('toolbarBehaviours', [Replacing])])
    ...
    var isDangerous = function (event$$1) {
      ...
      return (
        keyEv.which === BACKSPACE()[0] && !contains(['input', 'textarea'], name(event$$1.target()))
      )
    }
    ...
    var adt$6 = Adt.generate([{ stopped: [] }, { resume: ['element'] }, { complete: [] }])
    ...
    var scrollIntoView = function (cWin, socket, dropup, top, bottom) {
      ...
      if (top > greenzone || bottom > greenzone) {
        IosScrolling.moveOnlyScroll(socket, socket.dom().scrollTop - greenzone + bottom).get(
          refreshCursor
        )
      } else if (top < 0) {
        ...
        editor.on('init', function () {
          realm.init({
            ...
            toolstrip: Element$$1.fromDom(
              editor.editorContainer.querySelector('.' + Styles.resolve('toolstrip'))
            ),
