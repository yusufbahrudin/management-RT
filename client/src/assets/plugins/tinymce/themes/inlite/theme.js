  ...
  var inlite = (function () {
    ...
    function toggleBodyFullScreenClasses(classPrefix, state) {
      if (checkFullscreenWindows() && state === false) {
        global$7([document.documentElement, document.body]).removeClass(classPrefix + 'fullscreen')
      }
    }
      ...
      fullscreen: function (state) {
        ...
        if (state !== self$$1._fullscreen) {
          ...
          if (!state) {
            ...
            global$7([documentElement, document.body]).removeClass(prefix + 'fullscreen')
            ...
            global$7([documentElement, document.body]).addClass(prefix + 'fullscreen')
    ...
    var SplitButton = MenuButton.extend({
      ...
      renderHtml: function () {
        ...
        return (
          ...
          prefix +
          'open" hidefocus="1" tabindex="-1">' +
          (self$$1._menuBtnText ? (icon ? '\xA0' : '') + self$$1._menuBtnText : '') +
          ' <i class="' +
          prefix +
          'caret"></i>' +
          '</button>' +
