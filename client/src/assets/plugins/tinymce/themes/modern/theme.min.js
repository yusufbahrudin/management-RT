!(function () {
  ...
  var e,
    ...
    U = function (e, t, n, i, r, o) {
      return (
        ...
        e && (o = e({ elementRect: I(i), contentAreaRect: I(r), panelRect: o })),
        o
      )
    },
    V = function (x) {
        ...
        n = function (e, t) {
          ...
          if (!x.removed) {
            ...
            x.inline || (o.w = x.getDoc().documentElement.offsetWidth),
              ...
              (r = C.clamp(r, o)),
              n
                ? ((a = C.relativePosition(i, r, n)), F(s, U(u, a.x, a.y, r, o, i)))
                : ((o.h += i.h),
                  (r = C.intersect(o, r))
    ...
    ye = function (t, e, n) {
      var i, r, o, s, a
      if (
        (!1 === g(t) && n.skinUiCss ? ve.styleSheetLoader.load(n.skinUiCss, pe(t)) : pe(t)(),
        (i = e.panel =
          b.create({
            type: 'panel',
            role: 'application',
            ...
            items: [
              {
                ...
                classes: 'top-part',
                items: [
                  !1 === d(t) ? null : { type: 'menubar', border: '0 0 1 0', items: oe(t) },
                  L(t, f(t))
                ]
              },
              me(t)
  ...
  var ke = function () {
    ...
    He = function (e) {
      var t,
        n = O.getUiContainer(e)
      return n && !Ce(e) ? { x: 0, y: 0, w: (t = n).scrollWidth - 1, h: t.scrollHeight - 1 } : ke()
    },
    Se = {
    ...
    nt = {
      ...
      init: function (t) {
        ...
        ;(i.settings = t = w.extend({}, i.Defaults, t)),
          ...
          (i._elmCache = {}),
          (i.$ = xe),
          (i.state = new Ge({ visible: !0, active: !1, disabled: !1, value: '' })),
      ...
      for (r in (d || (d = l._delegates = {}), i)) {
        ...
        'wheel' !== r || et
          ? ('mouseenter' === r || 'mouseleave' === r
              ? l._hasMouseEnter ||
                (xe(l.getEl()).on('mouseleave', s).on('mouseover', u), (l._hasMouseEnter = 1))
  ...
  function Rt(r) {
    ...
    r.settings.autofix &&
      (r.state.get('fixed')
        ? r._autoFixY > e &&
          (r.fixed(!1).layoutRect({ y: r._autoFixY }).repaint(), t(!1, r._autoFixY - e))
  ...
  function Ct(e, t) {
    ...
    if (xt.length)
      for (n = 0; n < xt.length; n++)
        xt[n].modal && (r++, (i = xt[n])), (xt[n].getEl().style.zIndex = r), (xt[n].zIndex = r), r++
    var o = xe('#' + t.classPrefix + 'modal-block', t.getContainerElm())[0]
    i ? xe(o).css('z-index', i.zIndex - 1) : o && (o.parentNode.removeChild(o), (gt = !1)),
      (Et.currentZIndex = r)
  }
  var Et = vt.extend({
    Mixins: [Se, bt],
        ...
        a
          ...
          : ((a = n.panel =
              b.create({
                ...
                border: 1,
                items: [
                  !1 === d(s) ? null : { type: 'menubar', border: '0 0 1 0', items: oe(s) },
                  L(s, f(s))
                ]
              })),
  ...
  function It(e, t) {
    ;(function () {
      ...
      !1 === t &&
      xe([document.documentElement, document.body]).removeClass(e + 'fullscreen')
  }
  var Ft = Et.extend({
    modal: !0,
    Defaults: {
    ...
    recalc: function () {
      var e,
        ...
        o = r.statusbar
      r._fullscreen &&
        (r.layoutRect(_e.getWindowSize()), (r.layoutRect().contentH = r.layoutRect().innerH)),
        r._super(),
        (e = r.layoutRect()),
        r.settings.title &&
          !r._fullscreen &&
  ...
  !(function () {
    if (!de.desktop) {
      ...
      u.setInterval(function () {
        ...
        ;(n.w === e && n.h === t) || ((n = { w: e, h: t }), xe(window).trigger('resize'))
      }, 100)
    }
    xe(window).on('resize', function () {
      var e,
  ...
  var Ut,
    ...
    Gt = Jt.extend({
      ...
      postRender: function () {
        var n = this,
          t = _e.create('input', { type: 'file', id: n._id + '-browse', accept: n.settings.accept })
        n._super(),
    ...
    ln = Pt.extend({
      ...
      renderHtml: function () {
        ...
        return (
          ...
          (t = _e.create('div', e, '<span>' + this.translate(n.text) + '</span>')),
    ...
    gi = function (e, t) {
      ...
      ;/^https?/.test(e) &&
        (o
          ? ((n = o), (i = e), (r = X(n, i)), -1 === r ? W.none() : W.some(r)).isNone() &&
    ...
    ki = function (i) {
      var t = ['alignleft', 'aligncenter', 'alignright', 'alignjustify'],
        ...
        e = [
          ...
          { text: 'Center', icon: 'aligncenter', onclick: Ri(i, 'aligncenter') },
          { text: 'Right', icon: 'alignright', onclick: Ri(i, 'alignright') },
          { text: 'Justify', icon: 'alignjustify', onclick: Ri(i, 'alignjustify') }
        ]
      i.addMenuItem('align', { text: 'Align', menu: e }),
        ...
        w.each(
          ...
          function (e, t) {
            i.addButton(t, { active: !1, tooltip: e[0], cmd: e[1], onPostRender: Ei(i, t) })
          }
        )
    },
    Hi = function (e) {
    ...
    $i = function (e) {
      ...
      ;(n = e),
        w.each(
          ...
          function (e, t) {
            n.addButton(t, { active: !1, tooltip: e, onPostRender: Ei(n, t), onclick: Ri(n, t) })
          }
        ),
        (i = e),
        w.each(
        ...
        w.each(
          ...
          function (e, t) {
            r.addButton(t, { active: !1, tooltip: e[0], cmd: e[1], onPostRender: Ei(r, t) })
          }
        )
    },
    qi = function (e) {
      ...
      $i(e),
        ...
        n.addMenuItem('codeformat', { text: 'Code', icon: 'code', onclick: Ri(n, 'code') })
    },
    Xi = function (n, i) {
      return function () {
        var e = this,
    ...
    ji = function (e) {
      ...
      ;(t = e).addMenuItem('undo', {
        ...
        (n = e).addButton('undo', { tooltip: 'Undo', onPostRender: Xi(n, 'undo'), cmd: 'undo' }),
        n.addButton('redo', { tooltip: 'Redo', onPostRender: Xi(n, 'redo'), cmd: 'redo' })
    },
    Ji = function (e) {
      var t, n
      ...
      setup: function (e) {
        ...
        e.rtl && (ot.rtl = !0),
          ...
          (t = e).settings.ui_container &&
            (de.container = _i(pn.fromDom(document.body), t.settings.ui_container).fold(
              k(null),
              function (e) {
                return e.dom()
              }
      ...
      initLayoutRect: function () {
        ...
        return (
          e.settings.multiline &&
            ...
            (t.startMinH = t.h = t.minH = Math.min(t.maxH, _e.getSize(e.getEl()).height))),
          t
        )
      },
      repaint: function () {
    ...
    yr = Pt.extend({
      ...
      renderHtml: function () {
        ...
        return (
          ...
          ((e = _e.create(i.multiline ? 'textarea' : 'input', t)).value = n.state.get('value')),
