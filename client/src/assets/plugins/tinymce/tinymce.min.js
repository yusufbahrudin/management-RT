...
!(function () {
  ...
  ;(d = /Android/.test(se)),
    ...
    (m = 'FormData' in window && 'FileReader' in window && 'URL' in window && !!ae.createObjectURL),
  ...
  var St = function (e, t, n, r) {
    ...
    if (
      ((t ? t.ownerDocument || t : $e) !== Fe && Me(t), (n = n || []), !e || 'string' != typeof e)
    )
      return n
      ...
      function (e, t, n, r) {
        ...
        if (((n = n || []), 1 === l.length)) {
          ...
          for (
            ...
            if (
              (s = Ae.find[u]) &&
              (r = s(a.matches[0].replace(Nt, Et), (xt.test(i[0].type) && Bt(t.parentNode)) || t))
            ) {
      ...
      init: function (e, t) {
        ...
        if (nn(e)) {
          if (
            ...
            return gn(t).find(e)
          if (n[1]) for (r = rn(e, yn(t)).firstChild; r; ) Gt.call(o, r), (r = r.nextSibling)
          else {
  ...
  var En,
    ...
    Jn = [
      ...
      { name: 'OSX', search: Yn('os x'), versionRegexes: [/.*?os\ x\ ?([0-9]+)_([0-9]+).*/] },
    ...
    $r = {
      getPos: function (e, t, n) {
        var r,
          ...
          u = e.ownerDocument
        if (((n = n || e), t)) {
          if (n === e && t.getBoundingClientRect && 'static' === xr(nr.fromDom(e), 'position'))
            return {
              x: (i =
                (o = t.getBoundingClientRect()).left +
    ...
    Jo = function (e) {
      var u,
        ...
        a = function (e, t, n) {
          ...
          for (
            t = t || '', 'string' == typeof (n = n || []) && (n = Go(n)), r = (e = Go(e)).length;
            r--;
      ...
      v = function (e, t, n) {
        ...
        return (
          r
            ...
            : (r = jo[e]) ||
              ((r = $o(t, ' ', $o(t.toUpperCase(), ' '))), (r = Ko(r, n)), (jo[e] = r)),
          r
        )
      }
    ;(n = Jo((i = i || {}).schema)),
              ...
              if (2 !== a.status)
                if (3 !== a.status) {
                  if (
                    ...
                    'onload' in o &&
                      !(
                        (d = navigator.userAgent.match(/WebKit\/(\d*)/)) && parseInt(d[1], 10) < 536
                      ))
                  )
        ...
        isEmpty: function (e, t) {
          ...
          if ((e = e.firstChild)) {
            ...
            do {
              ...
              if (3 === o && e.parentNode && i[e.parentNode.nodeName] && ui.test(e.nodeValue))
                return !1
              e = a.next()
            } while (e)
          }
  ...
  var zi,
    ...
    Xi = function (r, e) {
      var t = r.selection.getRng(),
        ...
        s = function (e, t) {
          return (
            (n = t),
            (r = e.dom()) && r.hasAttribute && r.hasAttribute(n) ? A.some(vr(e, t)) : A.none()
          )
          var n, r
        }
    ...
    Gi = function (i, e) {
      var n,
        ...
        u = function (e, t) {
          var n = a.get(),
            r = t(n.hasOwnProperty(e) ? n[e] : { listeners: [], previous: _i(A.none()) })
          ;(n[e] = r), a.set(n)
        },
        t =
          ((n = function () {
    ...
    su = function (e) {
      var t,
        ...
        i = function (e, t) {
          ...
          if (t < e.data.length) {
            ...
            if (ja(e.data[t - 1]) && (n.setStart(e, t), n.setEnd(e, t + 1), !ou(n)))
              return o(uu(au(n), !1)), r
          }
          0 < t && (n.setStart(e, t - 1), n.setEnd(e, t), ou(n) || o(uu(au(n), !1))),
            t < e.data.length && (n.setStart(e, t), n.setEnd(e, t + 1), ou(n) || o(uu(au(n), !0)))
        }
      ...
      if ($a(e.container()))
        if (e.isAtEnd())
          ...
          if (((n = eu(e.container(), e.offset())), Ja(n) && i(n, 0), Ya(n) && e.isAtEnd()))
            return o(uu(au(n), !1)), r
  ...
  var lu,
    ...
    _u = function (e, t, n) {
      ...
      var a,
        ...
        f,
        d,
        m = Au((a = i).startContainer, a.startOffset) || Au(a.endContainer, a.endOffset)
      return m
    ...
    Hu = function (e, t) {
      var n,
        ...
        o,
        i = t.container(),
        a = ((n = te(i.childNodes)), (r = e), (o = L(n, r)), -1 === o ? A.none() : A.some(o))
          .map(function (e) {
    ...
    ju = function (e, t) {
      return Mu(e) && t.container() === e
        ? ((r = t),
          ...
          0 < (a = o.text + i.text).length ? (zu(n, a), du(n, r.offset() - o.count)) : r)
        : Vu(e, t)
      var n, r, o, i, a
    },
    qu = function (e) {
    ...
    $u = {
      removeAndReposition: function (e, t) {
        return du.isTextPosition(t)
          ? ju(e, t)
          : ((n = e), (r = t).container() === n.parentNode ? Hu(n, r) : Vu(n, r))
        var n, r
      },
      remove: qu
    },
  ...
  var Qu,
    ...
    cs = function (e, t, n) {
      ...
      if (t.isEqual(du.after(n)) && n.lastChild) {
        if (((u = du.after(n.lastChild)), Ac(e) && os(n.lastChild) && ns(n.lastChild)))
  ...
  var fs,
    ...
    vs = function (e, t, n, r) {
      for (
        ...
        f && ((s = l), (c = f), (o = t === lu.Forwards ? s.next(c) : s.prev(c)));

      ) {
        if (Ao.isBr(o.getNode(!1)))
          return t === lu.Forwards
            ? { positions: hs(t, d).concat([o]), breakType: Qu.Br, breakAt: A.some(o) }
        ...
        if (o.isVisible()) {
          if (e(f, o)) {
            var m =
              ...
              (a = f),
              (u = o),
              Ao.isBr(u.getNode(i === lu.Forwards)) ? Qu.Br : !1 === Bc(a, u) ? Qu.Block : Qu.Wrap)
    ...
    uc = function (e, t, n) {
      ...
      return ((a = u).breakType === Qu.Wrap && 0 === a.positions.length) ||
        (!Ao.isBr(n.getNode()) && (i = u).breakType === Qu.Br && 1 === i.positions.length)
        ? ((r = e),
          (o = t),
          !u.breakAt
            .map(function (e) {
    ...
    Fc = function (e, t, n) {
      ...
      if (((o = n.startContainer), (i = n.startOffset), da(o))) {
        if (
          (Sc(o) || (o = o.parentNode),
          'before' === (a = o.getAttribute('data-mce-caret')) && ((r = o.nextSibling), yc(r)))
        )
          return Ic(r)
    ...
    Gc = function (e, t, n) {
      return e
        ? !Yc(t, n) && ((r = t), !(!du.isTextPosition(r) && Ao.isBr(r.getNode()))) && Xc(t) && Kc(n)
        : !Yc(n, t) && Kc(t) && Xc(n)
      var r
    },
    Jc = function (e, t, n) {
    ...
    Qc = function (e, t) {
      ...
      return Ao.isText(u)
        ...
        : u
        ? Ra(u)
          ? A.some(e ? du.before(u) : ((a = u), Ao.isBr(a) ? du.before(a) : du.after(a)))
          : ((r = t), (o = u), (i = (n = e) ? du.before(o) : du.after(o)), Jc(n, r, i))
        : A.none()
    },
    Zc = {
      fromPosition: Jc,
    ...
    cl = function (e) {
      return (
        Ao.isElement(e) && 'SPAN' === e.tagName && 'bookmark' === e.getAttribute('data-mce-type')
      )
    },
    ll = function (e) {
        ...
        if (
          ...
          for (
            a < (i = u.childNodes).length
              ...
              : (r = new to((u = i[i.length - 1]), e.getParent(u, e.isBlock))).next(!0),
              o = r.current();
            o;
            o = r.next()
          )
    ...
    wl = function (e, t, n, r, o) {
      var i, a, u, s
      for (
        3 === r.nodeType && 0 === r.nodeValue.length && r[o] && (r = r[o]), i = pl(e, r), a = 0;
        a < i.length;
        a++
      )
    ...
    Sl = function (e, t, n, r) {
      ...
      return (
        ...
        t.collapsed &&
          ((o = xl(c, e.getBody(), i, a, !0, r)) && ((i = o.container), (a = o.offset)),
          (o = xl(c, e.getBody(), u, s, !1, r)) && ((u = o.container), (s = o.offset))),
        n[0].inline &&
          (u = r
            ? u
            : (function (e, t) {
        ...
        (n[0].inline || n[0].block_expand) &&
          ((n[0].inline && 3 === i.nodeType && 0 !== a) || (i = El(c, n, i, a, u, s, !0)),
          (n[0].inline && 3 === u.nodeType && s !== u.nodeValue.length) ||
            (u = El(c, n, i, a, u, s, !1))),
        n[0].selector &&
          !1 !== n[0].expand &&
          !n[0].inline &&
          ((i = wl(c, n, t, i, 'previousSibling')), (u = wl(c, n, t, u, 'nextSibling'))),
    ...
    Tl = function (e, t, o) {
      ...
      if (0 < (c = e.select('td[data-mce-selected],th[data-mce-selected]')).length)
        ...
        ;(r = y(l, n) || l),
          (i = y(d, n) || d),
          C(l, r, !0),
          (s = b(r === l ? r : r.nextSibling, 'nextSibling', i === d ? i.nextSibling : i)).length &&
            o(v(s)),
          C(d, i)
      }
    },
  ...
  var Il = function (e) {
    ...
    jl = function (e, o, i, t) {
      ...
      return T(1)
        ? Vl(E, S, k)
        : T(2)
        ? ((f = E), (d = S), (m = k), o.insertAfter(d.reverse(), f), Ul(d[0], m))
        : ((p = S),
          (h = k),
          (v = g = E),
          (y = (b = i).cloneRange()),
  ...
  var Zl = function (a) {
    ...
    rf = function (e, t, n) {
      ...
      if (
          ...
          g.isCollapsed() ||
            ...
            3 === C.nodeType &&
              ...
              ('\xa0' === C.data[x]
                ...
                : '\xa0' === C.data[x - 1] &&
                  (C.deleteData(x - 1, 1), /[\u00a0| ]$/.test(y) || (y = ' ' + y))),
            (t = y))
        var E,
          S,
          k,
          T = { context: (i = g.getNode()).nodeName.toLowerCase(), data: n.data, insert: !0 }
        if (((u = r.parse(t, T)), !0 === n.paste && Hl(e.schema, u) && ql(p, i)))
          return (
        ...
        if ((e._selectionOverrides.showBlockCaretContainer(i), T.invalid)) {
          for (
            nf(e, d), i = g.getNode(), a = e.getBody(), 9 === i.nodeType ? (i = f = a) : (f = i);
            f !== a;
        ...
        p = Xt.extend(
            ...
            : {}),
          {
            ...
            external_plugins:
              ...
              o && o.external_plugins ? Xt.extend({}, o.external_plugins, a) : a)
          }
        )
      return mf(e, g, n, p)
    },
    ...
    Cf = {
      ...
      findRootInline: function (e, t, n) {
        var r,
          o,
          i,
          a = ((r = e), (o = t), (i = n), F(di.DOM.getParents(i.container(), '*', o), r))
    ...
    Gf = function (e) {
      ...
      return Yf(i, a)
        ...
        : ((n = i),
          ...
          (o = r.getRng()),
          qa(
            [xf(n, nr.fromDom(o.startContainer)), xf(n, nr.fromDom(o.endContainer))],
            function (e, t) {
              return (
                !1 === Br(e, t) &&
                (o.deleteContents(),
    ...
    id = function (e, t) {
      return (
        ...
        (o = (n = t).container()),
        (i = n.offset()),
        !1 === du.isTextPosition(n) && o === r.parentNode && i > du.before(r).offset()
    ...
    ad = function (e) {
      return Ra(e.previousSibling)
        ? A.some(((t = e.previousSibling), Ao.isText(t) ? du(t, t.data.length) : du.after(t)))
        : e.previousSibling
      ...
      return ad(o)
        ...
        .orThunk(function () {
          return (
            (e = r),
            (t = o),
            (n = du.before(t.previousSibling ? t.previousSibling : t.parentNode)),
      ...
      return e
        ? (function (e) {
            if (xd(e.previousSibling))
              return Nd(e.previousSibling) || e.previousSibling.appendData(sa), e.previousSibling
        ...
        : (function (e) {
            if (xd(e.nextSibling))
              return wd(e.nextSibling) || e.nextSibling.insertData(0, sa), e.nextSibling
    ...
    tm = function (e, t) {
      ...
      return (
        !!Zd(t) && (e && ha(r) ? em(!0, t.selection, r) : !(e || !va(r)) && em(!1, t.selection, r))
      )
    },
    nm = function (e, t) {
    ...
    cm = function (r, o, i, a) {
      ...
      r.undoManager.ignore(function () {
        ...
        r.selection.setRng(
          ...
          Yd(s, u, du.fromRangeStart(r.selection.getRng())).map(Qd).map(sm(r, o))
      }),
        r.nodeChanged()
    },
    lm = function (n, r, i, o) {
          ...
          return s.isSome() && e.isSome()
            ? Cf.findRootInline(u, a, o)
                .map(function (e) {
                  return (
                    (o = e),
                    !!qa([Zc.firstPositionIn(o), Zc.lastPositionIn(o)], function (e, t) {
                      var n = Cf.normalizePosition(!0, e),
                        r = Cf.normalizePosition(!1, t)
    ...
    Em = function (n) {
      return ((r = n),
      qa([Nm(r.cells(), r.rng().start()), Nm(r.cells(), r.rng().end())], function (e, t) {
    ...
    ig = function (e, t, n, r, o) {
      ...
      for (i = new to(o, u); (s = i[r ? 'prev' : 'next']()); ) {
        ...
        if (Ao.isText(s) && 0 < s.nodeValue.length)
          return !1 === ng(s, f, 'A') ? A.some(cu(s, r ? s.nodeValue.length : 0)) : A.none()
    ...
    bg =
      (Qf([{ before: ['element'] }, { on: ['element', 'offset'] }, { after: ['element'] }]),
      Qf([
        { domRange: ['rng'] },
  ...
  var Hg,
    ...
    np = function (e, t) {
      return 'selectionchange' === t
        ...
        ? (e.eventRoot || (e.eventRoot = tp.select(e.settings.event_root)[0]), e.eventRoot)
        : e.getBody()
    },
    rp = function (e, t, n) {
      var r
      ...
      toggleNativeEvent: function (e, t) {
        ...
        'focus' !== e &&
          ...
          (t
            ...
            : n.initialized && (n.dom.unbind(np(n, e), e, n.delegates[e]), delete n.delegates[e]))
      },
  ...
  function fp(i) {
    var a = {},
      ...
      u = function (e) {
        ...
        for (n in (up(sp(e, '+'), function (e) {
          e in lp
            ...
            : ((r.charCode = e.charCodeAt(0)), (r.keyCode = cp[e] || e.toUpperCase().charCodeAt(0)))
        }),
        (t = [r.keyCode]),
        lp))
          r[n] ? t.push(n) : (r[n] = !1)
      ...
      s = function (e, t, n, r) {
        var o
        return (
          ((o = Xt.map(sp(e, '>'), u))[o.length - 1] = Xt.extend(o[o.length - 1], {
            func: n,
            scope: r || i
          })),
  ...
  var dp = function (e) {
    ...
    gp = function (t, e) {
      return ((n = e),
      n.collapsed ? A.from(Va(n.startContainer, n.startOffset)).map(nr.fromDom) : A.none()).bind(
        function (e) {
    ...
    Ap = function (e, t, n) {
      ...
      return (
        (l = h.x), (f = h.y), (d = Ep((c = p))), (m = Sp(c)), 0 <= l && 0 <= f && l <= d && f <= m
      )
    },
    _p = function (e) {
      var t,
  ...
  function nh(u) {
    var n,
      ...
      C = function (n) {
        return (
          a || (a = jp(d, { url: Zs(u), basePath: ec(u), credentials: tc(u), handler: nc(u) })),
          N().then(
            g(function (r) {
              var e
              return (
                ...
                a.upload(e, b).then(
                  g(function (e) {
                    var t = $(e, function (e, t) {
                      var n = r[t].image
                      return (
                        e.status && Qs(u) ? y(n, e.url) : e.error && Mp(u, e.error),
    ...
    ah = function (e) {
      ...
      if (
        ...
        v &&
          Ao.isElement(v) &&
          f &&
          ((l = b.nodeName.toLowerCase()), p.isValidChild(l, f.toLowerCase()) && !oh(h, b, v)))
      ) {
        for (
  ...
  var Th = function (o, i, a, e, u, t) {
    ...
    Mh = function (e, o) {
      return jt.reduce(e, function (e, t) {
        ...
        return (
          ...
          Ih(o, t) ? t : Ih(o, e) ? e : r === n && Bh(t.node) ? t : r < n ? t : e
        )
      })
    },
    Fh = function (e, t, n, r) {
    ...
    zh = function (e, t, n) {
      var r,
        ...
        c,
        l,
        f = kh(((o = e), jt.filter(jt.toArray(o.getElementsByTagName('*')), yc))),
                  ...
                  ? ((l = f = n.cloneNode(!0)),
                    (s = g.fire('ObjectSelected', {
                      ...
                      : ((r = ji(nr.fromDom(g.getBody()), '#' + h).fold(
                        ...
                        o.addRange(e),
                        M(Mi(nr.fromDom(g.getBody()), '*[data-mce-selected]'), function (e) {
      ...
      (o = {
        ...
        add: function (e, t) {
          var n,
            ...
            o,
            i = u.settings
          if (((o = mv(u)), (e = e || {}), (e = Xt.extend(e, o)), !1 === f() || u.removed))
            return null
          if (
            ((r = l[c]),
            u
        ...
        undo: function () {
          ...
          return (
            ...
            0 < c && ((e = l[--c]), gv(u, e, !0), d(!0), u.fire('undo', { level: e })),
            e
          )
        },
        redo: function () {
          var e
          return (
            c < l.length - 1 && ((e = l[++c]), gv(u, e, !1), d(!0), u.fire('redo', { level: e })), e
          )
        },
        clear: function () {
  ...
  var vv,
        ...
        if ('undefined' == typeof c.length) {
          for (a in c)
            if (c.hasOwnProperty(a)) {
              if (
                ((u = 'attributes' === r ? e.getAttrib(t, a) : ml.getStyle(e, t, a)),
                o && !u && !n.exact)
              )
                return
              if ((!o || n.exact) && !yv(u, ml.normalizeStyleValue(e, ml.replaceVars(c[a], i), a)))
                return
            }
        } else
    ...
    Ev = function (e, t, n, r, o) {
      ...
      if (c && t)
        for (a = 0; a < c.length; a++)
          if (
            ((i = c[a]),
            wv(e.dom, t, i) && Nv(l, t, i, 'attributes', o, r) && Nv(l, t, i, 'styles', o, r))
          ) {
    ...
    Sv = {
      ...
      match: function (e, t, n, r) {
        ...
        return r
          ? xv(e, r, t, n)
          : ((r = e.selection.getNode()),
            !!xv(e, r, t, n) || !((o = e.selection.getStart()) === r || !xv(e, o, t, n)))
      },
      ...
      return (
        t === r && Ao.isText(t)
          ? 0 < n &&
            ...
            n < o
              ? ((t = r = kv(r, (o -= n)).previousSibling), (o = r.nodeValue.length), (n = 0))
              : (o = 0))
          : (Ao.isText(t) && 0 < n && n < t.nodeValue.length && ((t = kv(t, n)), (n = 0)),
            Ao.isText(r) &&
              0 < o &&
    ...
    Bv = function (e) {
      ...
      return (
        hr(t, { id: _v, 'data-mce-bogus': '1', 'data-mce-type': 'format-caret' }),
    ...
    Pv = function (e, t, n) {
      ...
      var r = e.dom,
        o = e.selection
      if (t) Ov(e, t, n)
      else if (!(t = Lu(e.getBody(), o.getStart()))) for (; (t = r.get(_v)); ) Ov(e, t, !1)
    },
    Lv = function (e, t, n) {
      var r = e.dom,
      ...
      o && r.isEmpty(o)
        ...
        : (Kl(nr.fromDom(n)), r.isEmpty(n) ? n.parentNode.replaceChild(t, n) : r.insertAfter(t, n))
    },
    Iv = function (e, t) {
  ...
  var jv = function (e, t) {
    ...
    Xv = function (e, t, n) {
      ...
      return (
        ...
        Ao.isText(r) && n && o >= r.nodeValue.length && (r = new to(r, e.getBody()).next() || r),
        Ao.isText(r) && !n && 0 === o && (r = new to(r, e.getBody()).prev() || r),
        r
      )
    },
    Yv = function (e, t, n, r) {
        ...
        for (
          $v(n.styles, function (e, t) {
            ;(e = ml.normalizeStyleValue(y, ml.replaceVars(e, r), t)),
              ...
              (n.remove_similar || !i || Wv(ml.getStyle(y, i, t), e)) && y.setStyle(o, t, ''),
              (u = 1)
          }),
            u &&
              '' === y.getAttrib(o, 'style') &&
                ...
                ((g.list_block && Wv(m, g.list_block)) ||
                  $v(Xt.grep(m.childNodes), function (e) {
                    ml.isValid(d, b, e.nodeName.toLowerCase())
                      ? p
                        ? p.appendChild(e)
                        : ((p = Yv(v, e, b)), v.setAttribs(p, d.settings.forced_root_block_attrs))
                      : (p = 0)
                  }))
              : v.isBlock(m) &&
                !v.isBlock(h) &&
                ...
                Gv(v, m, !0) || Gv(v, m.lastChild, !1, 1) || m.appendChild(v.create('br')))),
            ...
            u =
              ...
              $v(ml.getParents(n.dom, t.parentNode).reverse(), function (e) {
                ...
                a ||
                  '_start' === e.id ||
                  '_end' === e.id ||
                  ((t = Sv.matchNode(n, e, r, o, i)) && !1 !== t.split && (a = e))
              }),
              a)
            ...
            if (((e = Tv(e)), (t = Xv(s, e, !0)) !== (n = Xv(s, e)))) {
              if (
                ...
                r &&
                  ...
                  n.firstChild &&
                  (n = n.firstChild || n),
                u.isChildOf(t, n) && t !== n && !u.isBlock(n) && !Kv(t) && !Kv(n))
              ) {
              ...
              ;(t = Yv(u, t, 'span', { id: '_start', 'data-mce-type': 'bookmark' })),
                (n = Yv(u, n, 'span', { id: '_end', 'data-mce-type': 'bookmark' })),
                i(t),
                i(n),
                (t = p(!0)),
                (n = p())
      ...
      if (e) e.nodeType ? ((n = u.createRng()).setStartBefore(e), n.setEndAfter(e), o(n)) : o(e)
        ...
        !u.select('td[data-mce-selected],th[data-mce-selected]').length
          ...
          : ((t = Bu.getPersistentBookmark(s.selection, !0)),
            o(r.getRng()),
            r.moveToBookmark(t),
            m.inline && Sv.match(s, c, l, r.getStart()) && ml.moveStart(u, r, r.getRng()),
            s.nodeChanged())
      else {
        e = r.getNode()
        for (
          ...
          return (
            ...
            (pb(e, function (e) {
              if (!('collapsed' in e && e.collapsed !== o))
                return i.is(t, e.selector) && !Pu(t) ? (y(t, e), !(n = !0)) : void 0
            }),
            n)
          )
        },
                ...
                u = function (e) {
                  ...
                  if (b.wrapper && Sv.matchNode(g, e, p, h)) a = 0
                    ...
                    (b.inline && s.isBlock(e))
                      ? ((a = 0), pb(Xt.grep(e.childNodes), u), r && (m = o), (a = 0))
                ...
                a = function (e) {
                  ...
                  return (
                    pb(e.childNodes, function (e) {
                      if ((t = e) && 1 === t.nodeType && !cl(t) && !Pu(t) && !Ao.isBogus(t))
                        return (n = e), !1
                      var t
                    }),
                    n
      ...
      if ('false' !== i.getContentEditable(n.getNode())) {
        if (b) {
          if (r)
            r.nodeType
              ? C(v, r) ||
                ((t = i.createRng()).setStartBefore(r), t.setEndAfter(r), a(i, Sl(g, t, v), 0, !0))
              : a(i, r, 0, !0)
  ...
  var Rb,
    ...
    Ib = function (e, t) {
      var n,
        r = ti()
      t.convert_fonts_to_spans && Lb(e, r, Xt.explode(t.font_size_legacy_values)),
        (n = r),
      ...
      e = {
        ...
        parse: function (e, a) {
          ...
          ;(a = a || {}),
            (R = {}),
            (D = {}),
            (l = Jb(Xb('script,style,head,html,body,title,meta,param'), T.getBlockElements()))
          ...
          t = Jh(
            {
              ...
              text: function (e, t) {
                var n
                f || ((e = e.replace(x, ' ')), Wb(d.lastChild, l) && (e = e.replace(y, ''))),
              ...
              start: function (e, t, n) {
                ...
                if ((n = h ? T.getElementRule(e) : {})) {
                  ...
                  if (
                    (f && b[e] && (f = !1),
                    n.removeEmpty && $b(T, g, b, d) && !d.attributes.map.name && !d.attr('id'))
                  )
                        ...
                        if (m[n.name] && 'li' === n.parent.name) {
                          ...
                          if (r && 1 < o.length) {
                            ...
                            $b(T, l, f, i)
                              ...
                              (r = o[0]),
                              ($b(T, l, f, r) || qb(r, 'br')) && r.empty().remove()
                          } else if (n.parent) {
                            if ('li' === n.name) {
                  ...
                  for (; n; )
                    (e = n.next),
                      ...
                      (1 === n.type && 'p' !== n.name && !l[n.name] && !n.attr('data-mce-type'))
                        ? (t || ((t = N(v, 1)).attr(k.forced_root_block_attrs), S.insert(t, n)),
                          t.append(n))
                        : (r(t), (t = null)),
                      (n = e)
                  r(t)
  ...
  var iy = oy,
      ...
      return (
        M(Mi(e, 'tr'), function (n, r) {
          M(Mi(n, 'td,th'), function (e, t) {
            !(function (e, t, n, r, o) {
              for (
                var i = hy(o, 'rowspan'), a = hy(o, 'colspan'), u = e.rows(), s = n;
                s < n + i;
                s++
              ) {
                u[s] || (u[s] = gy(ta(r), []))
    ...
    _y = function (e, t) {
      ...
      if ('text' === t.format)
        return e.selection.isCollapsed() ? '' : ca(r.text || (i.toString ? i.toString() : ''))
      r.cloneContents
        ? (n = t.contextual ? Ay(nr.fromDom(e.getBody()), a).dom() : r.cloneContents()) &&
          o.appendChild(n)
    ...
    Fy = function (u, s, e, c) {
      var n,
        ...
        m = function () {
          ...
          return (
            (t = fy(c, [t])[0]) || (t = r.createRange ? r.createRange() : r.body.createTextRange()),
            t.setStart &&
            ...
            return (
              ...
              (t = m())
                ? ((r = t.startContainer),
                  ...
                  3 === r.nodeType &&
                    3 === o.nodeType &&
                    ((r = r.length === i ? Py(r.nextSibling, !0) : r.parentNode),
        ...
        : ((u = da(r.startContainer)),
          f((i = Hc(e, t.getBody(), r)))
            ...
            ? f(i)
              ...
              : f((a = n(i))) && ((!(c = Bc((s = i), a)) && Ao.isBr(s.getNode())) || c)
    ...
    $y = function (e, t, n, r) {
      ...
      if (((c = s.left), (u = Mh(a, c)) && zy(u.node)))
        return (l = Math.abs(c - u.left)), (f = Math.abs(c - u.right)), Xu(e, t, u.node, l < f, !0)
      if (d) {
    ...
    gC = function (e, t, n, r, o) {
      ...
      if (n !== e.getBody()) {
        ...
        if (mC(n, r, !0) && mC(n, r, !1)) lC(n, 'LI') ? i.insertAfter(l, dC(n)) : i.replace(l, n)
          ...
          lC(n, 'LI')
            ? (i.insertAfter(l, dC(n)), l.appendChild(i.doc.createTextNode(' ')), l.appendChild(n))
    ...
    xC = function (a, e) {
      var t,
        ...
        S = function (e) {
          ...
          for (
            t = new to(s, c),
              Ao.isText(s) && (e && 0 === o ? t.prev() : e || o !== s.nodeValue.length || t.next());
            (n = t.current());
        ...
        k = function () {
          ;(r = /^(H[1-6]|PRE|FIGURE)$/.test(f) && 'HGROUP' !== d ? E(m) : E()),
            Ws(a) && vC(C, l) && C.isEmpty(c) ? (r = C.split(l, c)) : C.insertAfter(r, c),
            iC(a, r)
        }
            ...
            (s = (function (e, t, n, r, o) {
              ...
              if (!(a = m.getParent(r, m.isBlock)) || !vC(m, a)) {
                ...
                if (u && e.schema.isValidChild(l, d.toLowerCase())) {
                  for (
                    i = m.create(d), CC(e, i), u.parentNode.insertBefore(i, u), s = u;
                    s && !m.isBlock(s);
          ...
          /^(LI|DT|DD)$/.test(f) && C.isEmpty(c)
            ...
            : (m && c === a.getBody()) ||
              ...
              da(c)
                ...
                ? k()
                : S(!0)
                ? ((r = c.parentNode.insertBefore(E(), c)), iC(a, hC(c, 'HR') ? r : c))
                : ((t = ((b = N),
                  (y = b.cloneRange()),
                  ...
                  (function (e) {
                    for (
                      ;
                      Ao.isText(e) && (e.nodeValue = e.nodeValue.replace(/^[\r\n]+/, '')),
                        (e = e.firstChild);
                    ...
                    if (o) {
                      ...
                      for (r = i.length; r--; )
                        ...
                        (o.firstChild === o.lastChild && '' === o.firstChild.nodeValue)
                          ...
                          : (a = o) &&
                            'A' === a.nodeName &&
                            0 === Xt.trim(ca(a.innerText || a.textContent)).length &&
                            e.remove(o)
                      var a
                    }
                  })(C, w, r),
    ...
    HC = function (r) {
      r.on('keydown', function (e) {
        ...
        !1 === e.isDefaultPrevented() &&
          ((t = r),
          (n = e),
          Jy([{ keyCode: Hh.SPACEBAR, action: Gy(VC, t) }], n).each(function (e) {
            n.preventDefault()
          }))
      })
    },
    jC = function (e, t) {
      ...
      t.hasAttribute('data-mce-caret') &&
        (xa(t), (n = e).selection.setRng(n.selection.getRng()), e.selection.scrollIntoView(t))
    },
    qC = function (e, t) {
      var n,
        r =
          ((n = e),
          ji(nr.fromDom(n.getBody()), '*[data-mce-caret]').fold(j(null), function (e) {
            return e.dom()
          }))
      if (r)
  ...
  var XC = function (e) {
    ...
    tx = function (e, t) {
      var n,
        ...
        (s = nr.fromTag('iframe')),
        hr(s, i),
        hr(s, { id: n + '_ifr', frameBorder: '0', allowTransparency: 'true', title: r }),
        Cr(s, {
          width: '100%',
      ...
      return (
        ...
        (e.iframeHTML =
          ...
          (d = Ms(f)),
          (m = Fs(f)),
          zs(f) && (g += '<meta http-equiv="Content-Security-Policy" content="' + zs(f) + '" />'),
          (g +=
            '</head><body id="' +
            d +
    ...
    cx = function (t) {
      ...
      return (
        ...
        (u.aria_label =
          u.aria_label || rx.getAttrib(s, 'aria-label', t.getLang('aria.rich_text_area'))),
        ...
        T(o)
          ? ((n.settings.theme = ix(o)),
            ...
            n.theme.init &&
              n.theme.init(n, Vp.urls[o] || n.documentBaseUrl.replace(/\/$/, ''), n.$))
          : (n.theme = {}),
        (i = t),
        (a = []),
        ...
        if (t.getElement() && fe.contentEditable) {
          ...
          o &&
            ...
            e.hidden_input &&
              ...
              (lx.insertAfter(lx.create('input', { type: 'hidden', name: n }), n),
              (t.hasHiddenInput = !0)),
    ...
    yx = function (r, e) {
      ...
      if (
        ...
        0 !== r.indexOf('/') || i || (r = ((t && t.protocol) || 'http') + '://mce_host' + r),
          /^[\w\-]*:?\/\//.test(r) ||
            ((n = e.base_uri ? e.base_uri.path : new yx(document.location.href).directory),
            '' == e.base_uri.protocol
  ...
  var Cx = function (e, t, n) {
      ...
      return (
        'text' === t.format || vo(nr.fromDom(n)) ? (t.content = r) : (t.content = Xt.trim(r)),
    ...
    Sx = function (u, s, c) {
      return (
        ...
        (c.set = !0),
        (c.content = Nx(s) ? '' : s),
        Nx(s) || c.no_events || (u.fire('BeforeSetContent', c), (s = c.content)),
            ...
            : ((t = u),
              ...
              0 === (r = s).length || /^\s+$/.test(r)
                ? ((a = '<br data-mce-bogus="1">'),
                  ...
                  (i = Vs(t)) && t.schema.isValidChild(n.nodeName.toLowerCase(), i.toLowerCase())
    ...
    Ax = function (e) {
      if (!e.removed) {
        ...
        r && e.save({ is_removing: !0 }),
          ...
          !e.inline && r && ((i = e), kx.setStyle(i.id, 'display', i.orgDisplay)),
          Kg(e),
    ...
    (Lx.prototype = {
      ...
      hide: function () {
        ...
        e.hidden ||
          ...
          e.inline
            ...
            : (Rx.hide(e.getContainer()), Rx.setStyle(e.id, 'display', e.orgDisplay)),
          (e.hidden = !0),
          e.fire('hide'))
      },
      isHidden: function () {
      ...
      getContent: function (e) {
        return (
          (t = this),
          void 0 === (n = e) && (n = {}),
          A.from(t.getBody()).fold(j('tree' === n.format ? new Vb('body', 11) : ''), function (e) {
            return Cx(t, n, e)
          })
        )
        var t, n
      ...
      getContainer: function () {
        return (
          this.container || (this.container = Rx.get(this.editorContainer || this.id + '_parent')),
          this.container
        )
      },
  ...
  var Ix,
    ...
    aw = function (e) {
      e !== nw &&
        (e ? gn(window).on('resize scroll', iw) : gn(window).off('resize scroll', iw), (nw = e))
    },
    uw = function (t) {
      var e = ow
      delete rw[t.id]
      ...
      return (
        ...
        Fx.activeEditor === t && (Fx.activeEditor = 0 < ow.length ? ow[0] : null),
  ...
  ew(
    (Fx = {
      ...
      overrideDefaults: function (e) {
        var t, n
        ;(t = e.base_url) &&
          ((this.baseURL = new yx(this.documentBaseURL).toAbsolute(t.replace(/\/+$/, ''))),
          (this.baseURI = new yx(this.baseURL))),
          (n = e.suffix),
      ...
      add: function (e) {
        ...
        return (
          rw[e.id] === e ||
            (null === t.get(e.id) && ('length' !== e.id && (rw[e.id] = e), rw.push(e), ow.push(e)),
            aw(!0),
            (t.activeEditor = e),
      ...
      send: function (e) {
        ...
        if (
          ...
          if (
            ...
            (t = Dw.fire('beforeSend', { xhr: t, settings: e }).xhr).send(e.data),
            !e.async)
          )
            return r()
          setTimeout(r, 10)
          ...
          return (
            ...
            (n.toHsv = function () {
              return (
                ...
                (n = c),
                (o = 0),
                (i = Sw((e /= 255), Sw((t /= 255), (n /= 255)))) === (a = kw(e, kw(t, n)))
                  ? { h: 0, s: 0, v: 100 * (o = i) }
                  : ((r = (a - i) / a),
                    {
                      h: Tw(
