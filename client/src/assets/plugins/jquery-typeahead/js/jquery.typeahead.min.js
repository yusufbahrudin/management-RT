...
!(function (e) {
  ...
  'function' == typeof define && define.amd
    ...
    ? (module.exports =
        (void 0 === t &&
          (t = 'undefined' != typeof window ? require('jquery') : require('jquery')(void 0)),
        e(t)))
    : e(jQuery)
})(function (j) {
  'use strict'
  ...
  ;(l.prototype = {
    ...
    extendOptions: function () {
      if (
        ...
        this.options.compression &&
          (('object' == typeof LZString && this.options.cache) || (this.options.compression = !1)),
        ...
        this.options.group &&
          (Array.isArray(this.options.group) ||
            ('string' == typeof this.options.group
              ...
              : 'boolean' == typeof this.options.group && (this.options.group = { key: 'group' }),
        ...
        for (var t = 0, e = this.options.dropdownFilter.length; t < e; ++t)
          this.dropdownFilter[this.options.dropdownFilter[t].value ? 'static' : 'dynamic'].push(
            this.options.dropdownFilter[t]
          )
      }
    ...
    unifySourceFormat: function () {
      ...
      'string' == typeof this.options.source &&
        (this.options.source = { group: { ajax: { url: this.options.source } } }),
      ...
      this.options.source))
        if (this.options.source.hasOwnProperty(t)) {
          ...
          e.display && !Array.isArray(e.display) && (e.display = [e.display]),
            ...
            (e.cache =
              void 0 !== e.cache ? this._validateCacheMethod(e.cache) : this.options.cache),
            ...
            if (!i.options.mustSelectItem || !i.helper.isEmpty(i.item))
              return (
                ...
                i.options.callback.onSubmit
                  ? i.helper.executeCallback.call(i, i.options.callback.onSubmit, [
                      i.node,
                      this,
                      i.item || i.items,
                      t
      ...
      this.node.off(this.namespace).on(t.join(' '), function (t, e) {
        switch (t.type) {
          ...
          case 'focus':
            ...
            i.options.backdropOnFocus && (i.buildBackdropLayout(), i.showLayout()),
              i.options.searchOnFocus &&
                !i.item &&
                ((i.deferred = j.Deferred()), i.assignQuery(), i.generateSource())
            break
          case 'keydown':
            8 === t.keyCode &&
          ...
          case 'keyup':
            n &&
              i.node[0].value.replace(/^\s+/, '').toString().length < i.query.length &&
          ...
          case 'input':
            ;(i.deferred = j.Deferred()),
              ...
              '' === i.rawQuery &&
                '' === i.query &&
                ((t.originalEvent = e || {}),
                i.helper.executeCallback.call(i, i.options.callback.onCancel, [i.node, i.item, t]),
                (i.item = null)),
              ...
              i.options.hint &&
                ...
                (i.hint.container.val(''), i.isContentEditable && i.hint.container.text('')),
              i.hasDynamicGroups
          ...
          case 'search':
            i.searchResult(),
              i.buildLayout(),
              i.result.length || (i.searchGroups.length && i.displayEmptyTemplate)
                ? i.showLayout()
                : i.hideLayout(),
        ...
        for (var t in this.options.source)
          if (
            ...
            if (
              ...
              continue
            if ((this.searchGroups.push(t), !this.options.source[t].dynamic && this.source[t]))
              continue
    ...
    generateSource: function (t) {
      ...
      for (
        var i, s, o, n, r, a, l, h = this, c = ((e = 0), this.generateGroups.length);
        e < c;
        ++e
      ) {
        if (
        ...
        !o.data || o.ajax
          ? o.ajax &&
            (this.requests[i] || (this.requests[i] = this.generateRequestObject(i)),
    ...
    handleRequests: function () {
      ...
      if (
        !1 !==
        this.helper.executeCallback.call(this, this.options.callback.onSendRequest, [
          this.node,
          this.query
        ])
      )
                ...
                if (
                  ...
                  for (var s in r.request.data)
                    if (
                      ...
                      i || ((r = j.extend(!0, {}, r)), (i = !0)),
                        (r.request.data[s] = r.request.data[s].replace('{{query}}', h.query))
                      break
                    }
                j.ajax(r.request)
                  .done(function (t, e, i) {
                    for (var s, o = 0, n = r.validForGroup.length; o < n; o++)
                      (s = r.validForGroup[o]),
                        'function' == typeof (a = h.requests[s]).callback.done &&
                          (l[s] = a.callback.done.call(h, t, e, i))
                  })
                  .fail(function (t, e, i) {
                    for (var s = 0, o = r.validForGroup.length; s < o; s++)
                      (a = h.requests[r.validForGroup[s]]).callback.fail instanceof Function &&
                  ...
                  .always(function (t, e, i) {
                    for (var s, o = 0, n = r.validForGroup.length; o < n; o++) {
                      if (
                        ((s = r.validForGroup[o]),
                        (a = h.requests[s]).callback.always instanceof Function &&
                          a.callback.always.call(h, t, e, i),
                        'abort' === e)
                      )
                        return
                      h.populateSource(
                        (null !== t && 'function' == typeof t.promise && []) || l[s] || t,
                        a.extra.group,
                        a.extra.path || a.request.path
                      ),
                        0 === (c -= 1) &&
                          h.helper.executeCallback.call(h, h.options.callback.onReceiveRequest, [
                            h.node,
                            h.query
                          ])
                    }
                  ...
                  .then(function (t, e) {
                    for (var i = 0, s = r.validForGroup.length; i < s; i++)
                      (a = h.requests[r.validForGroup[i]]).callback.then instanceof Function &&
    ...
    populateSource: function (i, t, e) {
      ...
      e && 'string' == typeof e && (i = this.helper.namespace.call(this, e, i)),
        Array.isArray(i) || (i = []),
        n && ('function' == typeof n && (n = n()), Array.isArray(n) && (i = i.concat(n)))
      for (
        var r,
          a = o.display
        ...
        null !== i[l] &&
          'boolean' != typeof i[l] &&
          ('string' == typeof i[l] && (((r = {})[a] = i[l]), (i[l] = r)), (i[l].group = t))
            ...
            (c = this.dropdownFilter.dynamic[d].key),
              (p = i[l][c]) &&
                ...
                ~u[c].indexOf(p.toLowerCase()) ||
                  (u[c].push(p.toLowerCase()), this.dropdownFilter.dynamic[d].value.push(p)))
      }
      if (this.options.correlativeTemplate) {
        ...
        if (('function' == typeof m && (m = m.call(this, '', {})), m)) {
          ...
          o.display
            ...
            : ~this.options.display.indexOf('compiled') || this.options.display.unshift('compiled')
        } else;
      }
      this.options.callback.onPopulateSource &&
        (i = this.helper.executeCallback.call(this, this.options.callback.onPopulateSource, [
          this.node,
          i,
          t,
          e
      ...
      if (y && !window[y].getItem('TYPEAHEAD_' + this.selector + ':' + t)) {
        this.options.callback.onCacheSave &&
          (i = this.helper.executeCallback.call(this, this.options.callback.onCacheSave, [
            this.node,
            i,
            t,
            e
    ...
    incrementGeneratedGroup: function () {
      if ((this.generatedGroupCount++, this.generatedGroupCount === this.generateGroups.length)) {
        ...
        for (var t = 0, e = this.generateGroups.length; t < e; t++)
          this.source[this.generateGroups[t]] = this.tmpSource[this.generateGroups[t]]
    ...
    navigate: function (t) {
      if (
        (this.helper.executeCallback.call(this, this.options.callback.onNavigateBefore, [
          this.node,
          this.query,
          t
        ]),
        ...
        return (
          ...
          void (this.query.length
            ? (this.resetInput(), this.node.trigger('input' + this.namespace, [t]))
          ...
          9 === t.keyCode
            ...
            ? (t.preventDefault(),
              0 < s.length
                ...
                : i.length && ((r = i.length - 1), this.addActiveItem(i.last())))
            : 40 === t.keyCode &&
              (t.preventDefault(),
              0 < s.length
            ...
            t.preventInputChange &&
              ...
              this.buildHintLayout(null !== e && e < this.result.length ? [this.result[e]] : null),
            this.options.hint &&
              this.hint.container &&
    ...
    getTemplateValue: function (i) {
      if (i) {
        var t =
          (i.group && this.options.source[i.group].templateValue) || this.options.templateValue
      ...
      this.resetLayout(),
        !1 !==
          ...
          this.isDropdownEvent &&
            (this.helper.executeCallback.call(this, this.options.callback.onDropdownFilter, [
              this.node,
              this.query,
              this.filters.dropdown,
              this.result
      ...
      for (var v = 0, b = this.searchGroups.length; v < b; ++v)
        if (
          ...
          for (
            ...
            k < w && (!(this.resultItemCount >= f) || this.options.callback.onResult);
            k++
          )
            if (
              ...
              if (
                ...
                break
              for (
                var x = 0, C = (S = this.options.source[F].display || this.options.display).length;
                x < C;
                ++x
              ) {
                if (!1 !== o) {
                  if (
                    void 0 ===
                      (s = /\./.test(S[x]) ? this.helper.namespace.call(this, S[x], t) : t[S[x]]) ||
                    '' === s
                  )
                    continue
        ...
        for (var F in this.tmpResult)
          if (this.tmpResult.hasOwnProperty(F)) {
            for (v = 0, b = this.tmpResult[F].length; v < b; v++)
              (O = this.options.source[this.tmpResult[F][v].group].display || this.options.display),
    ...
    buildLayout: function () {
      this.buildHtmlLayout(),
        ...
        this.tmpResultHtml instanceof j
          ...
          : this.resultHtml instanceof j && this.resultContainer.html(this.resultHtml),
        this.options.callback.onLayoutBuiltAfter &&
          this.helper.executeCallback.call(this, this.options.callback.onLayoutBuiltAfter, [
            this.node,
            this.query,
            this.result
          ])
      ...
      if (!1 !== this.options.resultContainer) {
        ...
        if (
          (this.resultContainer ||
            ((this.resultContainer = j('<div/>', { class: this.options.selector.result })),
            ...
            h = this.options.multiselect.limitTemplate
              ? 'function' == typeof this.options.multiselect.limitTemplate
                ...
                : this.options.multiselect.limitTemplate.replace(
                    /\{\{query}}/gi,
                    j('<div>').text(this.helper.cleanStringFromScript(this.query)).html()
                  )
        ...
        this.groupTemplate
              ...
              t.replace(/<([^>]+)>\{\{(.+?)}}<\/[^>]+>/g, function (t, e, i, s, o) {
                ...
                if (!c.result.length)
                  return !0 === p
                    ? ''
                    : ((p = !0),
                      '<' + e + ' class="' + c.options.selector.empty + '">' + h + '</' + e + '>')
          ...
          : ((t = j(t)),
            this.result.length ||
              t.append(
                h instanceof j ? h : '<li class="' + c.options.selector.empty + '">' + h + '</li>'
              )),
          t.addClass(
            this.options.selector.list + (this.helper.isEmpty(this.result) ? ' empty' : '')
          )
        for (
          var e,
            i,
          ...
          (e = (n = this.result[b]).group),
            (s =
              (!this.options.multiselect && this.options.source[n.group].href) ||
              this.options.href),
            (u = []),
            ...
            (r = j('<li/>', {
              ...
              html: j('<a/>', {
                href:
                  s && !n.disabled
                    ? ((g = s), (y = n), (y.href = c.generateHref.call(c, g, y)))
                    : 'javascript:;',
                html: function () {
                        ...
                        return (
                          ...
                          ~i.indexOf('raw') ||
                            (!0 === c.options.highlight &&
                              o &&
                              ~d.indexOf(e) &&
                              (s = c.helper.highlight.call(c, s, o.split(' '), c.options.accent))),
                          s
                        )
                      }))
                  else {
                  ...
                  ;((!0 === c.options.highlight && o && !a) || 'any' === c.options.highlight) &&
                    (l = c.helper.highlight.call(c, l, o.split(' '), c.options.accent)),
                    j(this).append(l)
                }
              })
            })),
              ...
              e.on('click', function (t, e) {
                  ...
                  : (e && 'object' == typeof e && (t.originalEvent = e),
                    c.options.mustSelectItem && c.helper.isEmpty(i)
                      ...
                      : (c.options.multiselect || (c.item = i),
                        !1 !==
                          c.helper.executeCallback.call(c, c.options.callback.onClickBefore, [
                            c.node,
                            j(this),
                            i,
                            t
                          ...
                          ((t.originalEvent && t.originalEvent.defaultPrevented) ||
                            ...
                            (c.options.multiselect
                              ...
                              : ((c.focusOnly = !0),
                                (c.query = c.rawQuery = c.getTemplateValue.call(c, i)),
                                c.isContentEditable &&
                                  (c.node.text(c.query), c.helper.setCaretAtEnd(c.node[0]))),
                            c.hideLayout(),
                            c.node.val(c.query).focus(),
                            c.options.cancelButton && c.toggleCancelButtonVisibility(),
                            c.helper.executeCallback.call(c, c.options.callback.onClickAfter, [
                              c.node,
                              j(this),
                              i,
                              t
                ...
                e.on('mouseenter', function (t) {
                  i.disabled || (c.clearActiveItem(), c.addActiveItem(j(this))),
                    c.helper.executeCallback.call(c, c.options.callback.onEnter, [
                      c.node,
                      j(this),
                      i,
                      t
                ...
                e.on('mouseleave', function (t) {
                  i.disabled || c.clearActiveItem(),
                    c.helper.executeCallback.call(c, c.options.callback.onLeave, [
                      c.node,
                      j(this),
                      i,
                      t
    ...
    buildBackdropLayout: function () {
      this.options.backdrop &&
        ...
        this.container
          .addClass('backdrop')
          .css({ 'z-index': this.backdrop.css['z-index'] + 1, position: 'relative' }))
    },
            ...
            if (
              ...
              for (var o, n, r, a = 0, l = t.length; a < l; a++)
                if (!t[a].disabled) {
                  ...
                  for (
                    var h = 0,
                      c = (o = this.options.source[n].display || this.options.display).length;
                    h < c;
                    h++
                  )
                    if (
                      ((r = String(t[a][o[h]]).toLowerCase()),
                      this.options.accent && (r = this.helper.removeAccent.call(this, r)),
                      0 === r.indexOf(s))
                    ) {
                  ...
                  j('html').off(e),
                    i.container.hasClass('filter') &&
                      j('html').on('click' + e + ' touchend' + e, function (t) {
                        ;(j(t.target).closest('.' + i.options.selector.filter)[0] &&
    ...
    buildDropdownItemLayout: function (t) {
      if (this.options.dropdownFilter) {
        var e,
          ...
          o = this,
          n =
            ('string' == typeof this.options.dropdownFilter && this.options.dropdownFilter) ||
            'All',
        ...
        for (var s = 0, a = this.dropdownFilter[t].length; s < a; s++) {
          ...
          for (var l = 0, h = i.value.length; l <= h; l++)
            (l === h && s !== a - 1) ||
              ...
              i.value[l]
                ? (e = i.template
                    ? i.template.replace(new RegExp('{{' + i.key + '}}', 'gi'), i.value[l])
                    : i.value[l])
                : this.container.find('.' + o.options.selector.filterButton).html(e),
              (function (e, i, s) {
                r.append(
                  j('<li/>', {
                    class:
                    ...
                    html: j('<a/>', {
                      ...
                      click: function (t) {
                        t.preventDefault(),
                          c.call(o, { key: i.key, value: i.value[e] || '*', template: s })
                      }
                    })
                  })
                )
        ...
        this.dropdownFilter[t].length &&
          this.container.find('.' + o.options.selector.filterButton).removeAttr('style')
      }
      function c(t) {
    ...
    dynamicFilter: {
      ...
      init: function () {
        this.options.dynamicFilter &&
          (this.dynamicFilter.bind.call(this), (this.dynamicFilter.isEnabled = !0))
      },
      validate: function (t) {
        var e,
          i,
      ...
      getValue: function (t) {
        ...
        return (
          'SELECT' === t.tagName
            ...
            : 'INPUT' === t.tagName &&
              ('checkbox' === t.type
                ? (e = (t.checked && t.getAttribute('value')) || t.checked || null)
            ...
            html: j('<' + o + '/>', {
              ...
              click: function (t) {
                ...
                s.options.multiselect.callback &&
                  s.helper.executeCallback.call(s, s.options.multiselect.callback.onClick, [
                    s.node,
                    s.items[i],
                    t
                  ])
    ...
    cancelMultiselectItem: function (t, e, i) {
      ...
      ;(e = e || this.label.container.find('.' + this.options.selector.label).eq(t)).remove(),
        ...
        this.options.multiselect.callback &&
          this.helper.executeCallback.call(this, this.options.multiselect.callback.onCancel, [
            this.node,
            s,
            i
          ]),
    ...
    adjustInputSize: function () {
      ...
      this.label.container.find('.' + this.options.selector.label).filter(function (t, e) {
        0 === t &&
          (a = j(e)[0].getBoundingClientRect().height + parseFloat(j(e).css('margin-bottom') || 0)),
    ...
    showLayout: function () {
      !this.container.hasClass('result') &&
        ...
        this.container.addClass(
          [
            this.result.length || (this.searchGroups.length && this.displayEmptyTemplate)
              ? 'result '
              : '',
        ...
        this.helper.executeCallback.call(this, this.options.callback.onShowLayout, [
          this.node,
          this.query
        ]))
    },
    hideLayout: function () {
      ;(this.container.hasClass('result') || this.container.hasClass('backdrop')) &&
        (this.container.removeClass(
          'result hint filter' +
            (this.options.backdropOnFocus && j(this.node).is(':focus') ? '' : ' backdrop')
        ),
        (this.options.backdropOnFocus && this.container.hasClass('backdrop')) ||
          (j('html').off(this.namespace),
          this.helper.executeCallback.call(this, this.options.callback.onHideLayout, [
            this.node,
            this.query
          ])))
    },
    resetLayout: function () {
      ;(this.result = []),
        ...
        this.options.hint &&
          this.hint.container &&
          (this.hint.container.val(''), this.isContentEditable && this.hint.container.text(''))
    },
    resetInput: function () {
      this.node.val(''),
    ...
    helper: {
      ...
      executeCallback: function (t, e) {
        if (t) {
          ...
          if ('function' == typeof t) i = t
            ...
            ('string' == typeof t && (t = [t, []]),
            'function' != typeof (i = this.helper.namespace.call(this, t[0], window)))
          )
            return
      ...
      namespace: function (t, e, i, s) {
        ...
        for (
          var n = t.split('.'), r = e || window, a = ((i = i || 'get'), ''), l = 0, h = n.length;
          l < h;
          l++
        ) {
          if (void 0 === r[(a = n[l])]) {
    ...
    typeahead: function (t, e) {
      if (e && e.source && 'object' == typeof e.source) {
        ...
        if ((void 0 === t[0].value && (t[0].value = t.text()), t.length)) {
          if (1 === t.length)
            return (
              (t[0].selector = t.selector || e.input || t[0].nodeName.toLowerCase()),
