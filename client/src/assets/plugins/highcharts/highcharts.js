...
;(function (S, K) {
  ...
  ;(function (a) {
    ...
    a.Fx.prototype = {
      ...
      initPath: function (n, f, e) {
        ...
        f.length &&
          a.isNumber(w) &&
          ((k = e.length + w * v * p), J ? (x(f, e), t(e, f)) : (x(e, f), t(f, e)))
        return [f, e]
      },
      fillSetter: function () {
    ...
    a.attr = function (n, f, e) {
      ...
      a.isString(f)
        ? a.defined(e)
          ...
          : n &&
            n.getAttribute &&
            ((u = n.getAttribute(f)) || 'class' !== f || (u = n.getAttribute(f + 'Name')))
        : a.defined(f) &&
          a.isObject(f) &&
    ...
    a.formatSingle = function (n, f, e) {
      ...
      ;/f$/.test(n)
        ? ((e = (e = n.match(u)) ? e[1] : -1),
          null !== f &&
            (f = a.numberFormat(f, e, x.decimalPoint, -1 < n.indexOf(',') ? x.thousandsSep : '')))
    ...
    a.normalizeTickInterval = function (n, f, e, u, x) {
      ...
      t = n / e
      f ||
        ((f = x ? [1, 1.2, 1.5, 2, 2.5, 3, 4, 5, 6, 8, 10] : [1, 2, 2.5, 5, 10]),
        !1 === u &&
          (1 === e
      ...
      for (
        u = 0;
        u < f.length &&
        !((w = f[u]), (x && w * e >= n) || (!x && t <= (f[u] + (f[u + 1] || f[u])) / 2));
        u++
      );
      return (w = a.correctFloat(w * e, -Math.round(Math.log(0.001) / Math.LN10)))
    }
      ...
      a.each(['protoEvents', 'hcEvents'], function (y) {
        ...
        c &&
          (f
            ? ((t = c[f] || []),
              e
                ? ((w = a.inArray(e, t)), -1 < w && (t.splice(w, 1), (c[f] = t)), u(f, e))
                : (x(c), (c[f] = [])))
            : (x(c), (n[y] = {})))
      })
    }
    ...
    a.animate = function (n, f, e) {
      ...
      a.objectEach(f, function (c, h) {
        ...
        t = null
        'd' === h
          ? ((w.paths = w.initPath(n, n.d, f.d)), (w.toD = f.d), (u = 0), (t = 1))
          : n.attr
          ? (u = n.attr(h))
          : ((u = parseFloat(a.getStyle(n, h)) || 0), 'opacity' !== h && (x = 'px'))
        t || (t = c)
    ...
    I.jQuery &&
      (I.jQuery.fn.highcharts = function () {
        ...
        if (this[0])
          return n[0]
            ? (new a[a.isString(n[0]) ? n.shift() : 'Chart'](this[0], n[0], n[1]), this)
    ...
    k(C.prototype, {
      ...
      complexColor: function (z, g, r) {
        ...
        a.fireEvent(this.renderer, 'complexColor', { args: arguments }, function () {
          ...
          m &&
            ...
            J(d) &&
              (z[m] = d =
                { x1: d[0], y1: d[1], x2: d[2], y2: d[3], gradientUnits: 'userSpaceOnUse' }),
            'radialGradient' === m &&
              P &&
              !w(d.gradientUnits) &&
              ((H = d), (d = G(d, b.getRadialAttr(P, H), { gradientUnits: 'userSpaceOnUse' }))),
            N(d, function (a, z) {
              'id' !== z && O.push(z, a)
            }),
            N(q, function (a) {
            ...
            c[O]
              ...
              : ((d.id = l = a.uniqueKey()),
                ...
                p(q, function (z) {
                  0 === z[1].indexOf('rgba')
                    ? ((k = a.color(z[1])), (A = k.get('rgb')), (v = k.get('a')))
                    : ((A = z[1]), (v = 1))
                  z = b
                    .createElement('stop')
                    .attr({ offset: z[0], 'stop-color': A, 'stop-opacity': v })
                    .add(h)
                  h.stops.push(z)
                })),
            (M = 'url(' + b.url + '#' + l + ')'),
      ...
      updateShadows: function (a, g, r) {
        for (var z = this.shadows, d = z.length; d--; )
          r.call(
            z[d],
            'height' === a ? Math.max(g - (z[d].cutHeight || 0), 0) : 'd' === a ? this.d : g,
            a,
            z[d]
          )
      },
      addClass: function (a, g) {
        ...
        ;-1 === z.indexOf(a) &&
          (g || (a = (z + (z ? ' ' : '') + a).replace('  ', ' ')), this.attr('class', a))
        return this
      },
      hasClass: function (a) {
      ...
      align: function (a, g, r) {
        ...
        var c, H
        if (a) {
          if (((this.alignOptions = a), (this.alignByTranslate = g), !r || D(r)))
            (this.alignTo = z = r || 'renderer'), q(b, this), b.push(this), (r = null)
      ...
      getBBox: function (a, g) {
        ...
        if (!z) {
          ...
          r.isSVG &&
            ...
            v &&
              (z.height = r =
                { '11px,17': 14, '13px,20': 16 }[m && m.fontSize + ',' + Math.round(r)] || r),
            g &&
              ((z.width = Math.abs(r * Math.sin(d)) + Math.abs(a * Math.cos(d))),
        ...
        if (!a) this.destroyShadows()
          ...
          for (d = 1; d <= c; d++)
            (b = m.cloneNode(0)),
              ...
              r && (f(b, 'height', Math.max(f(b, 'height') - k, 0)), (b.cutHeight = k)),
      ...
      zIndexSetter: function (a, r) {
        ...
        var h
        w(a)
          ? (k.setAttribute('data-z-index', a), (a = +a), this[r] === a && (m = !1))
    ...
    k(F.prototype, {
      ...
      init: function (a, g, r, d, b, k) {
        ...
        this.createElement('desc')
          .add()
          .element.appendChild(h.createTextNode('Created with Highcharts 6.2.0'))
      ...
      buildText: function (a) {
        var r = a.element,
          ...
          u = function (a, g) {
            ...
            r = a.indexOf(g + '\x3d')
            if (-1 !== r && ((r = r + g.length + 1), (g = a.charAt(r)), '"' === g || "'" === g))
              ...
              p(c, function (g, d) {
                ...
                p(c, function (g) {
                  if ('' !== g || 1 === c.length) {
                    ...
                    if ((p = u(g, 'style')))
                      (p = p.replace(/(;| |^)color([ :])/, '$1fill$2')), f(l, 'style', p)
                    ;(M = u(g, 'href')) &&
                      !m &&
      ...
      button: function (a, g, r, d, b, c, m, H, h) {
        ...
        z.setState = function (a) {
          1 !== a && (z.state = q = a)
          z.removeClass(/highcharts-button-(normal|hover|pressed|disabled)/).addClass(
            ...
            p(['width', 'height'], function (a) {
              H[a + 'Setter'] = function (a, g) {
                ...
                w(d) &&
                  ...
                  this.alignByTranslate || ((r[b] = ((this[g] || 0) - d) / 2), this.attr(r)))
              }
            }),
            w(g) && H.attr({ x: g, y: r }),
            (H.isImg = !0),
              ...
              : (H.attr({ width: 0, height: 0 }),
                t('img', {
                  onload: function () {
                    ...
                    0 === this.width &&
                      (x(this, { position: 'absolute', top: '-999em' }), h.body.appendChild(this))
      ...
      symbols: {
        ...
        arc: function (a, g, r, d, b) {
          ...
          w(r) &&
            m.push(d ? 'M' : 'L', a + r * A, g + r * k, 'A', r, r, 0, b, 0, a + r * h, g + r * q)
          m.push(d ? '' : 'Z')
          return m
        },
        callout: function (a, g, r, d, b) {
          ...
          H && H > r
            ? b > g + m && b < g + d - m
              ? k.splice(13, 3, 'L', a + r, b - 6, a + r + 6, b, a + r, b + 6, a + r, g + d - c)
              : k.splice(13, 3, 'L', a + r, d / 2, H, b, a + r, d / 2, a + r, g + d - c)
            : H && 0 > H
            ? b > g + m && b < g + d - m
              ? k.splice(33, 3, 'L', a, b + 6, a - 6, b, a, b - 6, a, g + c)
              : k.splice(33, 3, 'L', a, d / 2, H, b, a, d / 2, a, g + c)
            : b && b > d && H > a + m && H < a + r - m
            ? k.splice(23, 3, 'L', H + 6, g + d, H, g + d + 6, H - 6, g + d, a + c, g + d)
            : b &&
              0 > b &&
              H > a + m &&
              H < a + r - m &&
        ...
        if (this.added) {
          ...
          if ('SPAN' === c.tagName) {
            ...
            ;(A = m !== this.oldTextWidth) &&
              !(A = m > this.oldTextWidth) &&
              ((A = this.textPxLength) ||
                (I(c, { width: '', whiteSpace: t || 'nowrap' }), (A = c.offsetWidth)),
              (A = A > m))
            A && /[ \-]/.test(c.textContent || c.innerText)
              ? (I(c, { width: m + 'px', display: 'block', whiteSpace: t || 'normal' }),
                (this.oldTextWidth = m),
    ...
    a.Time.prototype = {
      ...
      makeTime: function (e, t, w, y, c, h) {
        ...
        this.useUTC
          ? ((p = this.Date.UTC.apply(0, arguments)),
            ...
            k !== q
              ? (p += q - k)
              : k - 36e5 !== this.getTimezoneOffset(p - 36e5) || a.isSafari || (p -= 36e5))
          : (p = new this.Date(e, t, f(w, 1), f(y, 0), f(c, 0), f(h, 0)).getTime())
        return p
      },
      ...
      getTimeTicks: function (a, t, w, y) {
        ...
        if (C(t)) {
          ...
          d >= e.second &&
            c.set('Seconds', p, d >= e.minute ? 0 : b * Math.floor(c.get('Seconds', p) / b))
          d >= e.minute &&
            c.set('Minutes', p, d >= e.hour ? 0 : b * Math.floor(c.get('Minutes', p) / b))
          ...
          d >= e.month &&
            (c.set('Month', p, d >= e.year ? 0 : b * Math.floor(c.get('Month', p) / b)),
            (q = c.get('FullYear', p)))
          d >= e.year && c.set('FullYear', p, q - (q % b))
          d === e.week &&
            ((q = c.get('Day', p)), c.set('Date', p, c.get('Date', p) - q + y + (q < y ? -7 : 0)))
          q = c.get('FullYear', p)
          y = c.get('Month', p)
          var J = c.get('Date', p),
            l = c.get('Hours', p)
          t = p.getTime()
          c.variableTimezone &&
            (v = w - t > 4 * e.month || c.getTimezoneOffset(t) !== c.getTimezoneOffset(w))
          t = p.getTime()
          for (p = 1; t < w; )
            h.push(t),
              (t =
    ...
    a.Tick.prototype = {
      addLabel: function () {
        ...
        if ((D = n && n.list))
          f.shortenLabel = function () {
            for (B = 0; B < D.length; B++)
              if (
                (J.attr({
                  text: w.labelFormatter.call(a.extend(f.formatCtx, { dateTimeLabelFormat: D[B] }))
                }),
        ...
        if (F(J))
          J &&
            J.textStr !== y &&
            (!J.textWidth || (q.style && q.style.width) || J.styles.width || J.css({ width: null }),
            J.attr({ text: y }))
        else {
          if (
            (f.label = J =
              F(y) && q.enabled
                ? c.renderer.text(y, 0, 0, q.useHTML).css(e(q.style)).add(w.labelGroup)
                : null)
          )
      ...
      handleOverflow: function (a) {
        var e = this.axis,
          ...
          q = this.label,
          d = this.rotation,
          b = { left: 0, center: 0.5, right: 1 }[e.labelAlign || q.attr('align')],
          v = q.getBBox().width,
        ...
        if (d || 'justify' !== u(f.overflow, 'justify'))
          0 > d && c - b * v < k
            ...
            : 0 < d && c + b * v > p && (B = Math.round((h - c) / Math.cos(d * x)))
        else if (
          ((h = c + (1 - b) * v),
          c - b * v < k ? (l = a.x + l * (1 - b) - k) : h > p && ((l = p - a.x + l * b), (t = -1)),
          (l = Math.min(J, l)),
      ...
      getPosition: function (e, f, y, c) {
        ...
        e = {
          x: e
            ...
            : h.left +
              h.offset +
              (h.opposite ? ((c && p.oldChartWidth) || p.chartWidth) - h.right - h.left : 0),
          y: e
      ...
      getLabelPosition: function (a, e, f, c, h, p, k, q) {
        var d = this.axis,
          ...
          t = h.y,
          B =
            c || d.reserveSpaceDefault ? 0 : -d.labelOffset * ('center' === d.labelAlign ? 0.5 : 1),
          D = {}
        F(t) ||
          (t =
            0 === d.side
        ...
        J &&
          ((f = (k / (q || 1)) % J), d.opposite && (f = J - f - 1), (e += (d.labelOffset / J) * f))
        D.x = a
        D.y = Math.round(e)
      ...
      renderLabel: function (a, e, y, c) {
        ...
        q &&
          ...
          (this.isLast && !this.isFirst && !u(k.showLastLabel, 1))
            ? (v = !1)
            : !p || d.step || d.rotation || e || 0 === y || this.handleOverflow(a),
          b && c % b && (v = !1),
          v && f(a.y)
            ? ((a.opacity = y), q[this.isNewLabel ? 'attr' : 'animate'](a), (this.isNewLabel = !1))
  ...
  var W = (function (a) {
    ...
    a.extend(E.prototype, {
      ...
      defaultLabelFormatter: function () {
        ...
        void 0 === l &&
          (l = 1e4 <= Math.abs(r) ? a.numberFormat(r, -1) : a.numberFormat(r, -1, void 0, ''))
        return l
      },
              ...
              if (a.isXAxis)
                (b = g.xData),
                  b.length &&
                    ((g = n(b)),
                    (c = I(b)),
                    v(g) || g instanceof Date || ((b = q(b, v)), (g = n(b)), (c = I(b))),
                    b.length &&
      ...
      getPlotLinePath: function (a, r, b, d, c) {
        ...
        v(c)
          ? this.horiz
            ? ((H = k), (l = h - this.bottom), (a = b = e(a, m, m + this.width)))
            : ((a = m), (b = q - this.right), (H = l = e(H, k, k + this.height)))
          : ((A = !0), (d = !1))
          ...
          (c = g.getClosest()),
            l
              ...
              : y(g.series, function (a) {
                  ...
                  d = Math.max(d, b)
                  g.single ||
                    ((m = Math.max(m, J(a) ? 0 : b / 2)), (k = Math.max(k, 'on' === a ? 0 : b)))
                }),
      ...
      setTickInterval: function (g) {
        ...
        A
          ...
          : (!N &&
              x(E) &&
              (b.dataMin >= E ? ((w = E), (f = 0)) : b.dataMax <= E && ((t = E), (p = 0))),
      ...
      setTickPositions: function () {
        ...
        var c = g.tickPositioner,
          ...
          k = g.endOnTick
        this.tickmarkOffset =
          this.categories && 'between' === g.tickmarkPlacement && 1 === this.tickInterval ? 0.5 : 0
      ...
      setAxisSize: function () {
        var b = this.chart,
          ...
          l = (this.height = Math.round(
            a.relativeLength(D(d.height, b.plotHeight - c[0] + c[2]), b.plotHeight)
          )),
          h = (this.top = Math.round(
            a.relativeLength(D(d.top, b.plotTop + c[0]), b.plotHeight, b.plotTop)
          )),
          d = (this.left = Math.round(
            a.relativeLength(D(d.left, b.plotLeft + c[3]), b.plotWidth, b.plotLeft)
          ))
      ...
      unsquish: function () {
        ...
        b
          ? (A =
              !a.staggerLines &&
              !a.step &&
              (x(l) ? [l] : m < D(a.autoRotationLimit, 80) && a.autoRotation)) &&
            y(A, function (a) {
              var b
              if (a === l || (a && -90 <= a && 90 >= a))
      ...
      getSlotWidth: function (a) {
        ...
        return (
          (a && a.slotWidth) ||
          (g && 2 > (d.step || 0) && !d.rotation && ((this.staggerLines || 1) * this.len) / c) ||
          (!g &&
      ...
      renderUnsquish: function () {
        ...
        v.rotation &&
          ((p = G > 0.5 * a.chartHeight ? 0.33 * a.chartHeight : G), e || (f = 'ellipsis'))
          ...
          function (a) {
            ...
            b &&
              ...
              a.shortenLabel
                ...
                ? ((d.width = p), e || (d.textOverflow = b.specificTextOverflow || f), b.css(d))
      ...
      hasData: function () {
        return (
          ...
          (x(this.min) && x(this.max) && this.tickPositions && 0 < this.tickPositions.length)
        )
      },
      addTitle: function (a) {
        ...
        A || a.isLinked
          ? (y(m, function (b, g) {
            ...
            (a.reserveSpaceDefault =
              0 === q || 2 === q || { 1: 'left', 3: 'right' }[q] === a.labelAlign),
            D(E.reserveSpace, 'center' === a.labelAlign ? !0 : null, a.reserveSpaceDefault) &&
              y(m, function (a) {
      ...
      renderTick: function (a, b) {
        ...
        if (!d || (a >= this.min && a <= this.max))
          g[a] || (g[a] = new N(this, a)), c && g[a].isNew && g[a].render(b, !0, -1), g[a].render(b)
      },
      render: function () {
        var b = this,
          d = b.chart,
        ...
        D &&
          (D[D.isPlaced ? 'animate' : 'attr']({ d: this.getLinePath(D.strokeWidth()) }),
          (D.isPlaced = !0),
          D[t ? 'show' : 'hide'](!0))
        q &&
          t &&
      ...
      drawCrosshair: function (a, b) {
        ...
        if (this.crosshair && !1 !== (x(b) || !g)) {
          g
            ? x(b) && (m = D(b.crosshairPos, this.isXAxis ? b.plotX : this.len - b.plotY))
          ...
          k ||
            ...
            k
              .attr({
                stroke: c.color || (g ? f('#ccd6eb').setOpacity(0.25).get() : '#cccccc'),
  ...
  ;(function (a) {
    ...
    C.prototype.getLogTickPositions = function (a, u, x, t) {
      ...
      if (0.5 <= a) (a = Math.round(a)), (c = this.getLinearTickPositions(a, u, x))
      else if (0.08 <= a)
        for (
          var y = Math.floor(u),
            h,
  ...
  ;(function (a, C) {
    ...
    a.PlotLineOrBand.prototype = {
      render: function () {
        ...
        J
          ...
          : v &&
            (D && (B.fill = D),
            h.borderWidth && ((B.stroke = h.borderColor), (B['stroke-width'] = h.borderWidth)))
        A.zIndex = m
        E += '-' + m
        ...
        u && B && B.length
          ...
          : l &&
            (B ? (l.show(), l.animate({ d: B })) : (l.hide(), k && (e.label = k = k.destroy())))
        p && n(p.text) && B && B.length && 0 < f.width && 0 < f.height && !B.isFlat
          ? ((p = x(
              {
                align: c && v && 'center',
                x: c ? !v && 4 : 10,
    ...
    a.extend(C.prototype, {
      getPlotBandPath: function (a, e) {
        ...
        if (h && c)
          for (a && ((d = h.toString() === c.toString()), (q = 0)), a = 0; a < h.length; a += 6)
            k && c[a + 1] === h[a + 1]
              ? ((c[a + 1] += q), (c[a + 4] += q))
              : k || c[a + 2] !== h[a + 2] || ((c[a + 2] += q), (c[a + 5] += q)),
              p.push(
                'M',
                h[a + 1],
                h[a + 2],
      ...
      removePlotBandOrLine: function (a) {
        for (
          var f = this.plotLinesAndBands, c = this.options, h = this.userOptions, p = f.length;
          p--;

        )
          f[p].id === a && f[p].destroy()
        e(
          [c.plotLines || [], h.plotLines || [], c.plotBands || [], h.plotBands || []],
          function (c) {
    ...
    a.Tooltip.prototype = {
      ...
      getLabel: function () {
        ...
        this.label ||
          ...
          this.split
            ...
            : ((this.label = c
                .label('', 0, 0, h.shape || 'callout', null, null, h.useHTML, null, 'tooltip')
      ...
      getAnchor: function (a, h) {
        ...
        this.followPointer && h
          ...
          : (F(a, function (a) {
            ...
            (a = [
              q ? c.plotWidth - f : v,
              this.shared && !q && 1 < a.length && h ? h.chartY - d : q ? c.plotHeight - v : f
            ]))
          ...
          !1 === v
            ...
            : ((e = this.getLabel()),
              ...
              this.split
                ...
                : (k.style.width || e.css({ width: this.chart.spacingBox.width }),
                  e.attr({ text: v && v.join ? v.join('') : v }),
                  e
                    .removeClass(/highcharts-color-[\d]+/g)
                    .addClass('highcharts-color-' + x(d.colorIndex, l.colorIndex)),
                  e.attr({ stroke: k.borderColor || d.color || l.color || '#666666' }),
                  this.updatePosition({
                    plotX: h,
                    plotY: q,
                    negative: d.negative,
            ...
            A ||
              (m.tt = A =
                d
                  ...
                  .addClass(
                    'highcharts-tooltip-box ' + E + (c.isHeader ? ' highcharts-tooltip-header' : '')
                  )
                  .attr({
                    padding: v.padding,
                    r: v.borderRadius,
              ...
              ? ((f = a.height),
                ...
                (p = Math.max(
                  ...
                  Math.min(
                    ...
                    q.chartWidth + (q.scrollablePixels ? q.scrollablePixels - q.marginRight : 0) - p
                  )
                )))
      ...
      bodyFormatter: function (a) {
        return e(a, function (a) {
          ...
          return (
            c[(a.point.formatPrefix || 'point') + 'Formatter'] || a.point.tooltipFormatter
  ...
  ;(function (a) {
    ...
    a.Pointer.prototype = {
      ...
      runPointActions: function (c, b) {
        var d = this.chart,
          ...
          h = this.getHoverData(
            ...
            h,
            d.series,
            'touchmove' !== c.type && (!!b || (h && h.directTouch && this.isDirectTouch)),
            l,
            c,
        ...
        if (e && (e !== d.hoverPoint || (k && k.isHidden))) {
          ...
          b &&
            k &&
            !k.isHidden &&
            ((e = k.getAnchor([{}], c)), k.updatePosition({ plotX: e[0], plotY: e[1] }))
        this.unDocMouseMove ||
      ...
      scaleGroups: function (a, b) {
        ...
        u(c.series, function (k) {
          ...
          k.xAxis &&
            ...
            k.group &&
            (k.group.attr(d),
            k.markerGroup && (k.markerGroup.attr(d), k.markerGroup.clip(b ? c.clipRect : null)),
            ...
            b.hasCartesianSeries &&
              ...
              (this.selectionMarker = E =
                b.renderer
                  ...
                  .attr({
                    fill: c.selectionMarkerFill || n('#335cad').setOpacity(0.25).get(),
                    class: 'highcharts-selection-marker',
                    zIndex: 7
                  })
                  .add()),
            E && e && ((d -= g), E.attr({ width: Math.abs(d), x: (0 < d ? 0 : d) + g })),
            E && h && ((d = k - r), E.attr({ height: Math.abs(d), y: (0 < d ? 0 : d) + r })),
      ...
      onContainerMouseMove: function (c) {
        var b = this.chart
        ;(e(a.hoverChartIndex) && I[a.hoverChartIndex] && I[a.hoverChartIndex].mouseIsDown) ||
      ...
      setDOMEvents: function () {
        ...
        a.hasTouch &&
          ...
          a.unbindDocumentTouchEnd ||
            (a.unbindDocumentTouchEnd = C(k, 'touchend', c.onDocumentTouchEnd)))
      },
      destroy: function () {
        var c = this
  ...
  ;(function (a) {
    ...
    I(a.Pointer.prototype, {
      ...
      pinchTranslateDirection: function (a, e, f, n, y, c, h, p) {
        ...
        r ? ((N -= 0.8 * (N - h[q][0])), G || (g -= 0.8 * (g - h[q][1])), f()) : (h[q] = [N, g])
        D || ((c[q] = u - t), (c[v] = l))
        c = D ? 1 / B : B
        y[v] = l
        y[q] = e
      ...
      pinch: function (a) {
        var u = this,
          ...
          d =
            1 === c &&
            ((u.inClass(a.target, 'highcharts-tracker') && t.runTrackerClick) || u.runChartClick),
          b = {}
        1 < c && (u.initiated = !0)
        ...
        'touchstart' === a.type
          ...
          : w.length &&
            (k || (u.selectionMarker = k = I({ destroy: f, touch: !0 }, t.plotBox)),
      ...
      touch: function (f, n) {
        ...
        1 === f.touches.length
          ? ((f = this.normalize(f)),
            (y = t.isInsidePlot(f.chartX - t.plotLeft, f.chartY - t.plotTop)) && !t.openMenu
              ? (n && this.runPointActions(f),
                'touchmove' === f.type &&
                  ...
                  (u = n[0]
                    ? 4 <=
                      Math.sqrt(
                        Math.pow(n[0].chartX - f.chartX, 2) + Math.pow(n[0].chartY - f.chartY, 2)
                      )
                    : !1)),
                e(u, !0) && this.pinch(f))
              : n && this.reset())
      ...
      var y = {},
        ...
        p = function (c, q, d, b) {
          ;('touch' !== c.pointerType && c.pointerType !== c.MSPOINTER_TYPE_TOUCH) ||
            ...
            b[q]({ type: d, target: c.currentTarget, preventDefault: e, touches: h() }))
        }
      f(u.prototype, {
  ...
  ;(function (a) {
    ...
    a.Legend.prototype = {
      ...
      renderItem: function (a) {
        ...
        l.width || m.css({ width: (b.itemWidth || b.width || c.spacingBox.width) - f })
        this.setText(a)
        c = m.getBBox()
      ...
      layoutItem: function (a) {
        ...
        b &&
          this.itemX - d + c > p &&
          ((this.itemX = d), (this.itemY += l + this.lastLineHeight + e), (this.lastLineHeight = 0))
        ...
        this.offsetWidth =
          f || Math.max((b ? this.itemX - d - (a.checkbox ? 0 : k) : c) + d, this.offsetWidth)
      },
      ...
      adjustMargins: function (a, c) {
        var d = this.chart,
          ...
          h = this.getAlignment()
        h &&
          f([/(lth|ct|rth)/, /(rtv|rm|rbv)/, /(rbh|cb|lbh)/, /(lbv|lm|ltv)/], function (e, l) {
            e.test(h) &&
              !n(a[l]) &&
              (d[x[l]] = Math.max(
                d[x[l]],
        ...
        f(
          ...
          function (b) {
            ...
            b.xAxis &&
              ...
              h.push({
                target: b.visible ? (e ? e.plotY : b.xAxis.height) - 0.3 * k : c.plotHeight,
                size: k,
                item: b
              }))
          },
      ...
      render: function () {
        ...
        l ||
          ((this.box = l =
            h.rect().addClass('highcharts-legend-box').attr({ r: n.borderRadius }).add(d)),
          (l.isNew = !0))
        l.attr({
        ...
        0 < b &&
          ...
          (l[l.isNew ? 'attr' : 'animate'](
            l.crisp.call({}, { x: 0, y: 0, width: b, height: p }, l.strokeWidth())
          ),
          (l.isNew = !1))
        l[e ? 'show' : 'hide']()
        this.legendWidth = b
        ...
        e &&
          ...
          d.align(
            t(n, { width: b, height: p, verticalAlign: this.proximate ? 'top' : n.verticalAlign }),
            !0,
            h
          ))
      ...
      handleOverflow: function (a) {
        ...
        a > d && !1 !== n.enabled
          ? ((this.clipHeight = k = Math.max(d - 20 - this.titleHeight - l, 0)),
            ...
            p || ((p = c.clipRect = b.clipRect(0, l, 9999, 0)), c.contentGroup.clip(p)),
            r(k),
            A ||
    ...
    a.LegendSymbolMixin = {
      ...
      drawLineMarker: function (a) {
        ...
        d &&
          ...
          0 === this.symbol.indexOf('url') && ((d = t(d, { width: h, height: h })), (c = 0)),
          (this.legendSymbol = d =
            l
  ...
  ;(function (a) {
    ...
    p(O.prototype, {
      ...
      getMargins: function (a) {
        ...
        g &&
          !c(d[0]) &&
          (this.plotTop = Math.max(this.plotTop, g + this.options.title.margin + b[0]))
      ...
      setSize: function (b, c, d) {
        ...
        g.getChartSize()
        b = m.globalAnimation
        ;(b ? F : y)(g.container, { width: g.chartWidth + 'px', height: g.chartHeight + 'px' }, b)
        g.setChartSize(!0)
  ...
  ;(function (a) {
    ...
    a.Point.prototype = {
      ...
      destroyElements: function () {
        for (
          var a = ['graphic', 'dataLabel', 'dataLabelUpper', 'connector', 'shadowGroup'], c, e = 6;
          e--;
      ...
      firePointEvent: function (a, c, e) {
        ...
        ;(d.point.events[a] || (h.options && h.options.events && h.options.events[a])) &&
          this.importEvents()
        'click' === a &&
          d.allowPointSelect &&
          (e = function (a) {
    ...
    a.Series = a.seriesType(
      ...
      },
      {
        ...
        getCyclic: function (a, b, c) {
          ...
          b ||
            ((d = v(g[m], g['_' + m])),
            x(d) || (e.series.length || (e[h] = 0), (g['_' + m] = d = e[h] % f), (e[h] += 1)),
            c && (b = c[d]))
          void 0 !== d && (this[m] = d)
          this[a] = b
        },
            ...
            function (b) {
              ...
              k(g) &&
                ...
                -1 === g || d[g].touched
                  ? e.push(b)
                  : b !== c.data[g]
                  ? (d[g].update(b, !1, null, !1), (d[g].touched = !0), f && (h = g + 1))
                  : d[g] && (d[g].touched = !0),
                (m = !0))
            },
            this
          ...
          if (!N) {
            ...
            if (B && f > B) {
              ...
              if (k(G)) for (d = 0; d < f; d++) (u[d] = this.autoIncrement()), (D[d] = b[d])
                ...
                if (y) for (d = 0; d < f; d++) (G = b[d]), (u[d] = G[0]), (D[d] = G.slice(1, y + 1))
          ...
          for (B = 0; B < f; B++)
            (p = k + B),
              q
                ...
                : (v = c[p]) || void 0 === b[p] || (c[p] = v = new h().init(this, b[p], e[B])),
              v && ((v.index = p), (n[B] = v))
          this.options.keys = a
          if (c && (f !== (d = c.length) || q))
            for (B = 0; B < d; B++)
        ...
        getExtremes: function (a) {
          ...
          for (B = 0; B < d; B++)
            if (
              ...
              if ((f = v.length)) for (; f--; ) 'number' === typeof v[f] && (e[g++] = v[f])
              else e[g++] = v
          this.dataMin = n(e)
          this.dataMax = I(e)
        },
        translate: function () {
          ...
          for (a = 0; a < l; a++) {
            ...
            L.plotX = u = f(
              Math.min(Math.max(-1e5, d.translate(C, 0, 0, 0, 1, q, 'flags' === this.type)), 1e5)
            )
            b &&
              this.visible &&
              !L.isNull &&
        ...
        setClip: function (a) {
          var b = this.chart,
            ...
            h =
              this.sharedClipKey ||
              ['_sharedClip', a && a.duration, a && a.easing, m.height, c.xAxis, c.yAxis].join(),
            f = b[h],
            l = b[h + 'm']
          f ||
            (a &&
          ...
          a ||
            ...
            0 === f.count.length &&
              h &&
              b[h] &&
              (g || (b[h] = b[h].destroy()), b[h + 'm'] && (b[h + 'm'] = b[h + 'm'].destroy())))
        },
        animate: function (a) {
          var b = this.chart,
          ...
          a
            ...
            : ((d = this.sharedClipKey),
              ...
              b[d + 'm'] && b[d + 'm'].animate({ width: b.plotSizeX + 99, x: 0 }, c),
              (this.animate = null))
        },
                  ...
                  ? ((e = v(f.symbol, this.symbol)),
                    ...
                    g
                      ...
                      : k &&
                        ...
                        (d.graphic = g =
                          b.renderer.symbol(e, q.x, q.y, q.width, q.height, l ? f : h).add(p)),
              ...
              : (0 === k || l
                  ...
                  ? ((k =
                      1 === g
                        ? ['L', q.plotX, p]
                        : 2 === g
                        ? ['L', (q.plotX + r) / 2, q.plotY, 'L', (q.plotX + r) / 2, p]
                        : ['L', r, q.plotY]),
                    k.push('L', r, p))
                  : (k = ['L', r, p]),
                f.push(h.x),
        ...
        drawGraph: function () {
          ...
          t(d, function (d, g) {
            var e = d[0],
              h = a[e]
            h
              ? ((h.endX = a.preventGraphAnimation ? null : c.xMap), h.animate({ d: c }))
              : c.length &&
                ((a[e] = a.chart.renderer.path(c).addClass(d[1]).attr({ zIndex: 1 }).add(a.group)),
                (h = {
                  stroke: d[2],
        ...
        plotGroup: function (a, b, c, d, e) {
          ...
          g.addClass(
            'highcharts-' +
              ...
              this.type +
              '-series ' +
              (x(this.colorIndex) ? 'highcharts-color-' + this.colorIndex + ' ' : '') +
          ...
          (g = e[E]),
            ...
            B[A][g] ||
              (D[A] && D[A][g]
                ...
                : (B[A][g] = new a.StackItem(w, w.options.stackLabels, G, g, b))),
            (A = B[A][g]),
            null !== r
            ...
            'percent' === k
              ? ((G = G ? v : u),
                l && B[G] && B[G][g]
                  ? ((G = B[G][g]),
                    (A.total = G.total = Math.max(G.total, A.total) + Math.abs(r) || 0))
                  : (A.total = I(A.total + (Math.abs(r) || 0))))
              : (A.total = I(A.total + (r || 0))),
            (A.cumulative = t(A.cumulative, d) + (r || 0)),
            null !== r && (A.points[x].push(A.cumulative), (h[E] = A.cumulative))
    ...
    t(a.Chart.prototype, {
      ...
      showLoading: function (a) {
        ...
        d ||
          ...
          (b.loadingSpan = n('span', { className: 'highcharts-loading-inner' }, null, d)),
          C(b, 'redraw', h))
        ...
        b.loadingShown ||
          ...
          F(d, { opacity: e.style.opacity || 0.5 }, { duration: e.showDuration || 0 }))
        b.loadingShown = !0
        h()
      },
    ...
    t(I.prototype, {
      update: function (a, b) {
        ...
        c.options[this.coll].indexOf &&
          (c.options[this.coll][c.options[this.coll].indexOf(this.userOptions)] = a)
        ...
        getGraphPath: function (a) {
          ...
          for (c = 0; c < a.length; c++)
            if (
              ...
              t || L(c, c - 1, 'left'),
                (h && !u && t) || (k.push(a[c]), p.push({ x: c, plotX: d, plotY: l })),
                t || L(c, c + 1, 'right')
          c = e.call(this, k, !0, !0)
          p.reversed = !0
          h = e.call(this, p, !0, !0)
        ...
        drawGraph: function () {
          ...
          F(w, function (f) {
            var c = f[0],
              h = a[c]
            h
              ? ((h.endX = a.preventGraphAnimation ? null : e.xMap), h.animate({ d: e }))
              : ((h = a[c] =
                  a.chart.renderer
                    .path(e)
                    .addClass(f[1])
                    .attr({
                      fill: n(f[3], C(f[2]).setOpacity(n(t.fillOpacity, 0.75)).get()),
                      zIndex: 0
                    })
                    .add(a.group)),
                (h.isArea = !0))
      ...
      },
      {
        ...
        getColumnMetrics: function () {
          ...
          !1 === e.grouping
            ...
            : I(a.chart.series, function (c) {
                ...
                c.type !== a.type ||
                  ...
                  k.pos !== f.pos ||
                  (e.stacking
                    ? ((d = c.stackKey), void 0 === b[d] && (b[d] = v++), (h = b[d]))
                    : !1 !== e.grouping && (h = v++),
                  (c.columnIndex = h))
              })
          var n = Math.min(
              Math.abs(f.transA) *
                (f.ordinalSlope || e.pointRange || f.closestPointRange || f.tickInterval || 1),
              f.len
            ),
            l = n * e.groupPadding,
            t = (n - 2 * l) / (v || 1),
          ...
          a.columnMetrics = {
            width: e,
            offset:
              (t - e) / 2 + (l + ((a.columnIndex || 0) + (q ? 1 : 0)) * t - n / 2) * (q ? -1 : 1)
          }
        ...
        translate: function () {
          ...
          I(a.points, function (c) {
            ...
            f(c.options.pointWidth) &&
              ((p = t = Math.ceil(c.options.pointWidth)), (n -= Math.round((p - l) / 2)))
            c.barX = n
            c.pointWidth = p
        ...
        pointAttribs: function (a, e) {
          ...
          a &&
            this.zones.length &&
            ((b = a.getZone()), (b = a.options.color || (b && b.color) || this.color))
          e &&
            ((a = u(c.states[e], (a.options.states && a.options.states[e]) || {})),
            (e = a.brightness),
          ...
          a ||
            (n(e, function (a) {
              ...
              b &&
                ...
                b.animate({ r: e.r, start: e.start, end: e.end }, c.options.animation))
            }),
            (c.animate = null))
        },
          ...
          n(a.points, function (l) {
            ...
            if (l.isNull) d && (l.graphic = d.destroy())
              ...
              d
                ...
                : ((l.graphic = d =
                    c[l.shapeType](h).setRadialReference(a.center).attr(e).add(a.group)),
  ...
  ;(function (a) {
          ...
          n(t, function (g) {
            ...
            n(m, function (c, d) {
              ...
              l &&
                ...
                (m = I(n)
                  ? e(n, m, h.time)
                  : (c[g.formatPrefix + 'Formatter'] || c.formatter).call(m, c)),
                (n = c.style),
                (q = c.rotation),
              ...
              !p || (l && I(m))
                ...
                : ((g.dataLabel = g.dataLabel.destroy()),
                  g.dataLabels &&
                    (1 === g.dataLabels.length ? delete g.dataLabels : delete g.dataLabels[d]),
                  d || delete g.dataLabel,
                  v &&
                    ((g.connector = g.connector.destroy()),
                    g.connectors &&
                      (1 === g.connectors.length ? delete g.connectors : delete g.connectors[d])))
            })
          })
    ...
    c.prototype.alignDataLabel = function (a, c, d, e, h) {
      ...
      if (
        ...
        p
          ? ((v = !1),
            ...
            (m = {
              ...
              y: e.y + d.y + { top: 0, middle: 0.5, bottom: 1 }[d.verticalAlign] * e.height
            }),
        ...
        v && 0 <= e.height
          ...
          : w(d.crop, !0) &&
            (r = b.isInsidePlot(m.x, m.y) && b.isInsidePlot(m.x + n.width, m.y + n.height)),
        d.shape && !p)
      )
        c[h ? 'attr' : 'animate']({
    ...
    c.prototype.justifyDataLabel = function (a, c, d, e, f, h) {
      ...
      n = d.y + e.height - p
      n > b.plotHeight &&
        ('top' === k ? (c.verticalAlign = 'bottom') : (c.y = b.plotHeight - n), (q = !0))
              ...
              for (
                ...
                (e = c[S]),
                  ...
                  w(h.crop, !0) &&
                    ...
                    (l = null),
                    z - C < k && 1 === d
                      ? ((l = Math.round(C - z + k)), (U[3] = Math.max(l, U[3])))
                      : z + C > m - k &&
                        0 === d &&
                        ((l = Math.round(z + C - m + k)), (U[1] = Math.max(l, U[1]))),
                    0 > P - K / 2
                      ? (U[0] = Math.max(Math.round(-P + K / 2), U[0]))
                      : P + K / 2 > p && (U[2] = Math.max(Math.round(P + K / 2 - p), U[2])),
                    (y.sideOverflow = l))
          }),
              ...
              if ((y = a.dataLabel) && y._pos && a.visible && 0 < a.labelDistance) {
                ...
                if ((c = !u))
                  (a.connector = u =
                    ...
                    u.attr({ 'stroke-width': q, stroke: h.connectorColor || a.color || '#666666' })
      ...
      (h.pie.prototype.verifyDataLabelOverflow = function (a) {
        ...
        h ||
          (null !== d[0]
            ...
            : ((f = Math.max(b[2] - a[1] - a[3], e)), (b[0] += (a[3] - a[1]) / 2)),
          null !== d[1]
            ? (f = Math.max(Math.min(f, b[2] - Math.max(a[0], a[2])), e))
            : ((f = Math.max(Math.min(f, b[2] - a[0] - a[2]), e)), (b[1] += (a[0] - a[2]) / 2)),
          f < b[2]
            ? ((b[2] = f),
    ...
    x(q.prototype, {
      ...
      setState: function (a, b) {
        ...
        if (
              ...
              if (p) p[b ? 'animate' : 'attr']({ x: y.x, y: y.y })
                ...
                l &&
                  ((f.stateMarkerGraphic = p =
                    u.renderer.symbol(l, y.x, y.y, y.width, y.height).add(f.markerGroup)),
                  (p.currentSymbol = l))
          ...
          ;(c = h.halo) && c.size
            ? (w || (f.halo = w = u.renderer.path().add((this.graphic || p).parentGroup)),
              ...
              (w.point = this),
              w.attr(x({ fill: this.color || f.color, 'fill-opacity': c.opacity }, c.attributes)))
            : w &&
              w.point &&
              w.point.haloPath &&
        ...
        if (
          ...
          for (
            f = { 'stroke-width': f },
              d.animate(
                f,
                k(e[a || 'normal'] && e[a || 'normal'].animation, b.chart.options.chart.animation)
              );
            b['zone-graph-' + c];
      ...
      function t(e, c, h, p) {
        ...
        a.objectEach(e, function (a, d) {
          if (!p && -1 < I(d, ['series', 'xAxis', 'yAxis']))
            ...
            f(a) ? ((h[d] = n(a) ? [] : {}), t(a, c[d] || {}, h[d], p + 1)) : (h[d] = c[d] || null)
        })
      }
      var w = {}
