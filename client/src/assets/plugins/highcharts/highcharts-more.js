...
;(function (A) {
  ...
  ;(function (b) {
    ...
    n(q.prototype, {
      ...
      setOptions: function (b) {
        this.options = p(this.defaultOptions, this.chart.angular ? { background: {} } : void 0, b)
      },
      render: function () {
        var b = this.options,
        ...
        this.updateCenter()
        if (a)
          for (a = y(a), b = Math.max(a.length, this.background.length || 0), e = 0; e < b; e++)
            a[e] && this.axis
              ? this.renderBackground(p(this.defaultBackgroundOptions, a[e]), e)
              : this.background[e] &&
                ((this.background[e] = this.background[e].destroy()), this.background.splice(e, 1))
      },
      renderBackground: function (b, a) {
        var e = 'animate'
        this.background[a] ||
          ((this.background[a] = this.chart.renderer.path().add(this.group)), (e = 'attr'))
        this.background[a][e]({ d: this.axis.getPlotBandPath(b.from, b.to, b) }).attr({
    ...
    b.radialAxisExtended ||
      ...
      (m = {
        ...
        setOptions: function (a) {
          a = this.options = y(this.defaultOptions, this.defaultRadialOptions, a)
        ...
        getLinePath: function (c, e) {
          ...
          this.isCircular || void 0 !== e
            ? ((e = this.chart.renderer.symbols.arc(this.left + c[0], this.top + c[1], d, d, {
        ...
        getPosition: function (c, e) {
          return this.postTranslate(
            ...
            a(this.isCircular ? e : this.translate(c), this.center[2] / 2) - this.offset
          )
        },
        postTranslate: function (a, c) {
          ...
          return { x: e.plotLeft + d[0] + Math.cos(a) * c, y: e.plotTop + d[1] + Math.sin(a) * c }
        },
        getPlotBandPath: function (c, d, g) {
          ...
          'polygon' === this.options.gridLineInterpolation
            ...
            : ((c = Math.max(c, this.min)),
              ...
              (k[0] -= m),
              (k[2] -= m),
              (h = this.chart.renderer.symbols.arc(this.left + h[0], this.top + h[1], k[0], k[0], {
                start: Math.min(c, d),
                end: Math.max(c, d),
      ...
      q(v, 'init', function (a) {
        ...
        if (d) {
          ...
          e &&
            (n(this, m),
            (this.defaultRadialOptions = (f = g)
              ? this.defaultRadialXOptions
              : y(this.defaultYAxisOptions, this.defaultRadialYOptions)))
        d || e
      ...
      q(v, 'afterInit', function () {
        ...
        ;(c.angular && this.isXAxis) ||
          ...
          (this.endAngleRad = ((a(g.endAngle, g.startAngle + 360) - 90) * Math.PI) / 180),
      ...
      q(g, 'afterGetLabelPosition', function (c) {
        var d = this.axis,
          ...
          f = 20,
          m = g.align,
          k = (((d.translate(this.pos) + d.startAngleRad + Math.PI / 2) / Math.PI) * 180) % 360
        d.isRadial &&
          ...
          null === m &&
            (d.isCircular
              ? (this.label.getBBox().width > (d.len * d.tickInterval) / (d.max - d.min) && (f = 0),
                (m =
                  k > f && k < 180 - f ? 'left' : k > 180 + f && k < 360 - f ? 'right' : 'center'))
              : (m = 'center'),
            e.attr({ align: m })),
          (c.pos.x = b.x + g.x),
          (c.pos.y = b.y + h))
      ...
      c(r, 'getMarkPath', function (a, d, c, e, g, h, b) {
        var f = this.axis
        f.isRadial
          ? ((a = f.getPosition(this.pos, f.center[2] / 2 + e)), (d = ['M', d, c, 'L', a.x, a.y]))
    ...
    y(
      ...
      },
      {
        ...
        translate: function () {
          ...
          q(a.points, function (e) {
            ...
            null === f || null === g
              ...
              : ((e.plotLow = b),
                (e.plotHigh = c.translate(d ? a.modifyValue(f, e) : f, 0, 1, 0, 1)),
        ...
        drawDataLabels: function () {
          ...
          if (t.enabled || this._hasPointLabels) {
            for (d = c; d--; )
              if ((f = e[d]))
                (r = t.inside ? f.plotHigh < f.plotLow : f.plotHigh > f.plotLow),
                  (f.y = f.high),
                  (f._plotY = f.plotY),
                  (f.plotY = f.plotHigh),
                  (b[d] = f.dataLabel),
                  ...
                  k
                    ...
                    : t.verticalAlign || (t.verticalAlign = r ? 'top' : 'bottom')
          ...
          if (x.enabled || this._hasPointLabels) {
            for (d = c; d--; )
              if ((f = e[d]))
                (r = x.inside ? f.plotHigh < f.plotLow : f.plotHigh > f.plotLow),
                  (f.below = !r),
                  k
                    ? x.align || (x.align = r ? 'left' : 'right')
                    : x.verticalAlign || (x.verticalAlign = r ? 'bottom' : 'top')
            this.options.dataLabels = x
            a.drawDataLabels && a.drawDataLabels.apply(this, arguments)
          }
          if (t.enabled)
            for (d = c; d--; )
              (f = e[d]) && f.dataLabelUpper && (f.dataLabels = [f.dataLabelUpper, f.dataLabel])
      ...
      },
      {
        setState: function () {
          ...
          p(this.plotLow) || (this.plotLow = this.plotY = c.yAxis.toPixels(this.low, !0))
  ...
  ;(function (b) {
    ...
    y(
      'columnrange',
      'arearange',
      w(q.column, q.arearange, { pointRange: null, marker: null, states: { hover: { halo: !1 } } }),
      {
        translate: function () {
          var a = this,
            e = a.yAxis,
          ...
          v(a.points, function (g) {
            var k = g.shapeArgs,
              ...
              z,
              l
            g.plotHigh = r = Math.min(Math.max(-f, e.translate(g.high, 0, 1, 0, 1)), f)
            g.plotLow = Math.min(Math.max(-f, g.plotY), f)
            l = r
            z = p(g.rectPlotY, g.plotY) - r
            Math.abs(z) < x ? ((x -= z), (z += x), (l -= x / 2)) : 0 > z && ((z *= -1), (l -= z))
            m
              ? ((d = g.barX + c),
                (g.shapeType = 'path'),
                (g.shapeArgs = { d: a.polarArc(l + z, l, d, d + g.pointWidth) }))
              : ((k.height = z),
                (k.y = l),
                (g.tooltipPos = h.inverted
                  ...
                  : [b.left - h.plotLeft + k.x + k.width / 2, e.pos - h.plotTop + l + z / 2, z]))
          })
        },
        directTouch: !0,
      ...
      },
      {
        ...
        translate: function () {
          ...
          q(this.points, function (d) {
            ...
            v(x)
              ? ((x = (x / 180) * Math.PI),
                (l = Math.max(a.startAngleRad - x, Math.min(a.endAngleRad + x, l))))
              : !1 === b.wrap && (l = Math.max(a.startAngleRad, Math.min(a.endAngleRad, l)))
            l = (180 * l) / Math.PI
            d.shapeType = 'path'
            d.shapeArgs = {
              d: e.path || [
          ...
          q(b.points, function (u) {
            ...
            void 0 !== u.plotY &&
              ...
              z ||
                ...
                v && (u.whiskers = a.path().addClass('highcharts-boxplot-whisker').add(z)),
                p &&
                  (u.box = a
                    .path(void 0)
              ...
              v &&
                ...
                (I['stroke-width'] = w(u.whiskerWidth, l.whiskerWidth, l.lineWidth)),
                u.whiskers.attr(I)),
              p &&
              ...
              (J['stroke-width'] = w(u.medianWidth, l.medianWidth, l.lineWidth)),
              ...
              p &&
                ...
                (k += m),
                (t += m),
                u.box[q]({ d: ['M', k, g, 'L', k, e, 'L', t, e, 'L', t, g, 'L', k, g, 'z'] })),
              v &&
                ((m = (u.whiskers.strokeWidth() % 2) / 2),
                (c += m),
                (d += m),
                (n = /%$/.test(v) ? (x * parseFloat(v)) / 100 : v / 2),
                u.whiskers[q]({ d: ['M', f - n, c, 'L', f + n, c, 'M', f - n, d, 'L', f + n, d] })),
        ...
        generatePoints: function () {
          ...
          for (b = this.points.length; c < b; c++)
            (e = this.points[c]),
              ...
              e.isSum ? (e.y = q(d)) : e.isIntermediateSum && ((e.y = q(d - a)), (a = d))
        },
        translate: function () {
          var a = this.options,
            e = this.yAxis,
          ...
          for (a = c.length; b < a; b++)
            (d = c[b]),
              ...
              (h = d.shapeArgs),
              (m = u && e.stacks[(this.negStacks && r < v ? '-' : '') + this.stackKey]),
              ...
              d.isSum
                ? ((h.y = e.translate(n[1], 0, 1, 0, 1)),
                  (h.height = Math.min(e.translate(n[0], 0, 1, 0, 1), e.len) - h.y))
                : d.isIntermediateSum
                ? ((h.y = e.translate(n[1], 0, 1, 0, 1)),
                  (h.height = Math.min(e.translate(t, 0, 1, 0, 1), e.len) - h.y),
                  (t = n[1]))
                : ((h.height =
                    0 < r
                      ? e.translate(k, 0, 1, 0, 1) - h.y
                      : e.translate(k, 0, 1, 0, 1) - e.translate(k - r, 0, 1, 0, 1)),
              ...
              this.chart.inverted ? (d.tooltipPos[0] = e.len - h) : (d.tooltipPos[1] = h)
        },
  ...
  ;(function (b) {
    ...
    v(
      ...
      },
      {
        type: 'polygon',
        getGraphPath: function () {
          for (var b = q.prototype.getGraphPath.call(this), p = b.length + 1; p--; )
          ...
          for (c = h.length; f < c; f++)
            (g = h[f]),
              k.sizeByAbsoluteValue &&
                null !== g &&
                ((g = Math.abs(g - l)), (b = n = Math.max(b - l, Math.abs(a - l))), (a = 0)),
              y(g)
                ? g < a
                  ? (g = d / 2 - 1)
                  : ((g = 0 < n ? (g - a) / n : 0.5),
          ...
          for (a = d.length; a--; )
            (e = d[a]),
              ...
              y(c) && c >= this.minPxSize / 2
                ? ((e.marker = b.extend(e.marker, { radius: c, width: 2 * c, height: 2 * c })),
                  (e.dlBox = { x: e.plotX - c, y: e.plotY - c, width: 2 * c, height: 2 * c }))
          ...
          n &&
            ...
            c.length &&
              ((E = a(
                ...
                Math.min(
                  E,
                  Math.max(v(c), !1 === f.displayNegative ? f.zThreshold : -Number.MAX_VALUE)
                )
              )),
    ...
    b.polarExtended ||
      ...
      (y.searchPointByAngle = function (a) {
        ...
        return this.searchKDTree({
          clientX:
            180 +
            (-180 / Math.PI) * Math.atan2(a.chartX - g[0] - b.plotLeft, a.chartY - g[1] - b.plotTop)
        })
      }),
      (y.getConnectors = function (a, b, g, c) {
        ...
        e = { rightContX: l, rightContY: n, leftContX: f, leftContY: m, plotX: e, plotY: d }
      ...
      (y.toXY = function (a) {
        ...
        this.kdByAngle
          ? ((g = ((c / Math.PI) * 180 + this.xAxis.pane.options.startAngle) % 360),
            0 > g && (g += 360),
            (a.clientX = g))
          : (a.clientX = a.plotX)
      }),
      ...
      (w = function (a, b) {
        ...
        e.polar
          ? e.renderer.isSVG &&
            (!0 === c && (c = {}),
            b
              ? ((a = { translateX: m[0] + f, translateY: m[1] + l, scaleX: 0.001, scaleY: 0.001 }),
                d.attr(a),
                h && h.attr(a))
          ...
          if (b.isRadial)
            for (c = this.points, h = c.length; h--; )
              (d = c[h]),
                (a = d.barX + g),
                (d.shapeType = 'path'),
                (d.shapeArgs = { d: this.polarArc(d.yBottom, d.plotY, a, a + d.pointWidth) }),
                this.toXY(d),
        ...
        p(n, 'alignDataLabel', function (a, b, g, c, d, h) {
          this.chart.polar
            ? ((a = (b.rectPlotX / Math.PI) * 180),
              null === c.align &&
                (c.align = 20 < a && 160 > a ? 'left' : 200 < a && 340 > a ? 'right' : 'center'),
        ...
        e.polar
          ? q(e.axes, function (a) {
              ...
              c[d ? 'xAxis' : 'yAxis'].push({
                axis: a,
                value: a.translate(
                  d ? Math.PI - Math.atan2(f, g) : Math.sqrt(Math.pow(f, 2) + Math.pow(g, 2)),
                  !0
                )
              })
            })
