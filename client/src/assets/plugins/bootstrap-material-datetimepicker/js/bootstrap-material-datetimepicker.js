    ...
    (s.prototype = {
      ...
      initTemplate: function () {
        for (var e = '', i = this.currentDate.year(), a = i - 3; a < i + 4; a++)
          e += '<div class="year-picker-item" data-year="' + a + '">' + a + '</div>'
        this.midYear = i
        var s =
        ...
        if (!this.params.shortTime) {
          for (i = 0; i < 12; i++) {
            ...
            ;(a = -110 * Math.sin(2 * -Math.PI * (i / 12))),
              ...
              (n = this.currentDate.format(t) == i + 12 ? '#26c6da' : 'transparent'),
          ...
          if (e % 5 == 0) {
            ...
            ;(h.textContent = e),
              this.toggleTime(e, !1)
                ...
                : ((h.className += ' disabled'), h.setAttribute('fill', '#bdbdbd')),
              t.appendChild(h)
          }
        this._centerBox()
      },
      ...
      toggleTime: function (t, i) {
        var a,
          s = !1
        i
          ? ((a = e(this.currentDate)).hour(this.convertHours(t)).minute(0).second(0),
            (s = !(
              !1 === this.isAfterMinDate(a, !0, !1) || !1 === this.isBeforeMaxDate(a, !0, !1)
            )))
          : ((a = e(this.currentDate)).minute(t).second(0),
            (s = !(
              !1 === this.isAfterMinDate(a, !0, !0) || !1 === this.isBeforeMaxDate(a, !0, !0)
            )))
        return s
      },
      ...
      refreshYearItems: function () {
        ...
        var n = 2200
        void 0 !== this.maxDate && null !== this.maxDate && (n = e(this.maxDate).year()),
          ...
          n <= a + 3 && this.$dtpElement.find('.dtp-select-year-range.after').addClass('invisible'),
        ...
        e &&
          t('.dtp-picker-days tbody tr td').each(function () {
            t.inArray(t(this).index(), e) >= 0 ||
              t(this)
                .find('a')
                .css({ background: '#e3e3e3', cursor: 'no-drop', opacity: '0.5' })
                .off('click')
          })
      }
    })
