...
;(function (e) {
        ...
        d = function (a, d) {
          c.append(
            e('<span class="select-item"/>').append(
              b.i18n(
                'select.' + a + 's',
                { _: '%d ' + a + 's selected', 0: '', 1: '1 ' + a + ' selected' },
                d
              )
            )
          )
  ...
  function x(b, a, c, d) {
    var f = b[a + 's']({ search: 'applied' }).indexes(),
      d = e.inArray(d, f),
      m = e.inArray(c, f)
    if (!b[a + 's']({ selected: !0 }).any() && -1 === d) f.splice(e.inArray(c, f) + 1, f.length)
    else {
      if (d > m)
        var j = m,
          m = d,
  ...
  function s(b, a, c, d, f) {
    ...
    'os' === e
      ? b.ctrlKey || b.metaKey
        ...
        : ((b = a[d + 's']({ selected: !0 })),
          j && 1 === b.flatten().length ? a[d](f).deselect() : (b.deselect(), a[d](f).select()))
      : 'multi+shift' == e
      ? b.shiftKey
        ? 'cell' === d
          ? t(a, f, c._select_lastCell || null)
    ...
    function (b, a) {
      g.ext.selector[a.type].push(function (c, b, f) {
        ...
        for (var g = 0, i = f.length; g < i; g++)
          (e = c[a.prop][f[g]]),
            ((!0 === b && !0 === e._select_selected) || (!1 === b && !e._select_selected)) &&
              j.push(f[g])
        return j
      })
    }
