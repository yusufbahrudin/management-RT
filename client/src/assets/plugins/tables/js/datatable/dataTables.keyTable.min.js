    ...
    _focus: function (a, b, c, d) {
      ...
      if (this.s.enable) {
        if ('number' !== typeof a) {
          var j = a.index(),
            b = j.column,
            a = g.rows({ filter: 'applied', order: 'applied' }).indexes().indexOf(j.row)
            ...
            switch (a.keyCode) {
              ...
              case 34:
                if (c) {
                  ...
                  g.one('draw', function () {
                    ...
                    i._focus(g.cell(f < b.length ? b[f] : b[b.length - 1]), null, !0, a)
                  })
              ...
              case 36:
                c &&
                  ...
                  this._focus(g.cell(b[35 === a.keyCode ? b.length - 1 : 0]), null, !0, a))
                break
              case 37:
              ...
              case 40:
                ...
                break
              default:
                !0 === b && this._emitEvent('key', [g, a.keyCode, this.s.lastFocus, a])
            }
        }
      }
    },
