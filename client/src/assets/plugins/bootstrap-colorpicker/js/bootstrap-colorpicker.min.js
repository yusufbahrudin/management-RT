  ...
  return (function (e) {
              ...
              [
                {
                  ...
                  value: function (t) {
                    ...
                    if (
                      ...
                      return (this._color = (0, a.default)(null)), void (this._original.valid = !1)
              ...
              [
                {
                  ...
                  value: function (t) {
                    ...
                    var o = null
                    ;(t =
                      t instanceof l ? [t.h, t.s, t.v, isNaN(t.a) ? 1 : t.a] : e.sanitizeString(t)),
      ...
      ;(l.rgb.hsl = function (e) {
        ...
        (l.lch.lab = function (e) {
          var t,
            ...
            a = e[2]
          return (
            (r = (a / 360) * 2 * Math.PI), (t = i * Math.cos(r)), (o = i * Math.sin(r)), [n, t, o]
          )
        }),
        (l.rgb.ansi16 = function (e) {
          ...
          var i =
            30 + ((Math.round(r / 255) << 2) | (Math.round(o / 255) << 1) | Math.round(t / 255))
          return 2 === n && (i += 60), i
        }),
        ...
        (l.hcg.rgb = function (e) {
          ...
          return (
            (s = (1 - o) * r), [255 * (o * n[0] + s), 255 * (o * n[1] + s), 255 * (o * n[2] + s)]
          )
        }),
                  ...
                  e.picker.addClass('colorpicker-popup colorpicker-hidden'),
                    (this.hasInput || this.hasAddon) &&
                      ...
                      this.hasAddon &&
                        ...
                        this.addon.on({ 'focus.colorpicker': l.default.proxy(this.show, this) }),
                        this.addon.on({
                ...
                value: function () {
                  this.hasInput &&
                    ...
                    this.hasAddon &&
                      ...
                      this.addon.off({ 'focusout.colorpicker': l.default.proxy(this.hide, this) })),
              ...
              },
              {
                ...
                value: function () {
                  ...
                  ;(this.popoverTarget = this.hasAddon ? this.addon : this.input),
                    ...
                    this.popoverTarget.on('hidden.bs.popover', l.default.proxy(this.fireHide, this))
                }
              },
              {
                key: 'reposition',
    ...
    function (e, t, o) {
      ...
      ;(r.prototype = {
        ...
        round: function (e) {
          return (
            (e = Math.max(e || 0, 0)), new r(this.color.map(i(e)).concat(this.valpha), this.model)
          )
        },
        alpha: function (e) {
          return arguments.length
