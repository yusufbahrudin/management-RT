...
!(function (t, e) {
        ...
        ? o.items
            .map(function (t) {
              ...
              return (
                ...
                t +
                '"><a href="#" ' +
                ('data-value="' + e + '"' + (void 0 !== i ? ' data-option="' + i + '"' : '')) +
                '>' +
                n +
                '</a></li>'
              )
      ...
      createLayout: function (t, e) {
        var o = (
          e.airMode
            ...
            : y.editor([y.toolbar(), y.editingArea([y.codable(), y.editable()]), y.statusbar()])
        ).render()
        return (
          o.insertAfter(t),
          {
  ...
  function yt(t, e) {
    ...
    if (0 === t.offset) {
      ...
      bt(t.node)
        ? (n = it((o = t.node.childNodes[t.offset - 1])))
  ...
  function kt(t, e) {
    ...
    if (it(t.node) === t.offset) {
      ...
      bt(t.node)
        ...
        : ((o = t.node), (n = e ? it(t.node) : t.offset + 1))
    return { node: o, offset: n }
  }
  function Ct(t, e) {
  ...
  var Nt = {
    ...
    html: function (e, o) {
      var n = $t(e)
      o &&
        ((n = n.replace(/<(\/?)(\b(?!!)[^>\s]*)(.*?)(\s*\/?>)/g, function (t, e, o) {
          o = o.toUpperCase()
                ...
                Nt.isEditable(e.node) ||
                  (n
                    ? (Nt.isLeftEdgePoint(e) && a.push(e.node),
                      Nt.isRightEdgePoint(e) && N.contains(a, e.node) && (i = e.node))
    ...
    Ft = (function () {
      ...
      return (
        ...
        (e.prototype.current = function (e) {
          ...
          if (e.isOnList()) {
            var i =
              t.inArray(n['list-style-type'], ['circle', 'disc', 'disc-leading-zero', 'square']) >
              -1
      ...
      ;(this.getActionList = function () {
        for (
          ...
          s.push(
            ...
            (n = f),
            (a = m),
            { baseCell: v.baseCell, action: t, virtualTable: { rowIndex: n, cellIndex: a } })
          ),
            d++
        }
        return s
          ...
          for (
            ...
            switch (c.action) {
              ...
              case Mt.resultAction.SumSpanCount:
                if ('top' === o)
                  if (
                    (c.baseCell.parent ? c.baseCell.closest('tr').rowIndex : 0) <= i[0].rowIndex
                  ) {
                    var u = t('<div></div>')
                      .append(t('<td' + d + '>' + Nt.blank + '</td>').removeAttr('rowspan'))
                      .html()
                    s.append(u)
                    break
                  }
              ...
              switch (r[s].action) {
                ...
                case Mt.resultAction.SubtractSpanCount:
                  ...
                  if (a.colSpan && a.colSpan > 1) {
                    ...
                    l > 2
                      ? (l--, a.setAttribute('colSpan', l), a.cellIndex === i && (a.innerHTML = ''))
                      : 2 === l &&
                        (a.removeAttribute('colSpan'), a.cellIndex === i && (a.innerHTML = ''))
                  }
                  continue
                case Mt.resultAction.RemoveCell:
    ...
    jt = (function () {
      ...
      return (
        (e.prototype.initialize = function () {
          ...
          this.$editable
            .on('keydown', function (e) {
              if (
                (e.keyCode === At.code.ENTER && t.context.triggerEvent('enter', e),
                t.context.triggerEvent('keydown', e),
                e.isDefaultPrevented() ||
                  (t.options.shortcuts ? t.handleKeyMap(e) : t.preventDefaultEditableShortCuts(e)),
                t.isLimited(1, e))
              )
                return !1
            })
        ...
        (e.prototype.getSelectedText = function () {
          var t = this.createRange()
          return (
            t.isOnAnchor() && (t = Ht.createFromNode(Nt.ancestor(t.sc, Nt.isAnchor))), t.toString()
          )
        }),
              ...
              .on('drop', function (o) {
                ...
                o.preventDefault(),
                  n && n.files && n.files.length
                    ? (e.$editable.focus(),
                      e.context.invoke('editor.insertImagesOrCallback', n.files))
      ...
      return (
        ...
        (e.prototype.update = function (e) {
          ...
          if ((this.context.invoke('imagePopover.update', e), o)) {
            ...
            n.css({ display: 'block', left: s.left, top: s.top, width: a.w, height: a.h }).data(
              'target',
              i
            )
            var l = new Image()
      ...
      return (
        ...
        (e.prototype.isFontDeservedToAdd = function (e) {
          return (
            ...
            -1 === t.inArray(e, ['sans-serif', 'serif', 'monospace', 'cursive', 'fantasy'])
          )
        }),
            ...
            return e.ui
              .buttonGroup([
                ...
                e.ui.dropdown({
                  ...
                  template: function (t) {
                    'string' == typeof t &&
                      (t = { tag: t, title: e.lang.style.hasOwnProperty(t) ? e.lang.style[t] : t })
                    var o = t.tag,
                      n = t.title
                    return (
                      '<' +
                  ...
                  children: [
                    ...
                    e.ui.dropdown({
                      items: [
                        ...
                        '  <div class="note-palette-title">' + e.lang.color.background + '</div>',
                        '  <div>',
                        ...
                        '</div>',
                        '<div class="note-palette">',
                        '  <div class="note-palette-title">' + e.lang.color.foreground + '</div>',
                        '  <div>',
            ...
            this.context.memo('button.paragraph', function () {
              return e.ui
                .buttonGroup([
                  ...
                  e.ui.dropdown([
                    e.ui.buttonGroup({ className: 'note-align', children: [s, a, l, c] }),
                    e.ui.buttonGroup({ className: 'note-list', children: [d, u] })
                  ])
                ])
                .render()
            }),
                  ...
                  ],
                  {
                    callback: function (t) {
                      t.find('.note-dimension-picker-mousecatcher')
                        ...
                        .mousedown(e.context.createInvokeHandler('editor.insertTable'))
        ...
        (e.prototype.tableMoveHandler = function (e) {
          ...
          s.css({ width: c + 'em', height: d + 'em' }),
            r.data('value', c + 'x' + d),
            c > 3 && c < this.options.insertTableMaxSize.col && a.css({ width: c + 1 + 'em' }),
            d > 3 && d < this.options.insertTableMaxSize.row && a.css({ height: d + 1 + 'em' }),
            i.html(c + ' x ' + d)
        }),
        e
      )
      ...
      return (
        ...
        (e.prototype.createVideoNode = function (e) {
          ...
          if (n && 11 === n[1].length) {
            ...
            o = t('<iframe webkitallowfullscreen mozallowfullscreen allowfullscreen>')
              .attr('frameborder', 0)
            ...
            o = t('<iframe webkitallowfullscreen mozallowfullscreen allowfullscreen>')
              ...
              .attr('height', '310')
              .attr('width', '500')
              .attr('src', 'http://v.qq.com/iframe/player.html?vid=' + m + '&amp;auto=0')
          } else {
            if (!(u || h || p)) return !1
          ...
          return Object.keys(o)
            .map(function (n) {
              ...
              return (
                r
                  .append(
                    t('<label><kbd>' + n + '</kdb></label>').css({ width: 180, 'margin-right': 10 })
                  )
        ...
        (e.prototype.handleKeydown = function (t) {
          this.$popover.is(':visible') &&
            (t.keyCode === At.code.ENTER
              ...
              : t.keyCode === At.code.DOWN && (t.preventDefault(), this.moveDown()))
        }),
  ...
  t.fn.extend({
    summernote: function () {
      ...
      ;(i.langInfo = t.extend(!0, {}, t.summernote.lang['en-US'], t.summernote.lang[i.lang])),
