...
!(function (e, n) {
  if (
    (void 0 === e && void 0 !== window && (e = window), 'function' == typeof define && define.amd)
  )
  ...
  !(function (f) {
    ...
    function M(t, n) {
      return function () {
        ...
        return (
          'string' != typeof e[0] && 1 === e.length && e.push(null), o.apply(f, e.concat([t, n]))
        )
      }
    }
    function w(t) {
        ...
        e = function (e) {
          ...
          if (e instanceof r == !1) {
            if ('string' != typeof e && 'number' != typeof e)
              throw new Error('`date` option is invalid type. (date: ' + e + ').')
            e = r(e)
          }
        ...
        return function (e) {
          ...
          ;(t.settings = o.extend(!0, {}, s, e)),
            ...
            t.settings.lang !== r.defaultLanguage &&
              ...
              ((t.settings.weeks =
                n.languages.weeks[t.settings.lang] || n.languages.weeks[r.defaultLanguage]),
              (t.settings.monthsLong =
                n.languages.monthsLong[t.settings.lang] ||
                n.languages.monthsLong[r.defaultLanguage]),
              (t.settings.months =
                n.languages.months[t.settings.lang] || n.languages.months[r.defaultLanguage]),
              (t.settings.controls =
                n.languages.controls[t.settings.lang] || n.languages.controls[r.defaultLanguage])),
            'light' !== t.settings.theme &&
              -1 === o.inArray(t.settings.theme, a.preference.supports.themes) &&
        ...
        return D.each(function () {
              ...
              (t = t.toUpperCase()),
                P(
                  N.format(
                    ...
                    N.getSubClass('week'),
                    t,
                    F.languages.weeks.en[e % F.languages.weeks.en.length].toLowerCase()
                  )
          ...
          if (
            ...
            ;(C = P(k.calendarWrapperHtml)).bind('click', function (e) {
              ...
              C.unbind('cancel.' + N.getClass(q.name) + ' apply.' + N.getClass(q.name)).bind(
          ...
          var M = function () {
              ...
              for (
                ...
                var l = n.format('YYYY-MM-DD'),
                  u = k.calendar
                    .find(N.format('.{0}[data-date="{1}"]', N.getSubClass('unit'), l))
                    .addClass(S)
          ...
          ;(k.renderer = function () {
            if (
              ...
              k.calendar
                ...
                .text(D.settings.months[k.dateManager.prevMonth - 1].toUpperCase()),
              k.calendar
                .find(N.format('.{0}-next .{0}-value', z.top))
                .text(D.settings.months[k.dateManager.nextMonth - 1].toUpperCase()),
              ...
              J.find('.' + z.button).bind('click', function (e) {
                ...
                if (t.hasClass(z.button + '-apply')) {
                  ...
                  if (!0 === D.settings.toggle) n = k.storage.activeDates.join(', ')
                    ...
                    var a = []
                    null !== k.current[0] && a.push(k.current[0].format(D.settings.format)),
                      null !== k.current[1] && a.push(k.current[1].format(D.settings.format)),
                      (n = a.join(' ~ '))
            ...
            for (
              var g = [],
                c = [
                  null === k.current[0] ? null : k.current[0].format('YYYY-MM-DD'),
                  null === k.current[1] ? null : k.current[1].format('YYYY-MM-DD')
                ],
            ...
            for (
              var l = function (e) {
                  ...
                  else if ((null !== d && 0 < d.diff(t)) || (null !== f && f.diff(t) < 0))
                    a.addClass(N.getSubClass('unitDisabled')).addClass(
                  ...
                  a.bind('click', function (e) {
                    ...
                    if (t.hasClass(N.getSubClass('unitDisabled'))) s = !0
                      ...
                      if (!0 === D.settings.toggle) {
                        ...
                        if (((k.current[a] = T(n)), r.length < 1))
                          k.storage.activeDates.push(n), t.addClass(L).removeClass(x)
                        else {
                      ...
                      } else if (!0 === t.hasClass(O) && !1 === D.settings.pickWeeks)
                        !0 === D.settings.multiple &&
                        ...
                        if (!0 === D.settings.pickWeeks)
                          if (!0 === t.hasClass(O) || !0 === t.hasClass(S)) {
                            ...
                            ;(k.current[0] = T(n).startOf('week').add(D.settings.week, 'days')),
                              (k.current[1] = T(n).endOf('week').add(D.settings.week, 'days'))
                            for (var g = 0; g < 2; g++)
                              k.calendar
                                .find('.' + O + '.' + j[g])
                                .removeClass(O)
                          ...
                          if (
                            (!1 ===
                              (function (e, t) {
                                ...
                                for (
                                  var c = 0, d = 0;
                                  c < D.settings.disabledWeekdays.length && d < 7;
                                  c++
                                ) {
                                  d++
                    ...
                    if (k.current[0])
                      if (k.current[1])
                        for (
                          ...
                          m.format('YYYY-MM-DD') <= k.current[1].format('YYYY-MM-DD');
                          m.add('1', 'days')
                        )
                          f(m.clone())
                    ...
                    !1 === s &&
                      ...
                      'function' == typeof D.settings.click && D.settings.click.call(t, e, k)
                  })
                },
            ...
            for (var m = r + 1; g.length < 5 * D.settings.weeks.length; m++) {
              ...
              var p = P(
                N.format(
                  '<div class="{0} {0}-{1}"></div>',
                  N.getSubClass('unit'),
                  F.languages.weeks.en[m % F.languages.weeks.en.length].toLowerCase()
                )
              )
              g.push(p)
            }
            for (var v = null, h = 0; h < g.length; h++) {
              ...
              ;(h % D.settings.weeks.length == 0 || h + 1 >= g.length) &&
                (null !== v && v.appendTo(e),
                h + 1 < g.length &&
                  (v = P(N.format('<div class="{0}"></div>', N.getSubClass('row'))))),
                v.append(b)
            }
            k.calendar.find('.' + z.top + '-nav').bind('click', function (e) {
              ...
              t.hasClass(z.top + '-prev')
                ? ((n = 'prev'),
                  (k.dateManager = new W(k.dateManager.date.clone().add(-1, 'months'))))
          ...
          if (((s.language = a.language), 0 < Object.keys(a.languages).length)) {
            var t = function (t) {
              ...
              if (
                ...
                return (
                  console.warn('Warning: `weeks` option of `' + t + '` language is missing.'),
                  'break'
                )
              if (!n.monthsLong)
                return (
                  console.warn('Warning: `monthsLong` option of `' + t + '` language is missing.'),
                  'break'
                )
              if (!n.months)
                return (
                  console.warn('Warning: `months` option of `' + t + '` language is missing.'),
                  'break'
                )
              if (!n.controls)
                return (
                  console.warn('Warning: `controls` option of `' + t + '` language is missing.'),
                  'break'
                )
              if (n.weeks) {
                if (n.weeks.length < 7)
                  return console.error('`weeks` must have least 7 items.'), 'break'
                7 !== n.weeks.length &&
                  console.warn('`weeks` option over 7 items. We recommend to give 7 items.')
              }
              if (n.monthsLong) {
                if (n.monthsLong.length < 12)
                  return console.error('`monthsLong` must have least 12 items.'), 'break'
                12 !== n.monthsLong.length &&
                  console.warn('`monthsLong` option over 12 items. We recommend to give 12 items.')
              }
              if (n.months) {
                if (n.months.length < 12)
                  return console.error('`months` must have least 12 items.'), 'break'
                12 !== n.months.length &&
                  console.warn('`months` option over 12 items. We recommend to give 12 items.')
              }
              if (n.controls) {
                if (!n.controls.ok)
                  return (
              ...
              ;-1 === s.languages.supports.indexOf(t) && s.languages.supports.push(t),
                ['weeks', 'monthsLong', 'months', 'controls'].map(function (e) {
                  s.languages[e][t] &&
                    console.warn(
                      '`' + t + '` language is already given however it will be overwriten.'
                    ),
                    (s.languages[e][t] = n[e] || s.languages[e][t.defaultLanguage])
                })
            }
        ...
        return function (e) {
          if (e) {
            ...
            this.each(function () {
              ...
              !0 === t.settings.toggle ? (e.storage.activeDates = s) : (e.current = n),
                e.renderer.call()
            })
          }
        }
