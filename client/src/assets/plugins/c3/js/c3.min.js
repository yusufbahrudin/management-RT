...
!(function (t, e) {
  ...
  ;(i.prototype.axisX = function (t, e, i) {
    ...
    (i.prototype.splitTickText = function (t, e) {
      ...
      return (
        (!c || c <= 0) &&
          (c = s.isVertical() ? 95 : s.params.isCategory ? Math.ceil(e(1) - e(0)) - 12 : 110),
        (function t(e, i) {
          a = void 0
      ...
      return (
        ...
        (A.tickInterval = function () {
          ...
          return (t = b.isCategory
            ? 2 * w.tickOffset
            : (A.g.select('path.domain').node().getTotalLength() - 2 * w.outerTickSize) /
  ...
  var Y = {
    ...
    u = function (t) {
      return (
        null == t || (c(t) && 0 === t.length) || ('object' === s(t) && 0 === Object.keys(t).length)
      )
    },
    h = function (t) {
    ...
    (d.prototype.generateTickValues = function (t, e, i) {
      ...
      if (e)
        if (1 === (n = h(e) ? e() : e)) l = [t[0]]
          ...
          for (
            o = n - 2, r = t[0], s = ((a = t[t.length - 1]) - r) / (o + 1), l = [r], c = 0;
            c < o;
            c++
          )
  ...
  return (
    ...
    (l.prototype.initWithData = function (t) {
      ...
      ;(n.axis = new d(n)),
        ...
        a.data_hide &&
          n.addHiddenTargetIds(!0 === a.data_hide ? n.mapToIds(n.data.targets) : a.data_hide),
        a.legend_hide &&
    ...
    (l.prototype.opacityForCircle = function (t) {
      var e = (h(this.config.point_show) ? this.config.point_show(t) : this.config.point_show)
        ? 1
        : 0
    ...
    (n.prototype.category = function (t, e) {
      var i = this.internal,
        n = i.config
      return (
        1 < arguments.length && ((n.axis_x_categories[t] = e), i.redraw()), n.axis_x_categories[t]
      )
    }),
    ...
    (l.prototype.updateRadius = function () {
      ...
      ;(t.radiusExpanded =
        ...
        (t.gaugeArcWidth =
          i ||
          (n <= t.radius - t.innerRadius ? t.radius - t.innerRadius : n <= t.radius ? n : t.radius))
    }),
      ...
      if (
        ...
        g
          ...
          l.arcs
            ...
            .attr(
              'dx',
              -1 * (l.innerRadius + (l.radius - l.innerRadius) / (s.gauge_fullCircle ? 1 : 2)) +
                'px'
            )
            .attr('dy', '1.2em')
          ...
          l.arcs
            ...
            .attr(
              'dx',
              l.innerRadius + (l.radius - l.innerRadius) / (s.gauge_fullCircle ? 1 : 2) + 'px'
            )
            .attr('dy', '1.2em')
    ...
    (l.prototype.updateXDomain = function (t, e, i, n, r) {
      ...
      return (
        ...
        e &&
          a.x.domain(
            r || (!a.brush || a.brush.empty() ? a.orgXDomain : a.brush.selectionAsValue())
          ),
        ...
        (a.data_selection_enabled &&
          ...
          o
            ...
            .each(function (t, e) {
              ...
              u ^ l &&
                (c.classed(Y.INCLUDED, !l), c.classed(Y.SELECTED, !d), o.call(_, !d, c, t, e))
            })))
    }),
    ...
    (l.prototype.initGrid = function () {
      ...
      ;(t.grid = t.main.append('g').attr('clip-path', t.clipPathForGrid).attr('class', Y.grid)),
        ...
        e.grid_focus_show &&
          t.grid.append('g').attr('class', Y.xgridFocus).append('line').attr('class', Y.xgridFocus),
        (t.xgrid = i.selectAll([])),
    ...
    (l.prototype.generateGridData = function (t, e) {
      ...
      if ('year' === t)
        for (
          n = (i = this.getXDomain())[0].getFullYear(), r = i[1].getFullYear(), a = n;
          a <= r;
          a++
        )
            ...
            o.interaction_enabled
              ? function () {
                  ...
                  r.dragging ||
                    ...
                    i
                      ? ((n = (
                          r.isScatterType(i) || !o.tooltip_grouped ? [i] : r.filterByX(t, i.x)
                        ).map(function (t) {
                          return r.addName(t)
                        })),
                        ...
                        r.main
                          ...
                          .each(function () {
                            ;(o.data_selection_grouped || r.isWithinShape(this, t)) &&
                              (r.toggleShape(this, t, t.index), o.data_onclick.call(r.api, t, this))
                          })
                      }))
                }
              : null
    ...
    (l.prototype.updateLegend = function (f, t, e) {
      ...
      ;(f = f.filter(function (t) {
        ...
        m.isLegendInset &&
          ((O = S.legend_inset_step ? S.legend_inset_step : f.length), m.updateLegendStep(O)),
        (a = m.isLegendRight
          ? ((i = function (t) {
              return b * I[t]
            }),
    ...
    (l.prototype.toggleShape = function (t, e, i) {
      ...
      a.data_selection_enabled &&
        ...
        (a.data_selection_multiple ||
          n.main
            .selectAll(
              '.' + Y.shapes + (a.data_selection_grouped ? n.getTargetSelectorSuffix(e.id) : '')
            )
            .selectAll('.' + Y.shape)
            .each(function (t, e) {
              var i = r.select(this)
    ...
    (l.prototype.getBars = function (t, e) {
      return (
        e ? this.main.selectAll('.' + Y.bars + this.getTargetSelectorSuffix(e)) : this.main
    ...
    (l.prototype.getCircles = function (t, e) {
      return (
        e ? this.main.selectAll('.' + Y.circles + this.getTargetSelectorSuffix(e)) : this.main
    ...
    (l.prototype.showTooltip = function (t, e) {
      ...
      0 !== c.length &&
        ...
        (a.tooltip
          .html(
            o.tooltip_contents.call(a, t, a.axis.getXAxisTickFormat(), a.getYFormat(s), a.color)
          )
          .style('display', 'block'),
    ...
    (l.prototype.initZoom = function () {
      ...
      return (
        ...
        (i.zoom.updateDomain = function () {
          return (
            n.event && n.event.transform && i.x.domain(n.event.transform.rescaleX(i.subX).domain()),
            this
          )
        }),
