!(function () {
  ...
  function r(e, t, r) {
    var o,
      ...
      S = ''
    if ('Byte' == t)
      (o = e.length), 4 >= o ? (S = a(e) + p('\x00', 4 - o)) : ((S = s('>L', [r])), (c = a(e)))
    else if ('Short' == t)
      (o = e.length), 2 >= o ? (S = i(e) + p('\x00\x00', 2 - o)) : ((S = s('>L', [r])), (c = i(e)))
      ...
      'Undefined' == t &&
        ((o = e.length), o > 4 ? ((S = s('>L', [r])), (c = e)) : (S = e + p('\x00', 4 - o)))
    var h = s('>L', [o])
    return [h, S, c]
  }
  function o(e, t, a) {
  ...
  function l(e) {
    var t, a
    if ('د' == e.slice(0, 2))
      (t = y(e)), (a = c(t)), a ? (this.tiftag = a.slice(10)) : (this.tiftag = null)
  ...
  function s(e, t) {
    ...
    if (e.length - 1 != t.length)
      throw "'pack' error. " + (e.length - 1) + ' marks, ' + t.length + ' elements.'
    var a
    if ('<' == e[0]) a = !0
    else {
      if ('>' != e[0]) throw ''
    ...
    for (var i = '', n = 1, r = null, o = null, l = null; (o = e[n]); ) {
      if ('b' == o.toLowerCase()) {
        ...
        if (((r = t[n - 1]), 'l' == o && 0 > r && (r += 4294967296), r > 4294967295 || 0 > r))
          throw "'pack' error."
        ;(l =
  ...
  function m(e, t) {
    ...
    if (a != t.length)
      throw "'unpack' error. Mismatch between symbol and string length. " + a + ':' + t.length
    var n
    if ('<' == e[0]) n = !0
    else {
    ...
    for (var r = [], o = 0, l = 1, s = null, m = null, p = null, y = ''; (m = e[l]); ) {
      if ('b' == m.toLowerCase())
        (p = 1), (y = t.slice(o, o + p)), (s = y.charCodeAt(0)), 'b' == m && s >= 128 && (s -= 256)
      else if ('H' == m)
        (p = 2),
          (y = t.slice(o, o + p)),
  ...
  function S(e, t) {
    return (
      '؈' == e[1].slice(0, 2) && '؇' == e[2].slice(0, 2) && 'Exif\x00\x00' == e[2].slice(4, 10)
        ? t
          ? ((e[2] = t), (e = ['د'].concat(e.slice(2))))
          : (e = null == t ? e.slice(0, 2).concat(e.slice(3)) : e.slice(0).concat(e.slice(2)))
        : '؈' == e[1].slice(0, 2)
        ? t && (e[1] = t)
  ...
  if (
    ...
    (f.load = function (e) {
      ...
      if (
        ...
        34665 in a['0th'] && ((n = a['0th'][34665]), (a.Exif = i.get_ifd(n, 'Exif'))),
        34853 in a['0th'] && ((n = a['0th'][34853]), (a.GPS = i.get_ifd(n, 'GPS'))),
        40965 in a.Exif && ((n = a.Exif[40965]), (a.Interop = i.get_ifd(n, 'Interop'))),
        '\x00\x00\x00\x00' != r &&
        ...
        ('Interop' in y && Object.keys(y.Interop).length)
          ? ((i[34665] = 1),
            ...
            'Interop' in y && Object.keys(y.Interop).length
              ...
              : Object.keys(n).indexOf(f.ExifIFD.InteroperabilityTag.toString()) > -1 &&
                delete n[40965])
          : Object.keys(i).indexOf(f.ImageIFD.ExifTag.toString()) > -1 && delete i[34665],
    ...
    (l.prototype = {
      get_ifd: function (e, t) {
        ...
        return (
          '0th' == t && ((e = r + 12 * n), (i.first_ifd_pointer = this.tiftag.slice(e, e + 4))), i
        )
      },
        ...
        if (1 == i)
          n > 4
            ? ((t = m(this.endian_mark + 'L', r)[0]),
              (a = m(this.endian_mark + p('B', n), this.tiftag.slice(t, t + n))))
            : (a = m(this.endian_mark + p('B', n), r.slice(0, n)))
        else if (2 == i)
          n > 4
            ? ((t = m(this.endian_mark + 'L', r)[0]), (a = this.tiftag.slice(t, t + n - 1)))
            : (a = r.slice(0, n - 1))
        else if (3 == i)
          n > 2
            ? ((t = m(this.endian_mark + 'L', r)[0]),
              (a = m(this.endian_mark + p('H', n), this.tiftag.slice(t, t + 2 * n))))
            : (a = m(this.endian_mark + p('H', n), r.slice(0, 2 * n)))
        else if (4 == i)
          n > 1
            ? ((t = m(this.endian_mark + 'L', r)[0]),
              (a = m(this.endian_mark + p('L', n), this.tiftag.slice(t, t + 4 * n))))
          ...
          if (((t = m(this.endian_mark + 'L', r)[0]), n > 1)) {
            ...
            for (var o = 0; n > o; o++)
              a.push([
                m(this.endian_mark + 'L', this.tiftag.slice(t + 8 * o, t + 4 + 8 * o))[0],
                m(this.endian_mark + 'L', this.tiftag.slice(t + 4 + 8 * o, t + 8 + 8 * o))[0]
              ])
          } else
            a = [
          ...
          n > 4
            ? ((t = m(this.endian_mark + 'L', r)[0]), (a = this.tiftag.slice(t, t + n)))
            : (a = r.slice(0, n))
        else {
