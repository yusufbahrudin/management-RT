        ...
        if (e && e.length) {
          ...
          e.off(r).on(r, function () {
            var r = e.get(0),
              ...
              o = r.offsetWidth,
              l = t.getRotation(a)
            if ((e.data('orientation', a), n && i.data('orientation', a), a < 5))
    ...
    ((i = function (i, a) {
        ...
        ;(i = t.closeButton('fileinput-remove')),
          ...
          (h.defaults = {
            ...
            fileTypeSettings: {
              ...
              flash: function (e, i) {
                return (
                  t.compare(e, 'application/x-shockwave-flash', !0) || t.compare(i, /\.(swf)$/i)
                )
              },
              pdf: function (e, i) {
        ...
        ;(i.previewCache = {
          ...
          get: function (a, r) {
            var n,
              ...
              w = function (e, a, r, n, s, o, l, d, c) {
                return (
                  (d = ' file-preview-initial ' + t.SORT_CSS + (d ? ' ' + d : '')),
            ...
            return m
              ? ((r = void 0 === r || r),
                ...
                (n = v
                  ? w(o, m, d, c, g, l, p, h)
                  : w('generic', m, d, c, g, l, p, h, o).setTokens({ content: u.content[a] })),
          ...
          add: function (e, a, r, n) {
            ...
            return (
              ...
              n
                ? ((s = o.content.push(e) - 1), (o.config[s] = a), (o.tags[s] = r))
                : ((s = e.length - 1), (o.content = e), (o.config = a), (o.tags = r)),
          ...
          out: function () {
            ...
            for (e = 0; e < r; e++)
              (t = i.previewCache.get(e)), (a = i.reversePreviewOrder ? t + a : a + t)
      ...
      _errorsExist: function () {
        ...
        return (
          ...
          ((t = e(document.createElement('div')).html(this.$errorContainer.html()))
            .find('.kv-error-close')
            .remove(),
          t.find('ul').remove(),
        ...
        var n,
          ...
          o =
            void 0 !== i.responseJSON && void 0 !== i.responseJSON.error
              ...
              : i.responseText
        return (
          this.cancelling && this.msgUploadAborted && (s = this.msgUploadAborted),
      ...
      _parseFileType: function (e, i) {
        ...
        for (n = 0; n < s.length; n++)
          if (((r = s[n]), (a = (0, this.fileTypeSettings[r])(e, i) ? r : ''), !t.isEmpty(a)))
            return a
        return 'other'
      },
        ...
        return (
          t &&
            ...
            a.previewFileIconSettings &&
              (r =
                a.previewFileIconSettings[i] || a.previewFileIconSettings[i.toLowerCase()] || null),
      ...
      _listen: function () {
        ...
        i._handler(a, 'click', function (e) {
          a.hasClass('file-no-browse') &&
            (a.data('zoneClicked') ? a.data('zoneClicked', !1) : e.preventDefault())
        }),
      ...
      _getZoomButton: function (e) {
        ...
        return (
          ('fullscreen' !== e && 'borderless' !== e && 'toggleheader' !== e) ||
            (a += ' data-toggle="button" aria-pressed="false" autocomplete="off"'),
      ...
      _initZoom: function () {
        ...
        a.showPreview &&
          ...
          (a.$modal && a.$modal.length) ||
            ((i = e(document.createElement('div')).html(r).insertAfter(a.$container)),
        ...
        ;(n = b.attr('data-template') || 'generic'),
          ...
          (c = p.previewZoomSettings[n]) &&
            ...
            e.each(c, function (e, t) {
              d.css(e, t),
                ((d.attr('width') && 'width' === e) || (d.attr('height') && 'height' === e)) &&
                  d.removeAttr(e)
            })),
          f.data('previewId', u),
      ...
      _refreshPreview: function () {
        ...
        this._inputFileCount() &&
          ...
          (this.isAjaxUpload
            ? ((e = this.getFileStack()),
              (this.filestack = []),
              e.length ? this._clearFileInput() : (e = this.$element.get(0).files))
      ...
      _resetCanvas: function () {
        this.canvas &&
          ...
          this.imageCanvasContext.clearRect(0, 0, this.canvas.width, this.canvas.height)
      },
      ...
      _validateDefaultPreview: function () {
        this.showPreview &&
          ...
          (this._setPreviewContent(
            '<div class="file-default-preview">' + this.defaultPreviewContent + '</div>'
          ),
          ...
          void 0 !== a
            ? r
              ...
              : ((o = f.previewCache.add(c, h[0], p[0], n)),
                ...
                (d = (l = e(document.createElement('div')).html(s).hide().insertAfter(a)).find(
                  '.kv-zoom-cache'
                )) &&
                  d.length &&
                  d.insertAfter(a),
      ...
      _checkAsyncComplete: function () {
        ...
        for (i = 0; i < this.filestack.length; i++)
          if (
            this.filestack[i] &&
            ((t = this.previewInitId + '-' + i), -1 === e.inArray(t, this.uploadLog))
          )
            return !1
              ...
              m.fileBatchCompleted &&
                ...
                setTimeout(function () {
                  ...
                  m.unlock(o),
                    ...
                    m.uploadAsync && e.length && (t.addCss(e, t.SORT_CSS), m._initSortable()),
              ...
              ;(r = m._getOutData(s)),
                ...
                m.showPreview &&
                  (n.hasClass('file-preview-success') ||
                    (m._setThumbStatus(n, 'Loading'), t.addCss(n, 'file-uploading')),
                  o.attr('disabled', !0),
                  l.attr('disabled', !0)),
                a || m.lock(),
                ...
                o.showPreview &&
                  o._getThumbs().each(function () {
                    ...
                    i.hasClass('file-preview-success') ||
                      (o._setThumbStatus(i, 'Loading'), t.addCss(i, 'file-uploading')),
                      a.attr('disabled', !0),
                      r.attr('disabled', !0)
                  }),
                ...
                o._abort(a) &&
                  ...
                  o._getThumbs().each(function () {
                    ...
                    t.hasClass('file-preview-loading') &&
                      (o._setThumbStatus(t, 'New'), t.removeClass('file-uploading')),
                    ...
                    (d.each(function () {
                      ...
                      t.removeClass('file-uploading'),
                        ...
                        0 === c.length || -1 !== e.inArray(l, c)
                          ? (o._setPreviewError(t, i, o.filestack[i], o.retryErrorUploads),
                            o.retryErrorUploads ||
                              (t.find('.kv-file-upload').hide(), o.updateStack(i, void 0)))
            ...
            i._handler(o, 'click', function () {
              ...
              ;(r = l.hasClass('file-preview-error')),
                ...
                l.fadeOut('slow', function () {
                  ...
                  0 !== p || 0 !== h || u
                    ? ((s =
                        (n = h + p) > 1 ? i._getMsgSelected(n) : o[0] ? i._getFileNames()[0] : ''),
                      i._setCaption(s))
                    : i.reset(),
          ...
          a.find(n).each(function () {
            ...
            if (!t.isEmpty(p) && void 0 !== u) {
              ...
              ;(b = parseInt(b.replace('init_', ''))),
                ...
                'function' == typeof (v = t.isEmpty(g) || t.isEmpty(g.extra) ? r : g.extra) &&
                  (v = v()),
                ...
                (f = e.extend(
                  !0,
                  {},
                  { url: p, type: 'POST', dataType: 'json', data: e.extend(!0, {}, { key: u }, v) },
          ...
          t.isEmpty(l) ||
            ((r =
              s && n > s && e <= 100
                ...
                : l.setTokens({ percent: n, status: e > 100 ? this.msgUploadEnd : n + '%' })),
            i.html(r),
      ...
      _getFileCount: function (e) {
        return (
          this.validateInitialCount && !this.overwriteInitial && (e += this.previewCache.count()), e
        )
      },
      _getFileId: function (e) {
        ...
        return 'function' == typeof i
          ? i(e, event)
          : e && (t = String(e.webkitRelativePath || e.fileName || e.name || null))
        ...
        void 0 !== t && this.updateStack(t, i),
          this.showPreview &&
            (!this.removeFromPreviewOnError || a
              ? (this._setThumbStatus(e, 'Error'), this._refreshUploadButton(e, a))
              : e.remove())
      },
      _refreshUploadButton: function (e, t) {
        var i = e.find('.kv-file-upload'),
          ...
          n = a.uploadTitle
        i.length &&
          (t && ((r = a.uploadRetryIcon), (n = a.uploadRetryTitle)), i.attr('title', n).html(r))
      },
      ...
      _validateImageOrientation: function (e, i, a, r, n, s, o) {
        ...
        ;(d = (l = e.length && this.autoOrientImage ? this._getExifObj(o) : null)
          ...
          : null)
          ? (t.setImageOrientation(e, this.$preview.find('#zoom-' + a + ' img'), d),
      ...
      _validateAllImages: function () {
        ...
        if (r === this.totalImagesCount && (this._raise('fileimagesloaded'), this.resizeImage))
        ...
        if (
          ...
          try {
            b.drawImage(p, 0, 0, u, f),
              ...
              E && ((c = window.piexif.dump(E)), (l = window.piexif.insert(c, l))),
              (n = t.dataURI2Blob(l)),
              (h.filestack[x] = n),
      ...
      _renderButton: function (e) {
        ...
        return (
          ...
          i.setTokens({ type: l, css: a, title: r, status: o, icon: n, label: s })
        )
      },
      ...
      _browse: function (e) {
        ;(e && e.isDefaultPrevented()) ||
          ...
          (this.isError && !this.isAjaxUpload && this.clear(), this.$captionContainer.focus())
      },
            ...
            if (!a.autoReplace || n > b)
              return (
                ...
                (a.isError =
                  ...
                  (c = null),
                  (h = null),
                  (p = e.extend(!0, {}, a._getOutData({}, {}, _), { id: c, index: h })),
          ...
          '-1' !== l &&
            ...
            (void 0 !== d
              ? ((r[a] = d),
                ...
                a++)
              : o.attr({ id: 'uploaded-' + t.uniqId(), 'data-fileindex': '-1' }),
            i.$preview
              .find('#zoom-' + c)
              .attr({ id: 'zoom-' + o.attr('id'), 'data-fileindex': o.attr('data-fileindex') }))
        }),
          (i.filestack = r),
          (i.filenames = n),
          (i.fileids = s)
      ...
      _isFileSelectionValid: function (e) {
        return (
          ...
          this.required && !this.getFilesCount()
            ? (this.$errorContainer.html(''), this._showUploadError(this.msgFileRequired), !1)
            : !(this.minFileCount > 0 && this._getFileCount(e) < this.minFileCount) ||
              (this._noFilesError({}), !1)
        )
      },
      clearStack: function () {
      ...
      readFiles: function (i) {
        ...
        var a,
          ...
          y = function (t, n, s, o) {
            var l,
              d = e.extend(!0, {}, r._getOutData({}, {}, i), { id: s, index: o }),
          ...
          (a = function (x) {
            ...
            if (B) {
              ...
              if (!1 !== M) {
                if (0 === M.length)
                  return (
                    (S = r.msgInvalidFileName.replace('{name}', t.htmlEncode(B.name, '[unknown]'))),
                    void y(S, B, U, x)
                  )
                if (
                  (t.isEmpty(w) || (N = new RegExp('\\.(' + w.join('|') + ')$', 'i')),
                  (T = Z.toFixed(2)),
                  r.maxFileSize > 0 && Z > r.maxFileSize)
                )
                  return (
                    (S = r.msgSizeTooLarge.setTokens({ name: M, size: T, maxSize: r.maxFileSize })),
                    void y(S, B, U, x)
                  )
                if (null !== r.minFileSize && Z <= t.getNum(r.minFileSize))
                  return (
                    (S = r.msgSizeTooSmall.setTokens({ name: M, size: T, minSize: r.minFileSize })),
                    void y(S, B, U, x)
                  )
                if (!t.isEmpty(g) && t.isArray(g)) {
                  ...
                  if (0 === W)
                    return (
                      (S = r.msgInvalidFileType.setTokens({ name: M, types: q })),
                      void y(S, B, U, x)
                    )
                }
                if (
                  ...
                  t.isArray(w) &&
                  !t.isEmpty(N) &&
                  ((F = t.compare(M, N)), 0 === (W += t.isEmpty(F) ? 0 : F.length))
                )
                  return (
                    (S = r.msgInvalidFileExtension.setTokens({ name: M, extensions: _ })),
                    void y(S, B, U, x)
                  )
                if (!r.showPreview)
                  return (
                  ...
                  ? ((D = R(B.type, M)),
                    ...
                    (o.onload = function (i) {
                      ...
                      if (
                        ...
                        for (s = new Uint8Array(i.target.result), E = 0; E < s.length; E++)
                    ...
                    (o.onprogress = function (e) {
                      if (e.lengthComputable) {
                        var t = (e.loaded / e.total) * 100,
                          i = Math.ceil(t)
                        ;(S = h.setTokens({ index: x + 1, files: u, percent: i, name: M })),
                          setTimeout(function () {
                            d.html(S)
                          }, 100)
                      }
        ...
        if (this.isAjaxUpload && !this.isDisabled && this._isFileSelectionValid(n))
          if ((this._resetUpload(), 0 !== n || s))
            if (
              ...
              if (((r = this.filestack.length), (this.hasInitData = !1), !this.uploadAsync))
              ...
              for (
                this.$preview.find('.file-preview-initial').removeClass(t.SORT_CSS),
                  this._initSortable(),
