      ...
      renderCalendar: function (a) {
        ...
        for (
          ...
          g > 0 && y % 7 == 0 && ((y = 0), v++),
            ...
            k.hour(12),
            this.minDate &&
              i[v][y].format('YYYY-MM-DD') == this.minDate.format('YYYY-MM-DD') &&
              i[v][y].isBefore(this.minDate) &&
              'left' == a &&
              (i[v][y] = this.minDate.clone()),
            this.maxDate &&
              i[v][y].format('YYYY-MM-DD') == this.maxDate.format('YYYY-MM-DD') &&
        ...
        ;(Y += '<thead>'),
          ...
          (b && !b.isBefore(i.firstDay)) || (this.linkedCalendars && 'left' != a)
            ? (Y += '<th></th>')
            : (Y +=
        ...
        for (v = 0; v < 6; v++) {
          ;(Y += '<tr>'),
            this.showWeekNumbers
              ...
              : this.showISOWeekNumbers && (Y += '<td class="week">' + i[v][0].isoWeek() + '</td>')
          for (y = 0; y < 7; y++) {
            var N = []
            i[v][y].isSame(new Date(), 'day') && N.push('today'),
              ...
              i[v][y].format('YYYY-MM-DD') == this.startDate.format('YYYY-MM-DD') &&
                N.push('active', 'start-date'),
              null != this.endDate &&
                i[v][y].format('YYYY-MM-DD') == this.endDate.format('YYYY-MM-DD') &&
