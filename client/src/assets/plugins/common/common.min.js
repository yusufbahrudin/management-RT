          ...
          if (!this.transitioning && o(n).hasClass(this.config.collapseInClass)) {
            ...
            if ((i.trigger(t), !t.isDefaultPrevented())) {
              ...
              0 === i.height() || 'none' === i.css('display')
                ? s()
                : i.height(0).one(g.TRANSITION_END, s).mmEmulateTransitionEnd(350)
            }
          }
        }),
      ...
      (c.prototype = {
        ...
        createView: function (C, e) {
          ...
          function i(e, t) {
            ...
            if (
              ...
              (r =
                l[0] !== O.selectpicker.view.position0 || l[1] !== O.selectpicker.view.position1),
          ...
          var M = function (e, t, i, s) {
            ...
            V = function (e) {
              ...
              if (e.optionContent) s.innerHTML = e.optionContent
                ...
                e.optionSubtext &&
                  (((t = W.subtext.cloneNode(!1)).innerHTML = e.optionSubtext), s.appendChild(t))
              }
          ...
          j.each(function (e) {
            ...
            if ((R++, !t.hasClass('bs-title-option'))) {
              var i,
                ...
                v = this.disabled || m,
                g =
                  this.previousElementSibling && 'OPTGROUP' === this.previousElementSibling.tagName,
                b = p.data()
                ...
                if (f && !0 !== n.divider) {
                  ...
                  if (!this.previousElementSibling) {
                    ...
                    var S = (function (e) {
                      ...
                      return (
                        e.labelSubtext &&
                          (((t = W.subtext.cloneNode(!1)).textContent = e.labelSubtext),
                          s.appendChild(t)),
                        B.appendChild(s),
                        B
                      )
                    ...
                    D.push(M(S, 0, 'dropdown-header' + x, A)),
                      N.push({ content: k, subtext: $, type: 'optgroup-label', optID: A }),
                      (P = R - 1)
                  }
        ...
        render: function () {
              ...
              var r,
                ...
                d =
                  a.icon && e.options.showIcon
                    ? '<i class="' + e.options.iconBase + ' ' + a.icon + '"></i> '
                    : ''
              ;(r =
          ...
          null == this.options.title && (this.options.title = this.$element.attr('title')),
            ...
            h ||
              (h =
                void 0 !== this.options.title ? this.options.title : this.options.noneSelectedText),
          ...
          if (
            ...
            for (var i = 0; i < e.selectpicker.view.visibleElements.length; i++) {
              ...
              if (n) {
                ...
                e.setDisabled(
                  s,
                  n.disabled || ('OPTGROUP' === n.parentNode.tagName && n.parentNode.disabled),
                  o,
                  l
                ),
            ...
            this.$menuInner.on('click', 'li a', function (e, t) {
              ...
              if (
                ...
                if (
                  ...
                  if (
                    (a.prop('selected', !d), E.setSelected(n, !d), i.blur(), !1 !== u || !1 !== f)
                  ) {
                ...
                for (var r = 0; r < u.selectpicker.main.data.length; r++) {
                  ...
                  s[r] || (s[r] = $(c, i, o, l)),
                    s[r] &&
                      ...
                      (0 < c.headerIndex &&
                        ((s[c.headerIndex - 1] = !0), n.push(c.headerIndex - 1)),
                      (s[c.headerIndex] = !0),
        ...
        keydown: function (e) {
          ...
          if (
            ...
            e.which === C &&
              i &&
              (e.preventDefault(), c.$button.trigger('click.bs.dropdown.data-api').focus()),
            p)
          ) {
            if (!a.length) return
            void 0 ===
              (t =
                !0 === f
                  ...
                  : c.selectpicker.current.map.newIndex[c.activeIndex]) && (t = -1),
              -1 !== t &&
                ((s = c.selectpicker.current.elements[t + m]).classList.remove('active'),
              ...
              e.which === H
                ? (-1 !== t && t--,
                  ...
                  c.selectpicker.view.canHighlight[t + m] ||
                    (-1 ===
                      (t = c.selectpicker.view.canHighlight.slice(0, t + m).lastIndexOf(!0) - m) &&
                      (t = a.length - 1)))
                : (e.which === L || h) &&
                  (++t + m >= c.selectpicker.view.canHighlight.length && (t = 0),
                  c.selectpicker.view.canHighlight[t + m] ||
                    (t = t + 1 + c.selectpicker.view.canHighlight.slice(t + m + 1).indexOf(!0))),
              e.preventDefault()
            var v = m + t
            e.which === H
              ? 0 === m && t === a.length - 1
            ...
            if (w.length) {
              ...
              a.removeClass('active').find('a').removeClass('active'),
                1 === b.length &&
                  (-1 === (k = w.indexOf(c.activeIndex)) || k === w.length - 1 ? (k = 0) : k++),
          ...
          i &&
            ...
            (c.options.liveSearch && e.which === T) ||
              ...
              l.focus(),
              c.options.liveSearch || (e.preventDefault(), F(document).data('spaceSelect', !0))))
        },
        mobile: function () {
