...
;(function () {
  ...
  CKEDITOR.plugins.pastefromword.styles = {
    setStyle: function (a, b, c, d) {
      ...
      ;(d && e[b]) ||
        ('' === c ? delete e[b] : (e[b] = c), (a.attributes.style = CKEDITOR.tools.writeCssText(e)))
    },
  ...
  CKEDITOR.plugins.pastefromword.lists = {
    ...
    setListStart: function (a) {
      ...
      switch (a.attributes['cke-list-style-type']) {
        ...
        case 'upper-alpha':
          a.attributes.start =
            f.getSubsectionSymbol(b[c]).replace(/\W/g, '').toLowerCase().charCodeAt(0) - 96 - c
          break
        case 'decimal':
    ...
    calculateValue: function (a) {
      ...
      null === c &&
        ((c = void 0 !== b.attributes.start ? parseInt(b.attributes.start, 10) : 1), (d = 0))
      return c + (a - d)
    },
      ...
      for (var c = {}, d = [[]], e, g = 0; g < a.length; g++) {
        ...
        h
          ? ((n = h.type.match(/alpha/) && 7 == h.index ? 'alpha' : n),
            ...
            (l = this.getListItemInfo(a[g])),
            (h.type != k.type || (e && l.id != e.id && !this.isAListContinuation(a[g]))) &&
              d.push([]))
          : (k = f.getSymbolInfo(a[g].attributes['cke-symbol']))
        for (e = parseInt(a[g].attributes['cke-list-level'], 10) + 1; 20 > e; e++)
          c[e] && delete c[e]
    ...
    getSymbolInfo: function (a, b) {
      ...
      if (a.match(/\d/))
        return { index: a ? parseInt(f.getSubsectionSymbol(a), 10) : 0, type: 'decimal' }
