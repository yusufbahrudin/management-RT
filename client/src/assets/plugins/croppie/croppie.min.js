!(function (e, t) {
  ...
  function C() {
    ...
    ;(this.options.useCanvas = this.options.enableOrientation || E.call(this)),
      ...
      p(e, { width: r + (isNaN(r) ? '' : 'px'), height: a + (isNaN(a) ? '' : 'px') }),
      d(t, 'cr-viewport'),
      s && d(t, s),
      p(t, {
        ...
        s.elements.overlay.addEventListener('mousedown', d),
          s.elements.viewport.addEventListener('keydown', function (e) {
            ...
            if (!e.shiftKey || (e.keyCode !== l && e.keyCode !== c)) {
              ...
              ;(m =
                e.keyCode === l
                  ? parseFloat(s.elements.zoomer.value, 10) + parseFloat(s.elements.zoomer.step, 10)
        ...
        function () {
          ...
          d(h, 'cr-resizer'),
            ...
            this.options.resizeControls.height &&
              (d((a = document.createElement('div')), 'cr-resizer-vertical'), h.appendChild(a))
          this.options.resizeControls.width &&
            (d((s = document.createElement('div')), 'cr-resizer-horisontal'), h.appendChild(s))
          function m(a) {
  ...
  function k(e) {
    ...
    this.options.enforceBoundary &&
      ((n = p.width / u.width), (o = p.height / u.height), (r = Math.max(n, o))),
      r >= a && (a = r + 1),
      (s.min = j(r, 4)),
      (s.max = j(a, 4)),
      !e && (l < s.min || l > s.max)
  ...
  function A(e) {
    ...
    return (
      (s.width = h),
      (s.height = u),
      e.backgroundColor && ((l.fillStyle = e.backgroundColor), l.fillRect(0, 0, h, u)),
      !1 !== this.options.enforceBoundary &&
        ((o = Math.min(o, this._originalImageWidth)), (r = Math.min(r, this._originalImageHeight))),
    ...
    return (
      ...
      new Promise(function (e) {
        ...
        r.removeAttribute('crossOrigin'),
          n.match(/^https?:\/\/|^\/\//) && r.setAttribute('crossOrigin', 'anonymous'),
          (r.onload = function () {
            o
  ...
  function H() {
    ...
    return (
      ...
      (a = Math.max(h, a / l)),
      (s = Math.max(h, s / l)),
      { points: [j(i), j(n), j(a), j(s)], zoom: l, orientation: this.data.orientation }
    )
  }
      ...
      'viewport' === r
        ...
        : 'object' == typeof r &&
          (r.width && r.height
            ...
            : r.height && ((i.outputWidth = r.height * f), (i.outputHeight = r.height))),
