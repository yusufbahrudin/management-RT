;(function ($) {
  ...
  dragula(
    [document.getElementById('left-copy-1tomany'), document.getElementById('right-copy-1tomany')],
    {
  ...
  dragula(
    [document.getElementById('left-lovehandles'), document.getElementById('right-lovehandles')],
    {
